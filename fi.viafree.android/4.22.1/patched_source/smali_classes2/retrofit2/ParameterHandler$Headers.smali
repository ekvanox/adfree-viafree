...
# virtual methods
.method apply(Lretrofit2/RequestBuilder;Lg/s;)V
    .locals 2

    if-eqz p2, :cond_0

    .line 2
    invoke-virtual {p1, p2}, Lretrofit2/RequestBuilder;->addHeaders(Lg/s;)V
...
.method bridge synthetic apply(Lretrofit2/RequestBuilder;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lretrofit2/ParameterHandler$Headers;->apply(Lretrofit2/RequestBuilder;Lg/s;)V
