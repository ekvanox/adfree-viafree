...
.field private final headers:Lg/s;
...
.method constructor <init>(Lretrofit2/RequestFactory$Builder;)V
    ...
    iget-object v0, v0, Lretrofit2/Retrofit;->baseUrl:Lg/t;

    iput-object v0, p0, Lretrofit2/RequestFactory;->baseUrl:Lg/t;
    ...
    .line 6
    iget-object v0, p1, Lretrofit2/RequestFactory$Builder;->headers:Lg/s;

    iput-object v0, p0, Lretrofit2/RequestFactory;->headers:Lg/s;

    .line 7
    iget-object v0, p1, Lretrofit2/RequestFactory$Builder;->contentType:Lg/v;

    iput-object v0, p0, Lretrofit2/RequestFactory;->contentType:Lg/v;
...
# virtual methods
.method create([Ljava/lang/Object;)Lg/a0;
    .locals 12
    ...
    iget-object v5, p0, Lretrofit2/RequestFactory;->baseUrl:Lg/t;

    iget-object v6, p0, Lretrofit2/RequestFactory;->relativeUrl:Ljava/lang/String;

    iget-object v7, p0, Lretrofit2/RequestFactory;->headers:Lg/s;

    iget-object v8, p0, Lretrofit2/RequestFactory;->contentType:Lg/v;
    ...
    invoke-direct/range {v3 .. v11}, Lretrofit2/RequestBuilder;-><init>(Ljava/lang/String;Lg/t;Ljava/lang/String;Lg/s;Lg/v;ZZZ)V
    ...
    .line 9
    :cond_1
    invoke-virtual {v2}, Lretrofit2/RequestBuilder;->get()Lg/a0$a;
    ...
    .line 10
    invoke-virtual {p1, v0, v1}, Lg/a0$a;->i(Ljava/lang/Class;Ljava/lang/Object;)Lg/a0$a;
