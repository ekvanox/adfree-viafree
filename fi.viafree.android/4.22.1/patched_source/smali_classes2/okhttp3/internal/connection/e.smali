...
# direct methods
.method public constructor <init>(Lg/a;Lokhttp3/internal/connection/d;Lg/e;Lg/p;)V
    .locals 1
    ...
    .line 5
    iput-object p1, p0, Lokhttp3/internal/connection/e;->a:Lg/a;

    .line 6
    iput-object p2, p0, Lokhttp3/internal/connection/e;->b:Lokhttp3/internal/connection/d;

    .line 7
    iput-object p3, p0, Lokhttp3/internal/connection/e;->c:Lg/e;

    .line 8
    iput-object p4, p0, Lokhttp3/internal/connection/e;->d:Lg/p;
    ...
    invoke-direct {p0, p2, p1}, Lokhttp3/internal/connection/e;->h(Lg/t;Ljava/net/Proxy;)V
...
.method private f()Ljava/net/Proxy;
    ...
    .line 3
    invoke-direct {p0, v0}, Lokhttp3/internal/connection/e;->g(Ljava/net/Proxy;)V
    ...
    iget-object v2, p0, Lokhttp3/internal/connection/e;->a:Lg/a;
...
.method private g(Ljava/net/Proxy;)V
    ...
    .line 6
    invoke-static {v0}, Lokhttp3/internal/connection/e;->b(Ljava/net/InetSocketAddress;)Ljava/lang/String;
    ...
    :cond_2
    :goto_0
    iget-object v0, p0, Lokhttp3/internal/connection/e;->a:Lg/a;
    ...
    .line 14
    :cond_3
    iget-object p1, p0, Lokhttp3/internal/connection/e;->d:Lg/p;

    iget-object v2, p0, Lokhttp3/internal/connection/e;->c:Lg/e;

    invoke-virtual {p1, v2, v1}, Lg/p;->j(Lg/e;Ljava/lang/String;)V

    .line 15
    iget-object p1, p0, Lokhttp3/internal/connection/e;->a:Lg/a;
    ...
    .line 17
    iget-object v2, p0, Lokhttp3/internal/connection/e;->d:Lg/p;

    iget-object v3, p0, Lokhttp3/internal/connection/e;->c:Lg/e;
...
.method private h(Lg/t;Ljava/net/Proxy;)V
    .locals 1
    ...
    .line 2
    :cond_0
    iget-object p2, p0, Lokhttp3/internal/connection/e;->a:Lg/a;

    invoke-virtual {p2}, Lg/a;->i()Ljava/net/ProxySelector;

    move-result-object p2

    invoke-virtual {p1}, Lg/t;->G()Ljava/net/URI;
    ...
    invoke-static {p1}, Lg/g0/c;->u([Ljava/lang/Object;)Ljava/util/List;
...
# virtual methods
.method public a(Lg/e0;Ljava/io/IOException;)V
    .locals 3

    .line 1
    invoke-virtual {p1}, Lg/e0;->b()Ljava/net/Proxy;
    ...
    iget-object v1, p0, Lokhttp3/internal/connection/e;->a:Lg/a;
    ...
    invoke-virtual {v1}, Lg/t;->G()Ljava/net/URI;
    ...
    invoke-virtual {p2, p1}, Lokhttp3/internal/connection/d;->b(Lg/e0;)V
...
.method public e()Lokhttp3/internal/connection/e$a;
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 4
    invoke-direct {p0}, Lokhttp3/internal/connection/e;->f()Ljava/net/Proxy;
    ...
    iget-object v5, p0, Lokhttp3/internal/connection/e;->a:Lg/a;
    ...
    invoke-direct {v4, v5, v1, v6}, Lg/e0;-><init>(Lg/a;Ljava/net/Proxy;Ljava/net/InetSocketAddress;)V

    .line 7
    iget-object v5, p0, Lokhttp3/internal/connection/e;->b:Lokhttp3/internal/connection/d;

    invoke-virtual {v5, v4}, Lokhttp3/internal/connection/d;->c(Lg/e0;)Z
