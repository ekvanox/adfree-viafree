...
.field protected e:Lcom/viafree/android/v/q/d;

.field protected f:Lcom/viafree/android/u/b/a;

.field protected g:Lcom/viafree/android/v/o/d/c;

.field private final h:Lcom/viafree/android/v/p/f;
...
.method public constructor <init>(Landroid/app/Application;)V
    ...
    .line 2
    new-instance p1, Lcom/viafree/android/v/p/f;

    invoke-direct {p1}, Lcom/viafree/android/v/p/f;-><init>()V

    iput-object p1, p0, Lcom/viafree/android/contentpage/f;->h:Lcom/viafree/android/v/p/f;
    ...
    invoke-interface {p1, p0}, Lcom/viafree/android/v/l/b;->A(Lcom/viafree/android/contentpage/f;)V
    ...
    .line 26
    iget-object p1, p0, Lcom/viafree/android/contentpage/f;->h:Lcom/viafree/android/v/p/f;

    invoke-virtual {p1}, Lcom/viafree/android/v/p/f;->d()Z
...
.method private final H(Lcom/viafree/viafreeandroidutility/dto/BlockObject;)V
    ...
    .line 12
    invoke-virtual {v9}, Lcom/viafree/viafreeandroidutility/dto/ProgramObject;->k()Lcom/viafree/viafreeandroidutility/dto/EpisodeObject;
    ...
    .line 19
    iget-object p1, p0, Lcom/viafree/android/contentpage/f;->g:Lcom/viafree/android/v/o/d/c;

    if-eqz p1, :cond_a

    const-string v0, "swap"

    invoke-interface {p1, v3, v0}, Lcom/viafree/android/v/o/d/c;->k(Ljava/util/List;Ljava/lang/String;)V
...
.method private final m()Ljava/util/List;
    ...
    invoke-static {v7}, Lcom/viafree/android/v/p/k;->d(Landroid/content/Context;)Z
    ...
    .line 12
    :cond_4
    invoke-static {v4}, Lcom/viafree/android/v/p/l;->m(Lcom/viafree/viafreeandroidutility/dto/BlockObject;)Z

    move-result v4

    if-eqz v4, :cond_7

    iget-object v4, p0, Lcom/viafree/android/contentpage/f;->e:Lcom/viafree/android/v/q/d;

    if-eqz v4, :cond_6

    invoke-interface {v4}, Lcom/viafree/android/v/q/d;->c()Z
...
.method public final A(Ljava/lang/String;Ljava/lang/String;)Landroidx/lifecycle/LiveData;
    ...
    .line 1
    iget-object v0, p0, Lcom/viafree/android/contentpage/f;->d:Lcom/viafree/android/u/b/d;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p1, p2}, Lcom/viafree/android/u/b/d;->o(Ljava/lang/String;Ljava/lang/String;)Landroidx/lifecycle/LiveData;
...
.method protected final B()Lcom/viafree/android/v/q/d;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/viafree/android/contentpage/f;->e:Lcom/viafree/android/v/q/d;
...
.method public final M(Ljava/lang/String;Z)V
    ...
    iget-object v3, p0, Lcom/viafree/android/contentpage/f;->e:Lcom/viafree/android/v/q/d;
...
.method protected final r()Lcom/viafree/android/u/b/a;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/viafree/android/contentpage/f;->f:Lcom/viafree/android/u/b/a;
...
.method public final s()Lkotlin/h;
    ...
    check-cast v4, Lcom/viafree/android/u/b/f/f;

    if-eqz v4, :cond_4

    invoke-virtual {v4}, Lcom/viafree/android/u/b/f/f;->a()Ljava/lang/Object;
...
.method protected final z()Lcom/viafree/android/u/b/d;
    .locals 1
