...
.method public static enqueue(Lg/e;Lg/f;)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v5}, Lcom/google/firebase/perf/network/zzh;-><init>(Lg/f;Lcom/google/firebase/perf/internal/zzf;Lcom/google/android/gms/internal/firebase-perf/zzaz;J)V

    .line 5
    invoke-interface {p0, v6}, Lg/e;->c(Lg/f;)V

    return-void
.end method

.method public static execute(Lg/e;)Lg/c0;
    .locals 11
    .annotation build Landroidx/annotation/Keep;
    .end annotation
    ...
    .line 4
    :try_start_0
    invoke-interface {p0}, Lg/e;->execute()Lg/c0;
    ...
    .line 6
    invoke-static/range {v1 .. v6}, Lcom/google/firebase/perf/network/FirebasePerfOkHttpClient;->zza(Lg/c0;Lcom/google/android/gms/internal/firebase-perf/zzam;JJ)V
    :try_end_0
    ...
    .line 7
    invoke-interface {p0}, Lg/e;->request()Lg/a0;
    ...
    .line 9
    invoke-virtual {v2}, Lg/t;->H()Ljava/net/URL;
...
.method static zza(Lg/c0;Lcom/google/android/gms/internal/firebase-perf/zzam;JJ)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v1}, Lg/t;->H()Ljava/net/URL;
    ...
    .line 11
    invoke-virtual {v0}, Lg/v;->toString()Ljava/lang/String;
