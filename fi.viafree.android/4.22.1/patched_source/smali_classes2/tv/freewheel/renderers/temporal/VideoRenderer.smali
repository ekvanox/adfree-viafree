...
.method private checkAndFailIfFreeze()V
    ...
    .line 7
    invoke-direct {p0, v0}, Ltv/freewheel/renderers/temporal/VideoRenderer;->onRendererFailed(Landroid/os/Bundle;)V
...
.method private checkAndFailIfTimeout()V
    ...
    iget-wide v3, p0, Ltv/freewheel/renderers/temporal/VideoRenderer;->timeoutMillisecondsBeforeStart:D
...
.method private onRendererFailed(Landroid/os/Bundle;)V
    .locals 2
...
.method private preload()V
    ...
    invoke-virtual {v1, v0, v2}, Ltv/freewheel/renderers/temporal/VideoAdView;->tryToGetRedirectedUrl(Ljava/lang/String;I)V
    ...
    invoke-virtual {v1, v0}, Ltv/freewheel/renderers/temporal/VideoAdView;->setAdUrl(Ljava/lang/String;)V
    ...
    .line 14
    invoke-direct {p0, v1}, Ltv/freewheel/renderers/temporal/VideoRenderer;->onRendererFailed(Landroid/os/Bundle;)V
...
.method private startQuartileImpressionAndTimeoutPoller()V
    ...
    invoke-direct {v2, p0}, Ltv/freewheel/renderers/temporal/VideoRenderer$3;-><init>(Ltv/freewheel/renderers/temporal/VideoRenderer;)V

    iput-object v2, p0, Ltv/freewheel/renderers/temporal/VideoRenderer;->repeatingQuartileRunnable:Ljava/lang/Runnable;
...
.method public getModuleInfo()Ljava/util/Map;
    ...
    invoke-interface {v1}, Ltv/freewheel/ad/interfaces/IConstants;->INFO_KEY_MODULE_NAME()Ljava/lang/String;
    ...
    const-string v2, "6.33.0-99b42ba0-201912122303"
...
.method public load(Ltv/freewheel/renderers/interfaces/IRendererContext;)V
    ...
    invoke-interface {p1, v4, v5}, Ltv/freewheel/renderers/interfaces/IRendererContext;->setSupportedAdEvent(Ljava/lang/String;Z)V
    ...
    invoke-interface {p1}, Ltv/freewheel/ad/interfaces/IConstants;->PARAMETER_CLICK_DETECTION()Ljava/lang/String;

    move-result-object p1

    sget-object v4, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    invoke-virtual {v1, p1, v4}, Ltv/freewheel/utils/renderer/ParamParser;->parseBoolean(Ljava/lang/String;Ljava/lang/Boolean;)Ljava/lang/Boolean;
    ...
    iput-boolean p1, p0, Ltv/freewheel/renderers/temporal/VideoRenderer;->clickHandledByPlayer:Z
    ...
    invoke-interface {p1, v4, v3}, Ltv/freewheel/renderers/interfaces/IRendererContext;->setSupportedAdEvent(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v1, v4, p1}, Ltv/freewheel/utils/renderer/ParamParser;->parseBoolean(Ljava/lang/String;Ljava/lang/Boolean;)Ljava/lang/Boolean;
    ...
    iput-boolean p1, p0, Ltv/freewheel/renderers/temporal/VideoRenderer;->checkRedirectUrl:Z

    .line 22
    new-instance p1, Ltv/freewheel/renderers/temporal/VideoAdRenditionSelector;

    iget-object v1, p0, Ltv/freewheel/renderers/temporal/VideoRenderer;->rendererContext:Ltv/freewheel/renderers/interfaces/IRendererContext;

    invoke-direct {p1, v1}, Ltv/freewheel/renderers/temporal/VideoAdRenditionSelector;-><init>(Ltv/freewheel/renderers/interfaces/IRendererContext;)V

    .line 23
    invoke-virtual {p1}, Ltv/freewheel/renderers/temporal/VideoAdRenditionSelector;->getBestFitRendition()Ltv/freewheel/ad/interfaces/ICreativeRendition;
    ...
    invoke-interface {v0}, Ltv/freewheel/ad/interfaces/IConstants;->INFO_KEY_ERROR_CODE()Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Ltv/freewheel/renderers/temporal/VideoRenderer;->constants:Ltv/freewheel/ad/interfaces/IConstants;

    invoke-interface {v1}, Ltv/freewheel/ad/interfaces/IConstants;->ERROR_NULL_ASSET()Ljava/lang/String;
    ...
    const-string v1, "No asset"

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    .line 27
    invoke-direct {p0, p1}, Ltv/freewheel/renderers/temporal/VideoRenderer;->onRendererFailed(Landroid/os/Bundle;)V
    ...
    const-string v5, "Best fit rendition: "
    ...
    invoke-virtual {v1, v4}, Ltv/freewheel/utils/Logger;->debug(Ljava/lang/String;)V
    ...
    invoke-interface {v1, p1}, Ltv/freewheel/ad/interfaces/IAdInstance;->setActiveCreativeRendition(Ltv/freewheel/ad/interfaces/ICreativeRendition;)V
    ...
    iput-wide v4, p0, Ltv/freewheel/renderers/temporal/VideoRenderer;->estimatedDuration:D
    ...
    .line 45
    :goto_1
    iget-object p1, p0, Ltv/freewheel/renderers/temporal/VideoRenderer;->assetUrl:Ljava/lang/String;
    ...
    const-string p1, ", fixed assetUrl: "
