...
.method public intercept(Lg/u$a;)Lg/c0;
    ...
    invoke-direct {v4, v2, v0, v1}, Lcom/facebook/stetho/okhttp3/StethoInterceptor$OkHttpInspectorRequest;-><init>(Ljava/lang/String;Lg/a0;Lcom/facebook/stetho/inspector/network/RequestBodyHelper;)V
    ...
    .line 11
    :cond_1
    invoke-interface {p1}, Lg/u$a;->d()Lg/i;
    ...
    invoke-direct {v4, v2, v0, v7, p1}, Lcom/facebook/stetho/okhttp3/StethoInterceptor$OkHttpInspectorResponse;-><init>(Ljava/lang/String;Lg/a0;Lg/c0;Lg/i;)V
    ...
    .line 13
    invoke-virtual {v7}, Lg/c0;->c()Lg/d0;
    ...
    .line 15
    invoke-virtual {p1}, Lg/d0;->byteStream()Ljava/io/InputStream;
    ...
    .line 18
    invoke-virtual {v7, v0}, Lg/c0;->O(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 20
    invoke-virtual {v7}, Lg/c0;->U()Lg/c0$a;

    move-result-object v1

    new-instance v2, Lcom/facebook/stetho/okhttp3/StethoInterceptor$ForwardingResponseBody;

    invoke-direct {v2, p1, v0}, Lcom/facebook/stetho/okhttp3/StethoInterceptor$ForwardingResponseBody;-><init>(Lg/d0;Ljava/io/InputStream;)V
