...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 2
    sget p1, Lb/o/l;->Widget_Leanback_ImageCardView:I

    invoke-direct {p0, p2, p3, p1}, Landroidx/leanback/widget/ImageCardView;->o(Landroid/util/AttributeSet;II)V
...
.method private o(Landroid/util/AttributeSet;II)V
    ...
    .line 4
    sget v2, Lb/o/i;->lb_image_card_view:I
    ...
    sget-object v3, Lb/o/m;->lbImageCardView:[I
    ...
    .line 6
    sget p2, Lb/o/m;->lbImageCardView_lbImageCardViewType:I
    ...
    iput-object v8, p0, Landroidx/leanback/widget/ImageCardView;->w:Landroid/widget/ImageView;
    ...
    .line 10
    iget-object v8, p0, Landroidx/leanback/widget/ImageCardView;->w:Landroid/widget/ImageView;

    invoke-virtual {v8, v6}, Landroid/widget/ImageView;->setVisibility(I)V

    .line 11
    :cond_5
    iget-object v6, p0, Landroidx/leanback/widget/ImageCardView;->w:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, Landroidx/leanback/widget/ImageCardView;->C:Landroid/animation/ObjectAnimator;
    ...
    iput-object v0, p0, Landroidx/leanback/widget/ImageCardView;->x:Landroid/view/ViewGroup;
    ...
    .line 18
    sget v2, Lb/o/i;->lb_image_card_view_themed_title:I
    ...
    iput-object v0, p0, Landroidx/leanback/widget/ImageCardView;->y:Landroid/widget/TextView;

    .line 19
    iget-object v2, p0, Landroidx/leanback/widget/ImageCardView;->x:Landroid/view/ViewGroup;
    ...
    .line 20
    sget v0, Lb/o/i;->lb_image_card_view_themed_content:I
    ...
    iput-object v0, p0, Landroidx/leanback/widget/ImageCardView;->z:Landroid/widget/TextView;
    ...
    .line 22
    :cond_9
    sget v0, Lb/o/i;->lb_image_card_view_themed_badge_right:I

    if-eqz p2, :cond_a

    .line 23
    sget v0, Lb/o/i;->lb_image_card_view_themed_badge_left:I
    ...
    iput-object p3, p0, Landroidx/leanback/widget/ImageCardView;->A:Landroid/widget/ImageView;

    .line 25
    iget-object v0, p0, Landroidx/leanback/widget/ImageCardView;->x:Landroid/view/ViewGroup;
    ...
    .line 26
    iget-object v1, p0, Landroidx/leanback/widget/ImageCardView;->A:Landroid/widget/ImageView;

    if-eqz v1, :cond_d

    .line 27
    iget-object v1, p0, Landroidx/leanback/widget/ImageCardView;->y:Landroid/widget/TextView;
    ...
    .line 29
    iget-object v2, p0, Landroidx/leanback/widget/ImageCardView;->A:Landroid/widget/ImageView;
    ...
    .line 31
    :goto_5
    iget-object v2, p0, Landroidx/leanback/widget/ImageCardView;->y:Landroid/widget/TextView;
    ...
    .line 32
    iget-object v1, p0, Landroidx/leanback/widget/ImageCardView;->z:Landroid/widget/TextView;
    ...
    .line 37
    iget-object p2, p0, Landroidx/leanback/widget/ImageCardView;->A:Landroid/widget/ImageView;
    ...
    .line 38
    :cond_f
    iget-object p2, p0, Landroidx/leanback/widget/ImageCardView;->z:Landroid/widget/TextView;
    ...
    .line 41
    iget-object p3, p0, Landroidx/leanback/widget/ImageCardView;->z:Landroid/widget/TextView;
    ...
    .line 42
    iget-object p3, p0, Landroidx/leanback/widget/ImageCardView;->y:Landroid/widget/TextView;
    ...
    :cond_12
    :goto_6
    iget-object p3, p0, Landroidx/leanback/widget/ImageCardView;->A:Landroid/widget/ImageView;

    invoke-virtual {p3, p2}, Landroid/widget/ImageView;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    .line 44
    :cond_13
    sget p2, Lb/o/m;->lbImageCardView_infoAreaBackground:I
...
.method private p()V
    ...
    .line 2
    iget-boolean v0, p0, Landroidx/leanback/widget/ImageCardView;->B:Z

    if-eqz v0, :cond_0

    .line 3
    iget-object v0, p0, Landroidx/leanback/widget/ImageCardView;->C:Landroid/animation/ObjectAnimator;
...
.method public getBadgeImage()Landroid/graphics/drawable/Drawable;
    ...
    .line 1
    iget-object v0, p0, Landroidx/leanback/widget/ImageCardView;->A:Landroid/widget/ImageView;
...
.method public getContentText()Ljava/lang/CharSequence;
    ...
    .line 1
    iget-object v0, p0, Landroidx/leanback/widget/ImageCardView;->z:Landroid/widget/TextView;
...
.method public getTitleText()Ljava/lang/CharSequence;
    ...
    .line 1
    iget-object v0, p0, Landroidx/leanback/widget/ImageCardView;->y:Landroid/widget/TextView;
...
.method protected onAttachedToWindow()V
    ...
    .line 2
    iput-boolean v0, p0, Landroidx/leanback/widget/ImageCardView;->B:Z
    ...
    .line 4
    invoke-direct {p0}, Landroidx/leanback/widget/ImageCardView;->p()V
...
.method public q(Landroid/graphics/drawable/Drawable;Z)V
    ...
    .line 3
    iget-object p1, p0, Landroidx/leanback/widget/ImageCardView;->C:Landroid/animation/ObjectAnimator;
...
.method public setBadgeImage(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 3
    iget-object p1, p0, Landroidx/leanback/widget/ImageCardView;->A:Landroid/widget/ImageView;
...
.method public setMainImage(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 1
    invoke-virtual {p0, p1, v0}, Landroidx/leanback/widget/ImageCardView;->q(Landroid/graphics/drawable/Drawable;Z)V
