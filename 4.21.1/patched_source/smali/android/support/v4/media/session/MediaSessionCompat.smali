...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroid/os/Bundle;Landroidx/versionedparcelable/c;)V
    ...
    invoke-virtual {p0, p2}, Landroid/support/v4/media/session/MediaSessionCompat;->k(Landroid/support/v4/media/session/MediaSessionCompat$c;)V
    ...
    invoke-interface {p2, v6}, Landroid/support/v4/media/session/MediaSessionCompat$d;->g(Landroid/app/PendingIntent;)V
...
.method static f(Landroid/support/v4/media/session/PlaybackStateCompat;Landroid/support/v4/media/MediaMetadataCompat;)Landroid/support/v4/media/session/PlaybackStateCompat;
    .locals 14
...
.method public d()Ljava/lang/Object;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$d;->h()Ljava/lang/Object;
...
.method public i(Landroid/support/v4/media/session/MediaSessionCompat$j;)V
    .locals 1
...
.method public j(Z)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$d;->i(Z)V
...
.method public k(Landroid/support/v4/media/session/MediaSessionCompat$c;)V
    .locals 1

    const/4 v0, 0x0

    .line 1
    invoke-virtual {p0, p1, v0}, Landroid/support/v4/media/session/MediaSessionCompat;->l(Landroid/support/v4/media/session/MediaSessionCompat$c;Landroid/os/Handler;)V

    return-void
.end method

.method public l(Landroid/support/v4/media/session/MediaSessionCompat$c;Landroid/os/Handler;)V
    .locals 1
    ...
    invoke-interface {p1, p2, p2}, Landroid/support/v4/media/session/MediaSessionCompat$d;->d(Landroid/support/v4/media/session/MediaSessionCompat$c;Landroid/os/Handler;)V
    ...
    :goto_0
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$d;->d(Landroid/support/v4/media/session/MediaSessionCompat$c;Landroid/os/Handler;)V
...
.method public m(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$d;->f(Landroid/support/v4/media/MediaMetadataCompat;)V
...
.method public n(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$d;->k(Landroid/support/v4/media/session/PlaybackStateCompat;)V
...
.method public p(Landroidx/media/i;)V
    .locals 1
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$d;->l(Landroidx/media/i;)V
...
.method public q(Landroid/app/PendingIntent;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$d;->c(Landroid/app/PendingIntent;)V
