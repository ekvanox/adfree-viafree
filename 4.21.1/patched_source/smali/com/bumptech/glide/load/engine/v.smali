...
.field private volatile l:Lcom/bumptech/glide/load/n/n$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private n:Lcom/bumptech/glide/load/engine/w;
...
.method constructor <init>(Lcom/bumptech/glide/load/engine/g;Lcom/bumptech/glide/load/engine/f$a;)V
    ...
    .line 2
    iput v0, p0, Lcom/bumptech/glide/load/engine/v;->h:I
...
.method private a()Z
    ...
    .line 1
    iget v0, p0, Lcom/bumptech/glide/load/engine/v;->k:I

    iget-object v1, p0, Lcom/bumptech/glide/load/engine/v;->j:Ljava/util/List;
...
.method public b(Ljava/lang/Exception;)V
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/v;->n:Lcom/bumptech/glide/load/engine/w;

    iget-object v2, p0, Lcom/bumptech/glide/load/engine/v;->l:Lcom/bumptech/glide/load/n/n$a;
    ...
    invoke-interface {v0, v1, p1, v2, v3}, Lcom/bumptech/glide/load/engine/f$a;->a(Lcom/bumptech/glide/load/f;Ljava/lang/Exception;Lcom/bumptech/glide/load/m/d;Lcom/bumptech/glide/load/a;)V
...
.method public c()Z
    ...
    :cond_2
    :goto_0
    iget-object v3, p0, Lcom/bumptech/glide/load/engine/v;->j:Ljava/util/List;
    ...
    .line 10
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/v;->l:Lcom/bumptech/glide/load/n/n$a;
    ...
    .line 12
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/v;->j:Ljava/util/List;

    iget v1, p0, Lcom/bumptech/glide/load/engine/v;->k:I

    add-int/lit8 v3, v1, 0x1

    iput v3, p0, Lcom/bumptech/glide/load/engine/v;->k:I
    ...
    .line 13
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/v;->m:Ljava/io/File;
    ...
    .line 15
    invoke-interface {v0, v1, v3, v5, v6}, Lcom/bumptech/glide/load/n/n;->b(Ljava/lang/Object;IILcom/bumptech/glide/load/h;)Lcom/bumptech/glide/load/n/n$a;
    ...
    .line 16
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/v;->l:Lcom/bumptech/glide/load/n/n$a;

    if-eqz v0, :cond_4

    iget-object v0, p0, Lcom/bumptech/glide/load/engine/v;->b:Lcom/bumptech/glide/load/engine/g;

    iget-object v1, p0, Lcom/bumptech/glide/load/engine/v;->l:Lcom/bumptech/glide/load/n/n$a;
    ...
    invoke-interface {v0, v1, p0}, Lcom/bumptech/glide/load/m/d;->d(Lcom/bumptech/glide/f;Lcom/bumptech/glide/load/m/d$a;)V
    ...
    :cond_6
    :goto_2
    iget v3, p0, Lcom/bumptech/glide/load/engine/v;->h:I
    ...
    .line 24
    iget v4, p0, Lcom/bumptech/glide/load/engine/v;->h:I
    ...
    invoke-virtual {v4, v11}, Lcom/bumptech/glide/load/engine/g;->r(Ljava/lang/Class;)Lcom/bumptech/glide/load/l;
    ...
    invoke-direct/range {v4 .. v12}, Lcom/bumptech/glide/load/engine/w;-><init>(Lcom/bumptech/glide/load/engine/z/b;Lcom/bumptech/glide/load/f;Lcom/bumptech/glide/load/f;IILcom/bumptech/glide/load/l;Ljava/lang/Class;Lcom/bumptech/glide/load/h;)V

    iput-object v13, p0, Lcom/bumptech/glide/load/engine/v;->n:Lcom/bumptech/glide/load/engine/w;
    ...
    iget-object v5, p0, Lcom/bumptech/glide/load/engine/v;->n:Lcom/bumptech/glide/load/engine/w;

    invoke-interface {v4, v5}, Lcom/bumptech/glide/load/engine/a0/a;->b(Lcom/bumptech/glide/load/f;)Ljava/io/File;

    move-result-object v4

    iput-object v4, p0, Lcom/bumptech/glide/load/engine/v;->m:Ljava/io/File;

    if-eqz v4, :cond_2

    .line 33
    iput-object v3, p0, Lcom/bumptech/glide/load/engine/v;->i:Lcom/bumptech/glide/load/f;
    ...
    iput-object v3, p0, Lcom/bumptech/glide/load/engine/v;->j:Ljava/util/List;

    .line 35
    iput v2, p0, Lcom/bumptech/glide/load/engine/v;->k:I
...
.method public e(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/v;->i:Lcom/bumptech/glide/load/f;
