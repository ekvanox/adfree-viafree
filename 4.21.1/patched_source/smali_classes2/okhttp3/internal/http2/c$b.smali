...
.method constructor <init>(IZLi/c;)V
    ...
    .line 10
    iput-object p3, p0, Lokhttp3/internal/http2/c$b;->a:Li/c;
...
.method constructor <init>(Li/c;)V
    ...
    .line 1
    invoke-direct {p0, v0, v1, p1}, Lokhttp3/internal/http2/c$b;-><init>(IZLi/c;)V
...
.method f(Li/f;)V
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/http2/j;->e(Li/f;)I
    ...
    invoke-virtual {v2, p1, v0}, Lokhttp3/internal/http2/j;->d(Li/f;Li/d;)V

    .line 4
    invoke-virtual {v0}, Li/c;->X()Li/f;
    ...
    .line 6
    iget-object v0, p0, Lokhttp3/internal/http2/c$b;->a:Li/c;
...
.method g(Ljava/util/List;)V
    ...
    .line 9
    iget-object v4, v3, Lokhttp3/internal/http2/b;->a:Li/f;

    invoke-virtual {v4}, Li/f;->u()Li/f;

    move-result-object v4

    .line 10
    iget-object v5, v3, Lokhttp3/internal/http2/b;->b:Li/f;
    ...
    iget-object v9, v9, Lokhttp3/internal/http2/b;->b:Li/f;

    invoke-static {v9, v5}, Lh/g0/c;->q(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-object v11, v11, Lokhttp3/internal/http2/b;->a:Li/f;

    invoke-static {v11, v4}, Lh/g0/c;->q(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-object v11, v11, Lokhttp3/internal/http2/b;->b:Li/f;

    invoke-static {v11, v5}, Lh/g0/c;->q(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 21
    iget-object v7, p0, Lokhttp3/internal/http2/c$b;->a:Li/c;

    invoke-virtual {v7, v6}, Li/c;->k0(I)Li/c;

    .line 22
    invoke-virtual {p0, v4}, Lokhttp3/internal/http2/c$b;->f(Li/f;)V

    .line 23
    invoke-virtual {p0, v5}, Lokhttp3/internal/http2/c$b;->f(Li/f;)V
    ...
    .line 25
    :cond_9
    sget-object v7, Lokhttp3/internal/http2/b;->d:Li/f;

    invoke-virtual {v4, v7}, Li/f;->s(Li/f;)Z

    move-result v7

    if-eqz v7, :cond_a

    sget-object v7, Lokhttp3/internal/http2/b;->i:Li/f;
...
.method h(III)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/c$b;->a:Li/c;

    or-int/2addr p1, p3

    invoke-virtual {p2, p1}, Li/c;->k0(I)Li/c;
    ...
    invoke-virtual {v0, p3}, Li/c;->k0(I)Li/c;
    ...
    invoke-virtual {v0, p2}, Li/c;->k0(I)Li/c;
