...
# interfaces
.implements Lcom/viafree/android/w/m/a/a/a;
.implements Lcom/viafree/android/w/m/a/a/b;
...
# instance fields
.field private a:Lcom/viafree/android/w/q/d;
...
.field private h:Lcom/viafree/android/v/a/b;

.field private i:Lcom/viafree/android/v/a/a;
...
.method public constructor <init>(Landroid/content/Context;Lcom/viafree/android/w/q/d;Lcom/viafree/android/common/models/c;)V
    .locals 0
    ...
    .line 3
    iput-object p2, p0, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->a:Lcom/viafree/android/w/q/d;

    .line 4
    invoke-direct {p0, p3}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->N(Lcom/viafree/android/common/models/c;)V

    return-void
.end method

.method static synthetic A(Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;Lretrofit2/Response;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->Y(Lretrofit2/Response;Lcom/viafree/android/w/m/a/a/a$a;)V
...
.method private C()V
    ...
    .line 2
    invoke-virtual {v0, v2, v3, v1}, Lh/x$b;->e(JLjava/util/concurrent/TimeUnit;)Lh/x$b;

    sget-object v1, Ljava/util/concurrent/TimeUnit;->SECONDS:Ljava/util/concurrent/TimeUnit;

    .line 3
    invoke-virtual {v0, v2, v3, v1}, Lh/x$b;->h(JLjava/util/concurrent/TimeUnit;)Lh/x$b;

    sget-object v1, Ljava/util/concurrent/TimeUnit;->SECONDS:Ljava/util/concurrent/TimeUnit;

    .line 4
    invoke-virtual {v0, v2, v3, v1}, Lh/x$b;->k(JLjava/util/concurrent/TimeUnit;)Lh/x$b;
    ...
    iput-object v0, p0, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->d:Lh/x;

    return-void
.end method

.method private D(Ljava/lang/String;Lcom/google/gson/Gson;Lh/u;)Lcom/viafree/android/v/a/a;
    .locals 1
    ...
    new-instance p2, Lcom/viafree/android/v/b/f/e;

    invoke-direct {p2}, Lcom/viafree/android/v/b/f/e;-><init>()V
    ...
    .line 5
    invoke-direct {p0, p3}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->H(Lh/u;)Lh/x;

    move-result-object p2

    invoke-virtual {p1, p2}, Lretrofit2/Retrofit$Builder;->client(Lh/x;)Lretrofit2/Retrofit$Builder;
    ...
    const-class p2, Lcom/viafree/android/v/a/a;
    ...
    check-cast p1, Lcom/viafree/android/v/a/a;

    return-object p1
.end method

.method private E(Ljava/lang/String;Lcom/google/gson/Gson;Lh/u;)Lretrofit2/Retrofit;
    .locals 1
...
.method private F(Ljava/lang/String;Lcom/google/gson/Gson;Lh/u;)Lcom/viafree/android/v/a/b;
    .locals 1
    ...
    const-class p2, Lcom/viafree/android/v/a/b;
    ...
    check-cast p1, Lcom/viafree/android/v/a/b;

    return-object p1
.end method

.method public static G(Lh/x$b;)Lh/x$b;
    .locals 4
    ...
    invoke-virtual {p0, v1, v0}, Lh/x$b;->j(Ljavax/net/ssl/SSLSocketFactory;Ljavax/net/ssl/X509TrustManager;)Lh/x$b;
    ...
    invoke-virtual {p0, v0}, Lh/x$b;->i(Ljavax/net/ssl/SSLSocketFactory;)Lh/x$b;
    ...
    .line 20
    invoke-virtual {v0, v1}, Lh/k$a;->f([Lh/f0;)Lh/k$a;
    ...
    .line 24
    sget-object v0, Lh/k;->h:Lh/k;

    invoke-interface {v1, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 25
    sget-object v0, Lh/k;->i:Lh/k;

    invoke-interface {v1, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 26
    invoke-virtual {p0, v1}, Lh/x$b;->g(Ljava/util/List;)Lh/x$b;
    :try_end_0
...
.method private H(Lh/u;)Lh/x;
    ...
    .line 2
    invoke-virtual {v0, p1}, Lh/x$b;->a(Lh/u;)Lh/x$b;
    ...
    invoke-direct {p1, v1, v2, v3, v4}, Lh/j;-><init>(IJLjava/util/concurrent/TimeUnit;)V

    invoke-virtual {v0, p1}, Lh/x$b;->f(Lh/j;)Lh/x$b;
    ...
    invoke-direct {p1, v1, v2, v3}, Lh/c;-><init>(Ljava/io/File;J)V

    invoke-virtual {v0, p1}, Lh/x$b;->c(Lh/c;)Lh/x$b;
...
.method private N(Lcom/viafree/android/common/models/c;)V
    .locals 5
    ...
    invoke-direct {p0}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->L()Lh/u;

    move-result-object v2

    invoke-direct {p0, v1, v0, v2}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->E(Ljava/lang/String;Lcom/google/gson/Gson;Lh/u;)Lretrofit2/Retrofit;
    ...
    invoke-direct {p0, v3}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->J(Z)Lh/u;
    ...
    .line 11
    invoke-direct {p0}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->C()V
    ...
    invoke-direct {p0}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->I()Lh/u;

    move-result-object v2

    invoke-direct {p0, v1, v0, v2}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->F(Ljava/lang/String;Lcom/google/gson/Gson;Lh/u;)Lcom/viafree/android/v/a/b;

    move-result-object v1

    iput-object v1, p0, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->h:Lcom/viafree/android/v/a/b;
    ...
    invoke-direct {p0, p1, v0, v1}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->D(Ljava/lang/String;Lcom/google/gson/Gson;Lh/u;)Lcom/viafree/android/v/a/a;

    move-result-object p1

    iput-object p1, p0, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->i:Lcom/viafree/android/v/a/a;

    return-void
.end method

.method static synthetic R(Lcom/google/gson/JsonElement;Ljava/lang/reflect/Type;Lcom/google/gson/JsonDeserializationContext;)Lcom/viafree/android/videoplayer/ad/models/Midroll;
    .locals 0
...
.method private T(ZLretrofit2/Call;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 1

    .line 1
    new-instance v0, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient$g;

    invoke-direct {v0, p0, p1, p3}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient$g;-><init>(Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;ZLcom/viafree/android/w/m/a/a/a$a;)V
...
.method private W(Ljava/lang/String;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p2}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient$d;-><init>(Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;Lcom/viafree/android/w/m/a/a/a$a;)V

    invoke-virtual {p0, p1, v0}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->V(Ljava/lang/String;Lcom/viafree/android/w/m/a/a/a$a;)V

    return-void
.end method

.method private X(Lretrofit2/Response;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 3
    ...
    invoke-virtual {p1}, Lretrofit2/Response;->errorBody()Lh/d0;
    ...
    invoke-static {v2, v1}, Lcom/viafree/android/w/p/q;->a(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-interface {p2, v2}, Lcom/viafree/android/w/m/a/a/a$a;->a(Ljava/lang/Throwable;)V

    return-void

    .line 7
    :cond_1
    invoke-interface {p2, v0}, Lcom/viafree/android/w/m/a/a/a$a;->onSuccess(Ljava/lang/Object;)V

    return-void
.end method

.method private Y(Lretrofit2/Response;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 3
...
.method static synthetic w(Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;)Landroid/content/Context;
    .locals 0
...
.method static synthetic x(Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;)Lcom/viafree/android/w/q/d;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->a:Lcom/viafree/android/w/q/d;

    return-object p0
.end method

.method static synthetic y(Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;Ljava/lang/String;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->W(Ljava/lang/String;Lcom/viafree/android/w/m/a/a/a$a;)V

    return-void
.end method

.method static synthetic z(Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;Lretrofit2/Response;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->X(Lretrofit2/Response;Lcom/viafree/android/w/m/a/a/a$a;)V
...
# virtual methods
.method public K(Ljava/lang/String;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, p2}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->S(Lretrofit2/Call;Lcom/viafree/android/w/m/a/a/a$a;)V

    return-void
.end method

.method public synthetic O(Lh/u$a;)Lh/c0;
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-static {v1}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->M(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Lh/a0$a;->k(Lh/t;)Lh/a0$a;
    ...
    .line 7
    invoke-interface {p1, v0}, Lh/u$a;->c(Lh/a0;)Lh/c0;

    move-result-object v1

    .line 8
    invoke-virtual {v1}, Lh/c0;->M()I

    move-result v2

    .line 9
    iget-object v3, p0, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->a:Lcom/viafree/android/w/q/d;
    ...
    invoke-interface {v3}, Lcom/viafree/android/w/q/d;->f()Ljava/lang/String;
    ...
    invoke-static {v2, v5, v4}, Lcom/viafree/android/w/p/q;->h(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    .line 11
    iget-object v2, p0, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->a:Lcom/viafree/android/w/q/d;
    ...
    invoke-interface {v2, v1}, Lcom/viafree/android/w/q/d;->h(Ljava/lang/String;)V
    ...
    invoke-static {p1, v2, v0}, Lcom/viafree/android/w/p/q;->h(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    .line 21
    iget-object p1, p0, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->a:Lcom/viafree/android/w/q/d;

    const/4 v0, 0x0

    invoke-interface {p1, v0}, Lcom/viafree/android/w/q/d;->j(Landroid/app/Activity;)V

    :cond_1
    return-object v1
.end method

.method public synthetic P(ZLh/u$a;)Lh/c0;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1
    invoke-interface {p2}, Lh/u$a;->request()Lh/a0;
    ...
    invoke-virtual {p1, v0, v1}, Lh/a0$a;->d(Ljava/lang/String;Ljava/lang/String;)Lh/a0$a;
    ...
    .line 7
    :cond_0
    invoke-interface {p2, v0}, Lh/u$a;->c(Lh/a0;)Lh/c0;
    ...
    invoke-static {v1, v4, v3}, Lcom/viafree/android/w/p/q;->h(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    .line 11
    iget-object v1, p0, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->a:Lcom/viafree/android/w/q/d;
    ...
    invoke-interface {v1, p1}, Lcom/viafree/android/w/q/d;->h(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p1}, Lh/a0$a;->d(Ljava/lang/String;Ljava/lang/String;)Lh/a0$a;
    ...
    .line 19
    invoke-interface {p2, p1}, Lh/u$a;->c(Lh/a0;)Lh/c0;
    ...
    invoke-static {p2, v1, v0}, Lcom/viafree/android/w/p/q;->h(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    .line 21
    iget-object p2, p0, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->a:Lcom/viafree/android/w/q/d;

    const/4 v0, 0x0

    invoke-interface {p2, v0}, Lcom/viafree/android/w/q/d;->j(Landroid/app/Activity;)V

    :cond_2
    return-object p1
.end method

.method public synthetic Q(Lh/u$a;)Lh/c0;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 2
    invoke-virtual {v0, v1}, Lh/a0;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lh/t;->p()Lh/t$a;
    ...
    invoke-virtual {v3}, Lh/t;->B()Ljava/util/Set;
    ...
    .line 7
    :cond_0
    invoke-virtual {v2}, Lh/t$a;->c()Lh/t;
    ...
    invoke-static {v3}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->M(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 11
    invoke-virtual {v0, v2}, Lh/a0$a;->k(Lh/t;)Lh/a0$a;
...
.method protected S(Lretrofit2/Call;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 1

    const/4 v0, 0x0

    .line 1
    invoke-direct {p0, v0, p1, p2}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->T(ZLretrofit2/Call;Lcom/viafree/android/w/m/a/a/a$a;)V

    return-void
.end method

.method protected U(Lretrofit2/Call;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 1
...
.method public V(Ljava/lang/String;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p2}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient$e;-><init>(Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;Lcom/viafree/android/w/m/a/a/a$a;)V

    invoke-virtual {p0, p1, v0}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->U(Lretrofit2/Call;Lcom/viafree/android/w/m/a/a/a$a;)V

    return-void
.end method

.method public Z(Ljava/lang/String;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, p2}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->U(Lretrofit2/Call;Lcom/viafree/android/w/m/a/a/a$a;)V

    return-void
.end method

.method public a(Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v0, p1}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->S(Lretrofit2/Call;Lcom/viafree/android/w/m/a/a/a$a;)V
...
.method public b()Lcom/viafree/android/v/a/b;
    ...
    .line 1
    iget-object v0, p0, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->h:Lcom/viafree/android/v/a/b;
...
.method public c(Ljava/lang/String;)V
    ...
    sget-object v0, Lcom/viafree/android/w/m/a/a/a$a;->a:Lcom/viafree/android/w/m/a/a/a$a;
...
.method public d(Lcom/viafree/android/common/models/User;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public e(Ljava/lang/String;Ljava/lang/String;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, p3}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->U(Lretrofit2/Call;Lcom/viafree/android/w/m/a/a/a$a;)V

    return-void
.end method

.method public f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    iget-object p3, p0, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->a:Lcom/viafree/android/w/q/d;

    invoke-interface {p3}, Lcom/viafree/android/w/q/d;->c()Z
    ...
    invoke-interface {p4, p3}, Lcom/viafree/android/w/m/a/a/a$a;->a(Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->a:Lcom/viafree/android/w/q/d;
    ...
    invoke-virtual {p0, p1, p4}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->U(Lretrofit2/Call;Lcom/viafree/android/w/m/a/a/a$a;)V

    return-void
.end method

.method public g(Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public h(Ljava/lang/String;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public i(Ljava/lang/String;Ljava/lang/String;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public j(Lcom/viafree/android/common/statistics/clientstream/ClientStreamRequest;)V
    ...
    .line 2
    invoke-static {v1}, Lh/v;->d(Ljava/lang/String;)Lh/v;
    ...
    invoke-static {v1, v0}, Lh/b0;->create(Lh/v;Ljava/lang/String;)Lh/b0;
    ...
    .line 5
    invoke-virtual {v1, v0}, Lh/a0$a;->g(Lh/b0;)Lh/a0$a;
    ...
    .line 7
    iget-object v1, p0, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->d:Lh/x;
...
.method public k()Lcom/viafree/android/v/a/a;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->i:Lcom/viafree/android/v/a/a;

    return-object v0
.end method

.method public l(Ljava/lang/String;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v0, p1}, Lcom/viafree/android/common/data/rest/retrofit/g;->f(Ljava/lang/String;)Lretrofit2/Call;
...
.method public m(Lcom/viafree/viafreeandroidutility/dto/ProgramObject;Lcom/viafree/android/videoplayer/ad/models/Freewheel;Lcom/viafree/android/w/m/a/a/a$a;)Lretrofit2/Call;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2}, Lcom/viafree/android/w/q/d;->d()Lcom/viafree/android/common/models/User;
    ...
    .line 16
    invoke-virtual {p0, p1, p3}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->S(Lretrofit2/Call;Lcom/viafree/android/w/m/a/a/a$a;)V

    return-object p1
.end method

.method public n(Lcom/viafree/android/common/models/User;Ljava/lang/String;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p2, p0, p3}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient$b;-><init>(Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;Lcom/viafree/android/w/m/a/a/a$a;)V
...
.method public o(JLcom/viafree/android/w/m/a/a/a$a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
...
.method public p(Ljava/lang/String;Ljava/lang/String;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p3, p2}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient$c;-><init>(Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;Lcom/viafree/android/w/m/a/a/a$a;Ljava/lang/String;)V

    invoke-virtual {p0, p1, v0}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->Z(Ljava/lang/String;Lcom/viafree/android/w/m/a/a/a$a;)V

    return-void
.end method

.method public q(Ljava/lang/String;Ljava/lang/reflect/Type;ZLcom/viafree/android/w/m/a/a/a$a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v0, p0, p4, p2}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient$f;-><init>(Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;Lcom/viafree/android/w/m/a/a/a$a;Ljava/lang/reflect/Type;)V
    ...
    iget-object p4, p0, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->a:Lcom/viafree/android/w/q/d;

    invoke-interface {p4}, Lcom/viafree/android/w/q/d;->g()Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->S(Lretrofit2/Call;Lcom/viafree/android/w/m/a/a/a$a;)V

    :goto_0
    return-void
.end method

.method public r(Lcom/viafree/android/common/models/User;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public s(Ljava/lang/String;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public t(Ljava/lang/String;Ljava/lang/String;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public u(Ljava/lang/String;Ljava/lang/String;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public v(Lcom/viafree/android/common/models/User;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/viafree/android/w/m/a/a/a$a;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, p5}, Lcom/viafree/android/common/data/rest/retrofit/RetrofitApiClient;->U(Lretrofit2/Call;Lcom/viafree/android/w/m/a/a/a$a;)V
