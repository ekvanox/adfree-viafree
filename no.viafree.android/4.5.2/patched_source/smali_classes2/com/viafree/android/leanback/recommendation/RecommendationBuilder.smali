...
.method public a()Landroid/app/Notification;
    ...
    invoke-static {v5, v6, v1, v2}, Lcom/viafree/android/s/p/p;->a(Landroid/content/Context;Ljava/lang/String;II)Landroid/graphics/Bitmap;
    ...
    invoke-static {v2, v5, v3, v4}, Lcom/viafree/android/s/p/p;->a(Landroid/content/Context;Ljava/lang/String;II)Landroid/graphics/Bitmap;
    ...
    invoke-static {v3, v2, v5}, Lcom/viafree/android/s/p/r;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v3, v7}, Landroid/support/v4/app/y$d;-><init>(Landroid/content/Context;)V

    iget-object v7, p0, Lcom/viafree/android/leanback/recommendation/RecommendationBuilder;->c:Ljava/lang/String;

    .line 38
    invoke-virtual {v3, v7}, Landroid/support/v4/app/y$d;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$d;

    iget-object v7, p0, Lcom/viafree/android/leanback/recommendation/RecommendationBuilder;->d:Ljava/lang/String;

    .line 39
    invoke-virtual {v3, v7}, Landroid/support/v4/app/y$d;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$d;

    iget v7, p0, Lcom/viafree/android/leanback/recommendation/RecommendationBuilder;->g:I

    .line 40
    invoke-virtual {v3, v7}, Landroid/support/v4/app/y$d;->d(I)Landroid/support/v4/app/y$d;

    .line 41
    invoke-virtual {v3, v4}, Landroid/support/v4/app/y$d;->c(Z)Landroid/support/v4/app/y$d;

    .line 42
    invoke-virtual {v3, v4}, Landroid/support/v4/app/y$d;->d(Z)Landroid/support/v4/app/y$d;
    ...
    invoke-virtual {v3, v4}, Landroid/support/v4/app/y$d;->b(I)Landroid/support/v4/app/y$d;

    .line 44
    invoke-virtual {v3, v5}, Landroid/support/v4/app/y$d;->a(Ljava/lang/String;)Landroid/support/v4/app/y$d;
    ...
    .line 48
    invoke-virtual {v3, v0}, Landroid/support/v4/app/y$d;->a(Landroid/os/Bundle;)Landroid/support/v4/app/y$d;

    invoke-direct {v2, v3}, Landroid/support/v4/app/y$b;-><init>(Landroid/support/v4/app/y$d;)V

    .line 49
    invoke-virtual {v2}, Landroid/support/v4/app/y$e;->a()Landroid/app/Notification;
