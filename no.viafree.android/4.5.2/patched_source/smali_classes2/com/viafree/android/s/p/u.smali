.class public Lcom/viafree/android/s/p/u;
...
.method public static a(Ljava/util/Date;Landroid/content/Context;)Landroid/text/Spannable;
    ...
    .line 43
    new-instance v1, Lcom/viafree/android/s/p/k;

    invoke-direct {v1}, Lcom/viafree/android/s/p/k;-><init>()V

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    invoke-static {p1, p0}, Lcom/viafree/android/s/p/k;->a(Landroid/content/Context;Ljava/util/Date;)Ljava/lang/String;
...
.method protected static a(Landroid/app/Activity;JLjava/lang/String;Ljava/lang/String;ZLcom/viafree/android/common/models/d;Lcom/viafree/android/common/statistics/ga/f;)V
    .locals 7

    const-string v0, "openVideo_click"

    .line 15
    invoke-interface {p7, v0}, Lcom/viafree/android/common/statistics/ga/f;->f(Ljava/lang/String;)V
    ...
    .line 16
    invoke-interface {p7, p1}, Lcom/viafree/android/common/statistics/ga/f;->f(Ljava/lang/String;)V
    ...
    .line 18
    invoke-interface {p7, p4}, Lcom/viafree/android/common/statistics/ga/f;->f(Ljava/lang/String;)V
...
.method private static a(Landroid/content/Context;ILcom/viafree/android/s/p/u$a;)V
    .locals 6
    ...
    invoke-direct {v0, p2}, Lcom/viafree/android/s/p/e;-><init>(Lcom/viafree/android/s/p/u$a;)V
    ...
    invoke-direct {v0, p2}, Lcom/viafree/android/s/p/c;-><init>(Lcom/viafree/android/s/p/u$a;)V
    ...
    invoke-interface {p2, p0}, Lcom/viafree/android/s/p/u$a;->a(Ljava/lang/Object;)V
...
.method public static a(Landroid/support/v4/app/h;JJLjava/lang/String;ZZLjava/lang/String;Ljava/lang/String;ZLcom/viafree/android/common/models/d;Ljava/lang/Integer;Lcom/viafree/android/common/statistics/ga/f;)V
    .locals 12
    ...
    .line 8
    invoke-static/range {v1 .. v11}, Lcom/viafree/android/s/p/u;->a(Landroid/support/v4/app/h;JJLjava/lang/String;ZLjava/lang/String;Ljava/lang/String;Lcom/viafree/android/common/models/d;Ljava/lang/Integer;)V
    ...
    invoke-static/range {v0 .. v7}, Lcom/viafree/android/s/p/u;->a(Landroid/app/Activity;JLjava/lang/String;Ljava/lang/String;ZLcom/viafree/android/common/models/d;Lcom/viafree/android/common/statistics/ga/f;)V
    ...
    .line 10
    invoke-interface {v9, p1, p2, v0}, Lcom/viafree/android/common/statistics/ga/f;->a(JLjava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v9}, Lcom/viafree/android/s/p/d;-><init>(Landroid/support/v4/app/h;JLjava/lang/String;JZLcom/viafree/android/common/models/d;Lcom/viafree/android/common/statistics/ga/f;)V

    move-object v0, p0

    invoke-static {p0, v10, v11}, Lcom/viafree/android/s/p/u;->a(Landroid/content/Context;ILcom/viafree/android/s/p/u$a;)V

    :goto_2
    return-void
.end method

.method static synthetic a(Landroid/support/v4/app/h;JLjava/lang/String;JZLcom/viafree/android/common/models/d;Lcom/viafree/android/common/statistics/ga/f;Ljava/lang/Boolean;)V
    .locals 9
    ...
    invoke-static/range {v1 .. v8}, Lcom/viafree/android/s/p/u;->a(Landroid/app/Activity;JLjava/lang/String;Ljava/lang/String;ZLcom/viafree/android/common/models/d;Lcom/viafree/android/common/statistics/ga/f;)V

    :cond_1
    return-void
.end method

.method public static a(Landroid/support/v4/app/h;Lcom/viafree/android/common/data/rest/dto/ProgramObject;Ljava/lang/String;ZZLcom/viafree/android/common/statistics/ga/f;)V
    .locals 16
    ...
    invoke-virtual {v2}, Lcom/viafree/android/common/data/rest/dto/Video;->b()Lcom/viafree/android/common/data/rest/dto/LoginRequired;
    ...
    invoke-virtual {v2}, Lcom/viafree/android/common/data/rest/dto/LoginRequired;->b()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/viafree/android/common/data/rest/dto/LoginRequired;->a()Lcom/viafree/android/common/data/rest/dto/ImageUrl;
...
.method static synthetic a(Lcom/viafree/android/s/p/u$a;Landroid/content/DialogInterface;I)V
    .locals 0
    ...
    invoke-interface {p0, p1}, Lcom/viafree/android/s/p/u$a;->a(Ljava/lang/Object;)V

    return-void
.end method

.method static synthetic b(Lcom/viafree/android/s/p/u$a;Landroid/content/DialogInterface;I)V
    .locals 0
