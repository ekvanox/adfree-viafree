...
.method constructor <init>(Lretrofit2/ServiceMethod$Builder;)V
    ...
    invoke-virtual {v0}, Lretrofit2/Retrofit;->callFactory()Lh/e$a;

    move-result-object v0

    iput-object v0, p0, Lretrofit2/ServiceMethod;->callFactory:Lh/e$a;
    ...
    invoke-virtual {v0}, Lretrofit2/Retrofit;->baseUrl()Lh/t;

    move-result-object v0

    iput-object v0, p0, Lretrofit2/ServiceMethod;->baseUrl:Lh/t;
    ...
    .line 8
    iget-object v0, p1, Lretrofit2/ServiceMethod$Builder;->headers:Lh/s;

    iput-object v0, p0, Lretrofit2/ServiceMethod;->headers:Lh/s;

    .line 9
    iget-object v0, p1, Lretrofit2/ServiceMethod$Builder;->contentType:Lh/v;

    iput-object v0, p0, Lretrofit2/ServiceMethod;->contentType:Lh/v;
...
.method varargs toCall([Ljava/lang/Object;)Lh/e;
    .locals 10
    ...
    iget-object v2, p0, Lretrofit2/ServiceMethod;->baseUrl:Lh/t;

    iget-object v3, p0, Lretrofit2/ServiceMethod;->relativeUrl:Ljava/lang/String;

    iget-object v4, p0, Lretrofit2/ServiceMethod;->headers:Lh/s;

    iget-object v5, p0, Lretrofit2/ServiceMethod;->contentType:Lh/v;
    ...
    invoke-direct/range {v0 .. v8}, Lretrofit2/RequestBuilder;-><init>(Ljava/lang/String;Lh/t;Ljava/lang/String;Lh/s;Lh/v;ZZZ)V
    ...
    .line 6
    :cond_1
    iget-object p1, p0, Lretrofit2/ServiceMethod;->callFactory:Lh/e$a;

    invoke-virtual {v9}, Lretrofit2/RequestBuilder;->build()Lh/a0;
...
.method toResponse(Lh/d0;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
