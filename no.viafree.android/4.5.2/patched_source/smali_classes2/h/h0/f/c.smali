...
.method private a(IILh/a0;Lh/t;)Lh/a0;
    ...
    invoke-interface {v1}, Li/s;->timeout()Li/t;
    ...
    invoke-virtual {v1, v4, v5, v2}, Li/t;->a(JLjava/util/concurrent/TimeUnit;)Li/t;

    .line 120
    iget-object v1, p0, Lh/h0/f/c;->j:Li/d;

    invoke-interface {v1}, Li/r;->timeout()Li/t;
    ...
    .line 127
    :cond_0
    invoke-virtual {v0, v1, v2}, Lh/h0/h/a;->b(J)Li/s;
    ...
    invoke-static {v0, v1, v2}, Lh/h0/c;->b(Li/s;ILjava/util/concurrent/TimeUnit;)Z

    .line 129
    invoke-interface {v0}, Li/s;->close()V

    .line 130
    invoke-virtual {p3}, Lh/c0;->z()I
    ...
    .line 132
    invoke-virtual {p3, v1}, Lh/c0;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {p1}, Li/e;->b()Li/c;
...
.method private a(IILh/e;Lh/p;)V
    ...
    invoke-virtual {p2, p3, p4, p1}, Lh/h0/k/f;->a(Ljava/net/Socket;Ljava/net/InetSocketAddress;I)V
    :try_end_0
    ...
    invoke-static {p1}, Li/l;->b(Ljava/net/Socket;)Li/s;
    ...
    invoke-static {p1}, Li/l;->a(Ljava/net/Socket;)Li/r;
...
.method private a(Lh/h0/f/b;)V
    ...
    .line 86
    invoke-virtual {v3, v1, v4, v5}, Lh/h0/k/f;->a(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List;)V
    ...
    .line 89
    invoke-direct {p0, v3}, Lh/h0/f/c;->a(Ljavax/net/ssl/SSLSession;)Z
    ...
    .line 93
    invoke-virtual {v4}, Lh/r;->c()Ljava/util/List;
    ...
    invoke-virtual {p1, v1}, Lh/h0/k/f;->b(Ljavax/net/ssl/SSLSocket;)Ljava/lang/String;
    ...
    invoke-virtual {p1, v1}, Lh/h0/k/f;->a(Ljavax/net/ssl/SSLSocket;)V
    ...
    invoke-virtual {v0, v1}, Lh/h0/k/f;->a(Ljavax/net/ssl/SSLSocket;)V
...
.method private a(Lh/h0/f/b;ILh/e;Lh/p;)V
    ...
    .line 71
    new-instance p1, Lh/h0/i/g$g;

    const/4 p3, 0x1

    invoke-direct {p1, p3}, Lh/h0/i/g$g;-><init>(Z)V

    iget-object p3, p0, Lh/h0/f/c;->e:Ljava/net/Socket;

    iget-object p4, p0, Lh/h0/f/c;->c:Lh/e0;

    .line 72
    invoke-virtual {p4}, Lh/e0;->a()Lh/a;

    move-result-object p4

    invoke-virtual {p4}, Lh/a;->k()Lh/t;

    move-result-object p4

    invoke-virtual {p4}, Lh/t;->g()Ljava/lang/String;
    ...
    invoke-virtual {p1, p3, p4, v0, v1}, Lh/h0/i/g$g;->a(Ljava/net/Socket;Ljava/lang/String;Li/e;Li/d;)Lh/h0/i/g$g;

    .line 73
    invoke-virtual {p1, p0}, Lh/h0/i/g$g;->a(Lh/h0/i/g$h;)Lh/h0/i/g$g;

    .line 74
    invoke-virtual {p1, p2}, Lh/h0/i/g$g;->a(I)Lh/h0/i/g$g;

    .line 75
    invoke-virtual {p1}, Lh/h0/i/g$g;->a()Lh/h0/i/g;
    ...
    invoke-virtual {p1}, Lh/h0/i/g;->y()V
...
.method public a(Lh/x;Lh/u$a;Lh/h0/f/g;)Lh/h0/g/c;
    ...
    invoke-virtual {v0, v1, v2, v3}, Li/t;->a(JLjava/util/concurrent/TimeUnit;)Li/t;
    ...
    invoke-virtual {v0, v1, v2, p2}, Li/t;->a(JLjava/util/concurrent/TimeUnit;)Li/t;
...
.method public a(IIIIZLh/e;Lh/p;)V
    ...
    invoke-virtual {v1, v0}, Lh/h0/k/f;->b(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0}, Lh/h0/i/g;->x()I
...
.method public a(Lh/h0/i/g;)V
    ...
    .line 169
    :try_start_0
    invoke-virtual {p1}, Lh/h0/i/g;->x()I
...
.method public a(Lh/t;)Z
    ...
    invoke-virtual {v3}, Lh/r;->c()Ljava/util/List;
...
.method public a(Z)Z
    ...
    .line 162
    invoke-virtual {v0}, Lh/h0/i/g;->w()Z
