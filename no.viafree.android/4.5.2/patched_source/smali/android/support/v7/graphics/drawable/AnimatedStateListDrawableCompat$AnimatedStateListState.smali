...
.method constructor <init>(Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat;Landroid/content/res/Resources;)V
    ...
    .line 2
    iget-object p2, p1, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:La/b/k/h/h;

    iput-object p2, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:La/b/k/h/h;

    .line 3
    iget-object p1, p1, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:La/b/k/h/r;

    iput-object p1, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:La/b/k/h/r;

    goto :goto_0

    .line 4
    :cond_0
    new-instance p1, La/b/k/h/h;

    invoke-direct {p1}, La/b/k/h/h;-><init>()V

    iput-object p1, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:La/b/k/h/h;
...
.method addStateSet([ILandroid/graphics/drawable/Drawable;I)I
    ...
    .line 2
    iget-object p2, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:La/b/k/h/r;

    invoke-static {p3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object p3

    invoke-virtual {p2, p1, p3}, La/b/k/h/r;->c(ILjava/lang/Object;)V
...
.method addTransition(IILandroid/graphics/drawable/Drawable;Z)I
    ...
    .line 3
    :goto_0
    iget-object v4, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:La/b/k/h/h;
    ...
    invoke-virtual {v4, v0, v1, v7}, La/b/k/h/h;->a(JLjava/lang/Object;)V
    ...
    .line 5
    iget-object p4, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:La/b/k/h/h;
    ...
    invoke-virtual {p4, p1, p2, v0}, La/b/k/h/h;->a(JLjava/lang/Object;)V
...
.method getKeyframeIdAt(I)I
    ...
    .line 1
    :cond_0
    iget-object v1, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:La/b/k/h/r;

    invoke-static {v0}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v0

    invoke-virtual {v1, p1, v0}, La/b/k/h/r;->b(ILjava/lang/Object;)Ljava/lang/Object;
...
.method indexOfTransition(II)I
    ...
    .line 2
    iget-object v0, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:La/b/k/h/h;
    ...
    invoke-virtual {v0, p1, p2, v1}, La/b/k/h/h;->b(JLjava/lang/Object;)Ljava/lang/Object;
...
.method mutate()V
    ...
    invoke-virtual {v0}, La/b/k/h/h;->clone()La/b/k/h/h;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:La/b/k/h/h;

    .line 2
    iget-object v0, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:La/b/k/h/r;

    invoke-virtual {v0}, La/b/k/h/r;->clone()La/b/k/h/r;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:La/b/k/h/r;
