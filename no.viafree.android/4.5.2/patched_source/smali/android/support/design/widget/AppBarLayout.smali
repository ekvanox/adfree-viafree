...
.field private g:Landroid/support/v4/view/c0;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 10
    sget v1, La/b/d/j;->Widget_Design_AppBarLayout:I

    invoke-static {p0, p2, v0, v1}, Landroid/support/design/widget/v;->a(Landroid/view/View;Landroid/util/AttributeSet;II)V

    .line 11
    :cond_0
    sget-object v5, La/b/d/k;->AppBarLayout:[I

    const/4 v6, 0x0

    sget v7, La/b/d/j;->Widget_Design_AppBarLayout:I
    ...
    .line 12
    invoke-static/range {v3 .. v8}, Landroid/support/design/internal/g;->c(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroid/content/res/TypedArray;

    move-result-object p1

    .line 13
    sget p2, La/b/d/k;->AppBarLayout_android_background:I

    invoke-virtual {p1, p2}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-static {p0, p2}, Landroid/support/v4/view/u;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    .line 14
    sget p2, La/b/d/k;->AppBarLayout_expanded:I
    ...
    sget p2, La/b/d/k;->AppBarLayout_elevation:I
    ...
    .line 23
    sget p2, La/b/d/k;->AppBarLayout_android_keyboardNavigationCluster:I
    ...
    .line 27
    :cond_3
    sget p2, La/b/d/k;->AppBarLayout_android_touchscreenBlocksFocus:I
    ...
    .line 31
    :cond_4
    sget p2, La/b/d/k;->AppBarLayout_liftOnScroll:I

    invoke-virtual {p1, p2, v0}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p2

    iput-boolean p2, p0, Landroid/support/design/widget/AppBarLayout;->l:Z
...
.method private e()Z
    ...
    check-cast v3, Landroid/support/design/widget/AppBarLayout$c;

    invoke-virtual {v3}, Landroid/support/design/widget/AppBarLayout$c;->c()Z
...
.method a(Landroid/support/v4/view/c0;)Landroid/support/v4/view/c0;
    ...
    .line 18
    :goto_0
    iget-object v1, p0, Landroid/support/design/widget/AppBarLayout;->g:Landroid/support/v4/view/c0;
    ...
    .line 19
    iput-object v0, p0, Landroid/support/design/widget/AppBarLayout;->g:Landroid/support/v4/view/c0;
...
.method public a(Landroid/support/design/widget/AppBarLayout$d;)V
    .locals 0

    .line 5
    invoke-virtual {p0, p1}, Landroid/support/design/widget/AppBarLayout;->a(Landroid/support/design/widget/AppBarLayout$b;)V
...
.method public b(Landroid/support/design/widget/AppBarLayout$d;)V
    .locals 0

    .line 3
    invoke-virtual {p0, p1}, Landroid/support/design/widget/AppBarLayout;->b(Landroid/support/design/widget/AppBarLayout$b;)V
...
.method protected generateDefaultLayoutParams()Landroid/support/design/widget/AppBarLayout$c;
    .locals 3
...
.method protected bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 1
    invoke-virtual {p0}, Landroid/support/design/widget/AppBarLayout;->generateDefaultLayoutParams()Landroid/support/design/widget/AppBarLayout$c;
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/support/design/widget/AppBarLayout$c;
    .locals 2
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/design/widget/AppBarLayout$c;
    .locals 2
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroid/support/design/widget/AppBarLayout;->generateLayoutParams(Landroid/util/AttributeSet;)Landroid/support/design/widget/AppBarLayout$c;
...
.method protected bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 2
    invoke-virtual {p0, p1}, Landroid/support/design/widget/AppBarLayout;->generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/design/widget/AppBarLayout$c;
...
.method getDownNestedPreScrollRange()I
    ...
    .line 8
    invoke-static {v3}, Landroid/support/v4/view/u;->l(Landroid/view/View;)I
...
.method getDownNestedScrollRange()I
    ...
    .line 8
    invoke-static {v4}, Landroid/support/v4/view/u;->l(Landroid/view/View;)I
...
.method final getTopInset()I
    ...
    .line 1
    iget-object v0, p0, Landroid/support/design/widget/AppBarLayout;->g:Landroid/support/v4/view/c0;
...
.method protected onCreateDrawableState(I)[I
    ...
    sget v2, La/b/d/b;->state_liftable:I
    ...
    iget-boolean v2, p0, Landroid/support/design/widget/AppBarLayout;->k:Z

    if-eqz v2, :cond_2

    sget v2, La/b/d/b;->state_lifted:I
    ...
    sget v2, La/b/d/b;->state_collapsible:I
    ...
    sget v2, La/b/d/b;->state_collapsed:I
...
.method protected onLayout(ZIIII)V
    ...
    .line 7
    invoke-virtual {p5}, Landroid/support/design/widget/AppBarLayout$c;->b()Landroid/view/animation/Interpolator;
    ...
    .line 10
    iget-boolean p2, p0, Landroid/support/design/widget/AppBarLayout;->l:Z
