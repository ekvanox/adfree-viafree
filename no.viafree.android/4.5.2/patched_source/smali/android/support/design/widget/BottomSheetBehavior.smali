...
.field m:Landroid/support/v4/widget/t;
...
.field private t:Landroid/support/design/widget/BottomSheetBehavior$c;
...
.field private final z:Landroid/support/v4/widget/t$c;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Landroid/support/design/widget/BottomSheetBehavior$b;-><init>(Landroid/support/design/widget/BottomSheetBehavior;)V

    iput-object v0, p0, Landroid/support/design/widget/BottomSheetBehavior;->z:Landroid/support/v4/widget/t$c;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v1, p0}, Landroid/support/design/widget/BottomSheetBehavior$b;-><init>(Landroid/support/design/widget/BottomSheetBehavior;)V

    iput-object v1, p0, Landroid/support/design/widget/BottomSheetBehavior;->z:Landroid/support/v4/widget/t$c;

    .line 9
    sget-object v1, La/b/d/k;->BottomSheetBehavior_Layout:[I
    ...
    .line 10
    sget v1, La/b/d/k;->BottomSheetBehavior_Layout_behavior_peekHeight:I
    ...
    .line 16
    :goto_0
    sget v1, La/b/d/k;->BottomSheetBehavior_Layout_behavior_hideable:I
    ...
    .line 17
    sget v1, La/b/d/k;->BottomSheetBehavior_Layout_behavior_fitToContents:I
    ...
    .line 20
    sget v0, La/b/d/k;->BottomSheetBehavior_Layout_behavior_skipCollapsed:I
...
.method private d(Z)V
    ...
    invoke-static {v4, v5}, Landroid/support/v4/view/u;->f(Landroid/view/View;I)V
...
.method a(Landroid/view/View;)Landroid/view/View;
    ...
    .line 115
    invoke-static {p1}, Landroid/support/v4/view/u;->z(Landroid/view/View;)Z
...
.method a(I)V
    ...
    .line 132
    iget-object v1, p0, Landroid/support/design/widget/BottomSheetBehavior;->t:Landroid/support/design/widget/BottomSheetBehavior$c;
    ...
    invoke-virtual {v1, v0, p1}, Landroid/support/design/widget/BottomSheetBehavior$c;->a(Landroid/view/View;F)V
...
.method public a(Landroid/support/design/widget/BottomSheetBehavior$c;)V
    .locals 0

    .line 110
    iput-object p1, p0, Landroid/support/design/widget/BottomSheetBehavior;->t:Landroid/support/design/widget/BottomSheetBehavior$c;
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;I)V
    ...
    .line 98
    :goto_2
    iget-object p4, p0, Landroid/support/design/widget/BottomSheetBehavior;->m:Landroid/support/v4/widget/t;

    invoke-virtual {p2}, Landroid/view/View;->getLeft()I

    move-result v1

    invoke-virtual {p4, p2, v1, p1}, Landroid/support/v4/widget/t;->b(Landroid/view/View;II)Z
    ...
    invoke-direct {p1, p0, p2, v0}, Landroid/support/design/widget/BottomSheetBehavior$d;-><init>(Landroid/support/design/widget/BottomSheetBehavior;Landroid/view/View;I)V

    invoke-static {p2, p1}, Landroid/support/v4/view/u;->a(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;II[II)V
    ...
    invoke-static {p2, p3}, Landroid/support/v4/view/u;->d(Landroid/view/View;I)V
...
.method a(Landroid/view/View;I)V
    ...
    .line 126
    :goto_0
    iget-object v1, p0, Landroid/support/design/widget/BottomSheetBehavior;->m:Landroid/support/v4/widget/t;

    invoke-virtual {p1}, Landroid/view/View;->getLeft()I

    move-result v2

    invoke-virtual {v1, p1, v2, v0}, Landroid/support/v4/widget/t;->b(Landroid/view/View;II)Z
    ...
    invoke-direct {v0, p0, p1, p2}, Landroid/support/design/widget/BottomSheetBehavior$d;-><init>(Landroid/support/design/widget/BottomSheetBehavior;Landroid/view/View;I)V

    invoke-static {p1, v0}, Landroid/support/v4/view/u;->a(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    invoke-static {p2}, Landroid/support/v4/view/u;->h(Landroid/view/View;)Z
    ...
    sget v2, La/b/d/d;->design_bottom_sheet_peek_height_min:I
    ...
    invoke-static {p2, v0}, Landroid/support/v4/view/u;->d(Landroid/view/View;I)V

    .line 29
    :cond_8
    :goto_1
    iget-object p3, p0, Landroid/support/design/widget/BottomSheetBehavior;->m:Landroid/support/v4/widget/t;

    if-nez p3, :cond_9

    .line 30
    iget-object p3, p0, Landroid/support/design/widget/BottomSheetBehavior;->z:Landroid/support/v4/widget/t$c;

    invoke-static {p1, p3}, Landroid/support/v4/widget/t;->a(Landroid/view/ViewGroup;Landroid/support/v4/widget/t$c;)Landroid/support/v4/widget/t;

    move-result-object p1

    iput-object p1, p0, Landroid/support/design/widget/BottomSheetBehavior;->m:Landroid/support/v4/widget/t;
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-object p2, p0, Landroid/support/design/widget/BottomSheetBehavior;->m:Landroid/support/v4/widget/t;

    if-eqz p2, :cond_9

    .line 53
    invoke-virtual {p2, p3}, Landroid/support/v4/widget/t;->b(Landroid/view/MotionEvent;)Z
    ...
    iget-object p1, p0, Landroid/support/design/widget/BottomSheetBehavior;->m:Landroid/support/v4/widget/t;
    ...
    invoke-virtual {p2}, Landroid/support/v4/widget/t;->e()I
...
.method public b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    .line 5
    :cond_1
    iget-object v0, p0, Landroid/support/design/widget/BottomSheetBehavior;->m:Landroid/support/v4/widget/t;

    if-eqz v0, :cond_2

    .line 6
    invoke-virtual {v0, p3}, Landroid/support/v4/widget/t;->a(Landroid/view/MotionEvent;)V
...
.method public final c(I)V
    ...
    invoke-direct {v1, p0, v0, p1}, Landroid/support/design/widget/BottomSheetBehavior$a;-><init>(Landroid/support/design/widget/BottomSheetBehavior;Landroid/view/View;I)V
...
.method d(I)V
    ...
    .line 8
    invoke-virtual {v1, v0, p1}, Landroid/support/design/widget/BottomSheetBehavior$c;->a(Landroid/view/View;I)V
