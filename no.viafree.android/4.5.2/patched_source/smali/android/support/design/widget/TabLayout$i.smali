...
# instance fields
.field private b:Landroid/support/design/widget/TabLayout$g;
...
.method public constructor <init>(Landroid/support/design/widget/TabLayout;Landroid/content/Context;)V
    ...
    .line 4
    invoke-direct {p0, p2}, Landroid/support/design/widget/TabLayout$i;->a(Landroid/content/Context;)V
    ...
    invoke-static {p0, p2, v0, v1, v2}, Landroid/support/v4/view/u;->b(Landroid/view/View;IIII)V
    ...
    .line 10
    invoke-static {p0, p1}, Landroid/support/v4/view/u;->a(Landroid/view/View;Landroid/support/v4/view/r;)V
...
.method static synthetic a(Landroid/support/design/widget/TabLayout$i;)I
    ...
    .line 3
    invoke-direct {p0}, Landroid/support/design/widget/TabLayout$i;->d()I
...
.method private a(Landroid/content/Context;)V
    ...
    .line 16
    invoke-static {v3}, La/b/d/r/a;->a(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method private a(Landroid/graphics/Canvas;)V
    ...
    .line 24
    iget-object v0, p0, Landroid/support/design/widget/TabLayout$i;->h:Landroid/graphics/drawable/Drawable;
...
.method static synthetic a(Landroid/support/design/widget/TabLayout$i;Landroid/content/Context;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Landroid/support/design/widget/TabLayout$i;->a(Landroid/content/Context;)V

    return-void
.end method

.method static synthetic a(Landroid/support/design/widget/TabLayout$i;Landroid/graphics/Canvas;)V
    .locals 0

    .line 2
    invoke-direct {p0, p1}, Landroid/support/design/widget/TabLayout$i;->a(Landroid/graphics/Canvas;)V
...
.method private a(Landroid/widget/TextView;Landroid/widget/ImageView;)V
    ...
    .line 33
    invoke-virtual {v0}, Landroid/support/design/widget/TabLayout$g;->b()Landroid/graphics/drawable/Drawable;
...
.method private d()I
    ...
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$i;->d:Landroid/widget/ImageView;

    const/4 v3, 0x1

    aput-object v1, v0, v3

    iget-object v1, p0, Landroid/support/design/widget/TabLayout$i;->e:Landroid/view/View;
...
.method a()V
    ...
    .line 30
    invoke-virtual {p0, v0}, Landroid/support/design/widget/TabLayout$i;->a(Landroid/support/design/widget/TabLayout$g;)V
...
.method a(Landroid/support/design/widget/TabLayout$g;)V
    .locals 1
...
.method final b()V
    ...
    .line 2
    invoke-virtual {v0}, Landroid/support/design/widget/TabLayout$g;->a()Landroid/view/View;
    ...
    .line 14
    invoke-static {v3}, Landroid/support/v4/widget/q;->d(Landroid/widget/TextView;)I
    ...
    sget v4, La/b/d/h;->design_layout_tab_icon:I
    ...
    sget v2, La/b/d/h;->design_layout_tab_text:I
    ...
    invoke-static {v1}, Landroid/support/v4/widget/q;->d(Landroid/widget/TextView;)I
    ...
    invoke-direct {p0, v1, v2}, Landroid/support/design/widget/TabLayout$i;->a(Landroid/widget/TextView;Landroid/widget/ImageView;)V
    ...
    .line 44
    invoke-static {v0}, Landroid/support/design/widget/TabLayout$g;->a(Landroid/support/design/widget/TabLayout$g;)Ljava/lang/CharSequence;
    ...
    .line 46
    invoke-virtual {v0}, Landroid/support/design/widget/TabLayout$g;->e()Z
    ...
    :cond_11
    invoke-virtual {p0, v3}, Landroid/support/design/widget/TabLayout$i;->setSelected(Z)V
...
.method final c()V
    ...
    invoke-direct {p0, v0, v1}, Landroid/support/design/widget/TabLayout$i;->a(Landroid/widget/TextView;Landroid/widget/ImageView;)V
...
.method public onMeasure(II)V
    ...
    invoke-static {v5}, Landroid/support/v4/widget/q;->d(Landroid/widget/TextView;)I
    ...
    .line 17
    invoke-direct {p0, v2, v6, v0}, Landroid/support/design/widget/TabLayout$i;->a(Landroid/text/Layout;IF)F
