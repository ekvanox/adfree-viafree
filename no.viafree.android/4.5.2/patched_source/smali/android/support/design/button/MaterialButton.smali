...
# instance fields
.field private final b:Landroid/support/design/button/b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 2
    sget v0, La/b/d/b;->materialButtonStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 4
    sget-object v2, La/b/d/k;->MaterialButton:[I

    sget v4, La/b/d/j;->Widget_MaterialComponents_Button:I
    ...
    .line 6
    sget p2, La/b/d/k;->MaterialButton_iconPadding:I

    invoke-virtual {p1, p2, v6}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result p2

    iput p2, p0, Landroid/support/design/button/MaterialButton;->c:I

    .line 7
    sget p2, La/b/d/k;->MaterialButton_iconTintMode:I
    ...
    .line 9
    invoke-static {p2, p3}, Landroid/support/design/internal/h;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p2

    iput-object p2, p0, Landroid/support/design/button/MaterialButton;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    sget p3, La/b/d/k;->MaterialButton_iconTint:I

    .line 11
    invoke-static {p2, p1, p3}, La/b/d/q/a;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object p2

    iput-object p2, p0, Landroid/support/design/button/MaterialButton;->e:Landroid/content/res/ColorStateList;
    ...
    sget p3, La/b/d/k;->MaterialButton_icon:I

    invoke-static {p2, p1, p3}, La/b/d/q/a;->b(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    iput-object p2, p0, Landroid/support/design/button/MaterialButton;->f:Landroid/graphics/drawable/Drawable;

    .line 13
    sget p2, La/b/d/k;->MaterialButton_iconGravity:I
    ...
    .line 14
    sget p2, La/b/d/k;->MaterialButton_iconSize:I

    invoke-virtual {p1, p2, v6}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result p2

    iput p2, p0, Landroid/support/design/button/MaterialButton;->g:I
    ...
    iput-object p2, p0, Landroid/support/design/button/MaterialButton;->b:Landroid/support/design/button/b;

    .line 16
    iget-object p2, p0, Landroid/support/design/button/MaterialButton;->b:Landroid/support/design/button/b;
    ...
    .line 18
    iget p1, p0, Landroid/support/design/button/MaterialButton;->c:I
...
.method private b()Z
    ...
    .line 1
    iget-object v0, p0, Landroid/support/design/button/MaterialButton;->b:Landroid/support/design/button/b;
...
.method public getIconTint()Landroid/content/res/ColorStateList;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/design/button/MaterialButton;->e:Landroid/content/res/ColorStateList;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p1, p0, Landroid/support/design/button/MaterialButton;->b:Landroid/support/design/button/b;
...
.method protected onMeasure(II)V
    ...
    .line 2
    iget-object p1, p0, Landroid/support/design/button/MaterialButton;->f:Landroid/graphics/drawable/Drawable;
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 2
    iput-object p1, p0, Landroid/support/design/button/MaterialButton;->f:Landroid/graphics/drawable/Drawable;
...
.method public setIconPadding(I)V
    ...
    .line 2
    iput p1, p0, Landroid/support/design/button/MaterialButton;->c:I
...
.method public setIconSize(I)V
    ...
    .line 2
    iput p1, p0, Landroid/support/design/button/MaterialButton;->g:I
...
.method public setIconTint(Landroid/content/res/ColorStateList;)V
    ...
    .line 2
    iput-object p1, p0, Landroid/support/design/button/MaterialButton;->e:Landroid/content/res/ColorStateList;
...
.method public setIconTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 2
    iput-object p1, p0, Landroid/support/design/button/MaterialButton;->d:Landroid/graphics/PorterDuff$Mode;
