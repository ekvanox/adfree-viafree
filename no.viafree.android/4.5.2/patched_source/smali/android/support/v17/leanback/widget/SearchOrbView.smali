...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 2
    sget v0, La/b/j/a/b;->searchOrbViewStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget v2, La/b/j/a/g;->search_orb:I

    invoke-virtual {v1, v2}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v17/leanback/widget/SearchOrbView;->d:Landroid/view/View;

    .line 11
    iget-object v1, p0, Landroid/support/v17/leanback/widget/SearchOrbView;->c:Landroid/view/View;

    sget v2, La/b/j/a/g;->icon:I
    ...
    iput-object v1, p0, Landroid/support/v17/leanback/widget/SearchOrbView;->e:Landroid/widget/ImageView;
    ...
    sget v2, La/b/j/a/f;->lb_search_orb_focused_zoom:I

    invoke-virtual {v1, v2, v3, v3}, Landroid/content/res/Resources;->getFraction(III)F

    move-result v1

    iput v1, p0, Landroid/support/v17/leanback/widget/SearchOrbView;->h:F
    ...
    sget v2, La/b/j/a/h;->lb_search_orb_pulse_duration_ms:I
    ...
    sget v2, La/b/j/a/h;->lb_search_orb_scale_duration_ms:I

    invoke-virtual {v1, v2}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v1

    iput v1, p0, Landroid/support/v17/leanback/widget/SearchOrbView;->j:I
    ...
    sget v2, La/b/j/a/d;->lb_search_orb_focused_z:I
    ...
    iput v1, p0, Landroid/support/v17/leanback/widget/SearchOrbView;->l:F
    ...
    sget v2, La/b/j/a/d;->lb_search_orb_unfocused_z:I
    ...
    .line 17
    sget-object v1, La/b/j/a/m;->lbSearchOrbView:[I
    ...
    .line 18
    sget p2, La/b/j/a/m;->lbSearchOrbView_searchOrbIcon:I
    ...
    .line 19
    sget p2, La/b/j/a/e;->lb_ic_in_app_search:I
    ...
    .line 21
    sget p2, La/b/j/a/c;->lb_default_search_color:I
    ...
    .line 22
    sget p3, La/b/j/a/m;->lbSearchOrbView_searchOrbColor:I
    ...
    .line 23
    sget p3, La/b/j/a/m;->lbSearchOrbView_searchOrbBrightColor:I
    ...
    .line 24
    sget v0, La/b/j/a/m;->lbSearchOrbView_searchOrbIconColor:I
    ...
    invoke-direct {v1, p2, p3, v0}, Landroid/support/v17/leanback/widget/SearchOrbView$c;-><init>(III)V
    ...
    iget p2, p0, Landroid/support/v17/leanback/widget/SearchOrbView;->l:F

    invoke-static {p1, p2}, Landroid/support/v4/view/u;->b(Landroid/view/View;F)V
...
.method private a()V
    ...
    .line 17
    iget-object v0, p0, Landroid/support/v17/leanback/widget/SearchOrbView;->p:Landroid/animation/ArgbEvaluator;
    ...
    iget-object v3, p0, Landroid/support/v17/leanback/widget/SearchOrbView;->g:Landroid/support/v17/leanback/widget/SearchOrbView$c;

    iget v3, v3, Landroid/support/v17/leanback/widget/SearchOrbView$c;->a:I
    ...
    iget v3, v3, Landroid/support/v17/leanback/widget/SearchOrbView$c;->b:I
    ...
    iget-object v2, p0, Landroid/support/v17/leanback/widget/SearchOrbView;->g:Landroid/support/v17/leanback/widget/SearchOrbView$c;

    iget v2, v2, Landroid/support/v17/leanback/widget/SearchOrbView$c;->a:I
    ...
    iget-object v1, p0, Landroid/support/v17/leanback/widget/SearchOrbView;->q:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
...
.method private a(ZI)V
    ...
    iget-object v1, p0, Landroid/support/v17/leanback/widget/SearchOrbView;->s:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    .line 6
    iget-object p1, p0, Landroid/support/v17/leanback/widget/SearchOrbView;->r:Landroid/animation/ValueAnimator;
...
.method a(Z)V
    ...
    .line 9
    iget v0, p0, Landroid/support/v17/leanback/widget/SearchOrbView;->h:F
    ...
    iget v1, p0, Landroid/support/v17/leanback/widget/SearchOrbView;->j:I
...
.method getLayoutResourceId()I
    ...
    .line 1
    sget v0, La/b/j/a/i;->lb_search_orb:I
...
.method public getOrbIcon()Landroid/graphics/drawable/Drawable;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v17/leanback/widget/SearchOrbView;->f:Landroid/graphics/drawable/Drawable;
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v17/leanback/widget/SearchOrbView;->b:Landroid/view/View$OnClickListener;
...
.method public setOrbColor(I)V
    ...
    invoke-direct {v0, p1, p1, v1}, Landroid/support/v17/leanback/widget/SearchOrbView$c;-><init>(III)V
...
.method public setOrbColors(Landroid/support/v17/leanback/widget/SearchOrbView$c;)V
    ...
    .line 3
    iget-object p1, p0, Landroid/support/v17/leanback/widget/SearchOrbView;->m:Landroid/animation/ValueAnimator;

    if-nez p1, :cond_0

    .line 4
    iget-object p1, p0, Landroid/support/v17/leanback/widget/SearchOrbView;->g:Landroid/support/v17/leanback/widget/SearchOrbView$c;

    iget p1, p1, Landroid/support/v17/leanback/widget/SearchOrbView$c;->a:I
...
.method setSearchOrbZ(F)V
    ...
    iget v2, p0, Landroid/support/v17/leanback/widget/SearchOrbView;->l:F
    ...
    invoke-static {v0, v1}, Landroid/support/v4/view/u;->b(Landroid/view/View;F)V
