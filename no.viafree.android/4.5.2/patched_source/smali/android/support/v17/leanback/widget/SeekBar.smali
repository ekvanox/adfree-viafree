...
.field private p:Landroid/support/v17/leanback/widget/SeekBar$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p2, p0, Landroid/support/v17/leanback/widget/SeekBar;->d:Landroid/graphics/RectF;
    ...
    iput-object p2, p0, Landroid/support/v17/leanback/widget/SeekBar;->h:Landroid/graphics/Paint;
    ...
    .line 13
    iget-object p2, p0, Landroid/support/v17/leanback/widget/SeekBar;->h:Landroid/graphics/Paint;
    ...
    sget v0, La/b/j/a/d;->lb_playback_transport_progressbar_bar_height:I
    ...
    sget v0, La/b/j/a/d;->lb_playback_transport_progressbar_active_bar_height:I

    invoke-virtual {p2, v0}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result p2

    iput p2, p0, Landroid/support/v17/leanback/widget/SeekBar;->o:I
    ...
    sget p2, La/b/j/a/d;->lb_playback_transport_progressbar_active_radius:I
...
.method private a()V
    ...
    .line 5
    iget-object v3, p0, Landroid/support/v17/leanback/widget/SeekBar;->d:Landroid/graphics/RectF;

    iget v4, p0, Landroid/support/v17/leanback/widget/SeekBar;->n:I
    ...
    .line 7
    iget v3, p0, Landroid/support/v17/leanback/widget/SeekBar;->i:I

    int-to-float v3, v3

    iget v4, p0, Landroid/support/v17/leanback/widget/SeekBar;->k:I
    ...
    .line 8
    iget-object v4, p0, Landroid/support/v17/leanback/widget/SeekBar;->b:Landroid/graphics/RectF;

    iget v5, p0, Landroid/support/v17/leanback/widget/SeekBar;->n:I
    ...
    iget v5, p0, Landroid/support/v17/leanback/widget/SeekBar;->k:I
    ...
    iget v7, p0, Landroid/support/v17/leanback/widget/SeekBar;->n:I
    ...
    .line 11
    iput v2, p0, Landroid/support/v17/leanback/widget/SeekBar;->l:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, p0, Landroid/support/v17/leanback/widget/SeekBar;->g:Landroid/graphics/Paint;
    ...
    .line 7
    iget v1, p0, Landroid/support/v17/leanback/widget/SeekBar;->l:I
    ...
    iget-object v3, p0, Landroid/support/v17/leanback/widget/SeekBar;->h:Landroid/graphics/Paint;
...
.method public performAccessibilityAction(ILandroid/os/Bundle;)Z
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v17/leanback/widget/SeekBar;->p:Landroid/support/v17/leanback/widget/SeekBar$a;
