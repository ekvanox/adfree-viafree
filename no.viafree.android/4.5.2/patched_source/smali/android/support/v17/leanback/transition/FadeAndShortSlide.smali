...
.field static final g:Landroid/support/v17/leanback/transition/FadeAndShortSlide$g;

.field static final h:Landroid/support/v17/leanback/transition/FadeAndShortSlide$g;

.field static final i:Landroid/support/v17/leanback/transition/FadeAndShortSlide$g;

.field static final j:Landroid/support/v17/leanback/transition/FadeAndShortSlide$g;

.field static final k:Landroid/support/v17/leanback/transition/FadeAndShortSlide$g;


# instance fields
.field private b:Landroid/support/v17/leanback/transition/FadeAndShortSlide$g;

.field private c:Landroid/transition/Visibility;

.field private d:F

.field final e:Landroid/support/v17/leanback/transition/FadeAndShortSlide$g;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 12
    sget p2, La/b/j/a/m;->lbSlide_lb_slideEdge:I
...
.method a(Landroid/view/ViewGroup;)F
    ...
    .line 1
    iget v0, p0, Landroid/support/v17/leanback/transition/FadeAndShortSlide;->d:F
...
.method public a(F)V
    ...
    .line 12
    iput p1, p0, Landroid/support/v17/leanback/transition/FadeAndShortSlide;->d:F
...
.method public a(I)V
    ...
    .line 5
    sget-object p1, Landroid/support/v17/leanback/transition/FadeAndShortSlide;->i:Landroid/support/v17/leanback/transition/FadeAndShortSlide$g;

    iput-object p1, p0, Landroid/support/v17/leanback/transition/FadeAndShortSlide;->b:Landroid/support/v17/leanback/transition/FadeAndShortSlide$g;
    ...
    .line 7
    :cond_1
    sget-object p1, Landroid/support/v17/leanback/transition/FadeAndShortSlide;->h:Landroid/support/v17/leanback/transition/FadeAndShortSlide$g;
    ...
    .line 8
    :cond_2
    sget-object p1, Landroid/support/v17/leanback/transition/FadeAndShortSlide;->g:Landroid/support/v17/leanback/transition/FadeAndShortSlide$g;
    ...
    .line 9
    :cond_3
    iget-object p1, p0, Landroid/support/v17/leanback/transition/FadeAndShortSlide;->e:Landroid/support/v17/leanback/transition/FadeAndShortSlide$g;
    ...
    .line 10
    :cond_4
    sget-object p1, Landroid/support/v17/leanback/transition/FadeAndShortSlide;->j:Landroid/support/v17/leanback/transition/FadeAndShortSlide$g;
    ...
    .line 11
    :cond_5
    sget-object p1, Landroid/support/v17/leanback/transition/FadeAndShortSlide;->k:Landroid/support/v17/leanback/transition/FadeAndShortSlide$g;
...
.method public clone()Landroid/transition/Transition;
    ...
    .line 3
    iget-object v1, p0, Landroid/support/v17/leanback/transition/FadeAndShortSlide;->c:Landroid/transition/Visibility;
    ...
    iput-object v1, v0, Landroid/support/v17/leanback/transition/FadeAndShortSlide;->c:Landroid/transition/Visibility;
...
.method public onAppear(Landroid/view/ViewGroup;Landroid/view/View;Landroid/transition/TransitionValues;Landroid/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    .line 5
    iget-object v1, v10, Landroid/support/v17/leanback/transition/FadeAndShortSlide;->b:Landroid/support/v17/leanback/transition/FadeAndShortSlide$g;

    invoke-virtual {v1, p0, p1, v12, v0}, Landroid/support/v17/leanback/transition/FadeAndShortSlide$g;->a(Landroid/support/v17/leanback/transition/FadeAndShortSlide;Landroid/view/ViewGroup;Landroid/view/View;[I)F
    ...
    invoke-virtual {v1, p0, p1, v12, v0}, Landroid/support/v17/leanback/transition/FadeAndShortSlide$g;->b(Landroid/support/v17/leanback/transition/FadeAndShortSlide;Landroid/view/ViewGroup;Landroid/view/View;[I)F
    ...
    .line 9
    iget-object v1, v10, Landroid/support/v17/leanback/transition/FadeAndShortSlide;->c:Landroid/transition/Visibility;
