...
# interfaces
.implements Landroid/support/v17/leanback/widget/g0;
.implements Landroid/support/v17/leanback/widget/a0;
...
# instance fields
.field private b:Landroid/support/v17/leanback/widget/g0$a;

.field private c:Landroid/support/v17/leanback/widget/a0$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Landroid/support/v17/leanback/widget/GuidedActionEditText;->e:Landroid/graphics/drawable/Drawable;

    .line 6
    iget-object p1, p0, Landroid/support/v17/leanback/widget/GuidedActionEditText;->e:Landroid/graphics/drawable/Drawable;
...
.method public autofill(Landroid/view/autofill/AutofillValue;)V
    ...
    .line 2
    iget-object p1, p0, Landroid/support/v17/leanback/widget/GuidedActionEditText;->c:Landroid/support/v17/leanback/widget/a0$a;

    if-eqz p1, :cond_0

    .line 3
    invoke-interface {p1, p0}, Landroid/support/v17/leanback/widget/a0$a;->a(Landroid/view/View;)V
...
.method protected onFocusChanged(ZILandroid/graphics/Rect;)V
    ...
    .line 3
    :cond_0
    iget-object p2, p0, Landroid/support/v17/leanback/widget/GuidedActionEditText;->e:Landroid/graphics/drawable/Drawable;
...
.method public onKeyPreIme(ILandroid/view/KeyEvent;)Z
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v17/leanback/widget/GuidedActionEditText;->b:Landroid/support/v17/leanback/widget/g0$a;

    if-eqz v0, :cond_0

    .line 2
    invoke-interface {v0, p0, p1, p2}, Landroid/support/v17/leanback/widget/g0$a;->a(Landroid/widget/EditText;ILandroid/view/KeyEvent;)Z
...
.method public setImeKeyListener(Landroid/support/v17/leanback/widget/g0$a;)V
    .locals 0

    .line 1
    iput-object p1, p0, Landroid/support/v17/leanback/widget/GuidedActionEditText;->b:Landroid/support/v17/leanback/widget/g0$a;

    return-void
.end method

.method public setOnAutofillListener(Landroid/support/v17/leanback/widget/a0$a;)V
    .locals 0

    .line 1
    iput-object p1, p0, Landroid/support/v17/leanback/widget/GuidedActionEditText;->c:Landroid/support/v17/leanback/widget/a0$a;
