...
.field private final h:Landroid/support/v4/widget/t;

.field private final i:Landroid/support/v4/widget/t;

.field private final j:Landroid/support/v4/widget/DrawerLayout$f;

.field private final k:Landroid/support/v4/widget/DrawerLayout$f;
...
.field private t:Landroid/support/v4/widget/DrawerLayout$d;
...
.method static constructor <clinit>()V
    ...
    .line 2
    sput-object v1, Landroid/support/v4/widget/DrawerLayout;->M:[I
    ...
    :goto_0
    sput-boolean v1, Landroid/support/v4/widget/DrawerLayout;->N:Z
    ...
    :goto_1
    sput-boolean v0, Landroid/support/v4/widget/DrawerLayout;->O:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->b:Landroid/support/v4/widget/DrawerLayout$c;
    ...
    .line 16
    iput v2, p0, Landroid/support/v4/widget/DrawerLayout;->d:I
    ...
    iput-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/DrawerLayout$f;
    ...
    iput-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/DrawerLayout$f;

    .line 19
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/DrawerLayout$f;

    const/high16 v3, 0x3f800000    # 1.0f

    invoke-static {p0, v3, p3}, Landroid/support/v4/widget/t;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/t$c;)Landroid/support/v4/widget/t;

    move-result-object p3

    iput-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/t;

    .line 20
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/t;

    invoke-virtual {p3, p2}, Landroid/support/v4/widget/t;->d(I)V

    .line 21
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/t;

    invoke-virtual {p3, v2}, Landroid/support/v4/widget/t;->a(F)V

    .line 22
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/DrawerLayout$f;

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/t;

    invoke-virtual {p3, v4}, Landroid/support/v4/widget/DrawerLayout$f;->a(Landroid/support/v4/widget/t;)V

    .line 23
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/DrawerLayout$f;

    invoke-static {p0, v3, p3}, Landroid/support/v4/widget/t;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/t$c;)Landroid/support/v4/widget/t;

    move-result-object p3

    iput-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/t;

    .line 24
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/t;

    const/4 v3, 0x2

    invoke-virtual {p3, v3}, Landroid/support/v4/widget/t;->d(I)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/t;
    ...
    .line 39
    iput v1, p0, Landroid/support/v4/widget/DrawerLayout;->c:F
    ...
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->I:Ljava/util/ArrayList;
...
.method private a(FFLandroid/view/View;)Z
    ...
    .line 20
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->J:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->J:Landroid/graphics/Rect;
    ...
    .line 23
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout;->J:Landroid/graphics/Rect;
...
.method private b(Landroid/view/MotionEvent;Landroid/view/View;)Landroid/view/MotionEvent;
    ...
    .line 9
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->K:Landroid/graphics/Matrix;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->K:Landroid/graphics/Matrix;
    ...
    .line 12
    iget-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->K:Landroid/graphics/Matrix;
...
.method private c(Landroid/view/View;Z)V
    ...
    .line 21
    invoke-virtual {p0, v2}, Landroid/support/v4/widget/DrawerLayout;->i(Landroid/view/View;)Z
    ...
    .line 22
    invoke-static {v2, v3}, Landroid/support/v4/view/u;->f(Landroid/view/View;I)V
...
.method private i()V
    ...
    .line 1
    sget-boolean v0, Landroid/support/v4/widget/DrawerLayout;->O:Z
...
.method public a(II)V
    ...
    .line 14
    iget-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/t;

    goto :goto_1

    :cond_4
    iget-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/t;

    .line 15
    :goto_1
    invoke-virtual {p2}, Landroid/support/v4/widget/t;->b()V
    ...
    .line 17
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/DrawerLayout;->k(Landroid/view/View;)V
...
.method a(IILandroid/view/View;)V
    ...
    .line 34
    iget-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/t;

    invoke-virtual {p1}, Landroid/support/v4/widget/t;->f()I

    move-result p1

    .line 35
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/t;

    invoke-virtual {v0}, Landroid/support/v4/widget/t;->f()I
    ...
    invoke-interface {p2, v1}, Landroid/support/v4/widget/DrawerLayout$d;->onDrawerStateChanged(I)V
...
.method public a(IZ)V
    ...
    .line 88
    invoke-static {p1}, Landroid/support/v4/widget/DrawerLayout;->h(I)Ljava/lang/String;
...
.method a(Landroid/view/View;F)V
    ...
    invoke-interface {v1, p1, p2}, Landroid/support/v4/widget/DrawerLayout$d;->onDrawerSlide(Landroid/view/View;F)V
...
.method public a(Landroid/view/View;Z)V
    ...
    .line 77
    invoke-virtual {p2, p1, v0, v1}, Landroid/support/v4/widget/t;->b(Landroid/view/View;II)Z
...
.method a(Z)V
    ...
    .line 57
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/t;
    ...
    .line 59
    invoke-virtual {v7, v4, v6, v8}, Landroid/support/v4/widget/t;->b(Landroid/view/View;II)Z
    ...
    .line 60
    :cond_1
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/t;
    ...
    .line 62
    invoke-virtual {v6, v4, v7, v8}, Landroid/support/v4/widget/t;->b(Landroid/view/View;II)Z
    ...
    invoke-virtual {p1}, Landroid/support/v4/widget/DrawerLayout$f;->b()V
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    .line 9
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->I:Ljava/util/ArrayList;
    ...
    .line 12
    :cond_5
    iget-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->I:Ljava/util/ArrayList;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 6
    :goto_1
    sget-boolean p2, Landroid/support/v4/widget/DrawerLayout;->N:Z

    if-nez p2, :cond_2

    .line 7
    iget-object p2, p0, Landroid/support/v4/widget/DrawerLayout;->b:Landroid/support/v4/widget/DrawerLayout$c;
...
.method public b(Landroid/support/v4/widget/DrawerLayout$d;)V
    .locals 1
...
.method b(Landroid/view/View;)V
    ...
    invoke-interface {v2, p1}, Landroid/support/v4/widget/DrawerLayout$d;->onDrawerClosed(Landroid/view/View;)V
...
.method public b(Landroid/view/View;Z)V
    ...
    invoke-virtual {p2, p1, v1, v0}, Landroid/support/v4/widget/t;->b(Landroid/view/View;II)Z
...
.method c(Landroid/view/View;)V
    ...
    invoke-interface {v1, p1}, Landroid/support/v4/widget/DrawerLayout$d;->onDrawerOpened(Landroid/view/View;)V
...
.method public computeScroll()V
    ...
    .line 5
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/t;
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/widget/t;->a(Z)Z
...
.method public d(Landroid/view/View;)I
    ...
    .line 3
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/DrawerLayout;->c(I)I
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    .line 8
    invoke-static {v12}, Landroid/support/v4/widget/DrawerLayout;->l(Landroid/view/View;)Z

    move-result v13

    if-eqz v13, :cond_2

    invoke-virtual {p0, v12}, Landroid/support/v4/widget/DrawerLayout;->i(Landroid/view/View;)Z
    ...
    .line 24
    iget-object v8, v0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/t;

    invoke-virtual {v8}, Landroid/support/v4/widget/t;->d()I
    ...
    .line 36
    iget-object v10, v0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/t;

    invoke-virtual {v10}, Landroid/support/v4/widget/t;->d()I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 2
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/t;
    ...
    .line 3
    invoke-virtual {v2, p1}, Landroid/support/v4/widget/t;->b(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p1, v4}, Landroid/support/v4/widget/t;->a(I)Z
    ...
    invoke-virtual {v4, v0, p1}, Landroid/support/v4/widget/t;->b(II)Landroid/view/View;
...
.method protected onLayout(ZIIII)V
    ...
    .line 6
    invoke-virtual {v0, v6}, Landroid/support/v4/widget/DrawerLayout;->g(Landroid/view/View;)Z
...
.method protected onMeasure(II)V
    ...
    .line 14
    invoke-static {v12}, Landroid/support/v4/view/u;->h(Landroid/view/View;)Z
    ...
    .line 44
    invoke-virtual {v0, v12}, Landroid/support/v4/widget/DrawerLayout;->i(Landroid/view/View;)Z
    ...
    .line 45
    sget-boolean v2, Landroid/support/v4/widget/DrawerLayout;->O:Z

    if-eqz v2, :cond_e

    .line 46
    invoke-static {v12}, Landroid/support/v4/view/u;->g(Landroid/view/View;)F

    move-result v2

    iget v14, v0, Landroid/support/v4/widget/DrawerLayout;->c:F
    ...
    .line 47
    invoke-static {v12, v14}, Landroid/support/v4/view/u;->a(Landroid/view/View;F)V
    ...
    .line 50
    invoke-static {v2}, Landroid/support/v4/widget/DrawerLayout;->h(I)Ljava/lang/String;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .line 7
    :goto_1
    iget v7, v4, Landroid/support/v4/widget/DrawerLayout$e;->d:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 8
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/t;

    float-to-int v4, v0

    float-to-int v5, p1

    invoke-virtual {v3, v4, v5}, Landroid/support/v4/widget/t;->b(II)Landroid/view/View;
    ...
    .line 9
    invoke-virtual {p0, v3}, Landroid/support/v4/widget/DrawerLayout;->g(Landroid/view/View;)Z
    ...
    invoke-virtual {v3}, Landroid/support/v4/widget/t;->e()I
...
.method public setDrawerElevation(F)V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/view/u;->a(Landroid/view/View;F)V
...
.method public setDrawerListener(Landroid/support/v4/widget/DrawerLayout$d;)V
    ...
    .line 2
    invoke-virtual {p0, v0}, Landroid/support/v4/widget/DrawerLayout;->b(Landroid/support/v4/widget/DrawerLayout$d;)V
