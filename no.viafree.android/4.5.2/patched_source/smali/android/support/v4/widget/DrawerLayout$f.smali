...
.field private b:Landroid/support/v4/widget/t;
...
.method a()V
    ...
    .line 17
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout$f;->b:Landroid/support/v4/widget/t;
    ...
    .line 19
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout$f;->d:Landroid/support/v4/widget/DrawerLayout;
    ...
    .line 21
    :cond_2
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout$f;->d:Landroid/support/v4/widget/DrawerLayout;

    const/4 v4, 0x5

    invoke-virtual {v3, v4}, Landroid/support/v4/widget/DrawerLayout;->b(I)Landroid/view/View;
    ...
    .line 27
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout$f;->b:Landroid/support/v4/widget/t;

    invoke-virtual {v4}, Landroid/view/View;->getTop()I

    move-result v5

    invoke-virtual {v1, v4, v3, v5}, Landroid/support/v4/widget/t;->b(Landroid/view/View;II)Z
...
.method public a(II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/widget/t;->a(Landroid/view/View;I)V
...
.method public a(Landroid/support/v4/widget/t;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout$f;->b:Landroid/support/v4/widget/t;
...
.method public a(Landroid/view/View;FF)V
    ...
    .line 15
    :goto_1
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout$f;->b:Landroid/support/v4/widget/t;

    invoke-virtual {p1}, Landroid/view/View;->getTop()I

    move-result p1

    invoke-virtual {p3, p2, p1}, Landroid/support/v4/widget/t;->d(II)Z
...
.method public b(Landroid/view/View;I)Z
    ...
    invoke-virtual {p2, p1}, Landroid/support/v4/widget/DrawerLayout;->i(Landroid/view/View;)Z
...
.method public c(I)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout$f;->b:Landroid/support/v4/widget/t;

    invoke-virtual {v2}, Landroid/support/v4/widget/t;->c()Landroid/view/View;
