...
.method public constructor <init>(Landroid/arch/lifecycle/h;)V
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/i;->a:La/a/a/b/a;
    ...
    .line 8
    sget-object p1, Landroid/arch/lifecycle/e$b;->INITIALIZED:Landroid/arch/lifecycle/e$b;
...
.method private a(Landroid/arch/lifecycle/h;)V
    ...
    .line 20
    iget-object v0, p0, Landroid/arch/lifecycle/i;->a:La/a/a/b/a;
    ...
    check-cast v2, Landroid/arch/lifecycle/i$b;

    .line 25
    :goto_0
    iget-object v3, v2, Landroid/arch/lifecycle/i$b;->a:Landroid/arch/lifecycle/e$b;
    ...
    iget-object v3, p0, Landroid/arch/lifecycle/i;->a:La/a/a/b/a;
    ...
    invoke-static {v3}, Landroid/arch/lifecycle/i;->b(Landroid/arch/lifecycle/e$b;)Landroid/arch/lifecycle/e$a;
    ...
    invoke-direct {p0, v4}, Landroid/arch/lifecycle/i;->d(Landroid/arch/lifecycle/e$b;)V

    .line 29
    invoke-virtual {v2, p1, v3}, Landroid/arch/lifecycle/i$b;->a(Landroid/arch/lifecycle/h;Landroid/arch/lifecycle/e$a;)V
...
.method private static b(Landroid/arch/lifecycle/e$b;)Landroid/arch/lifecycle/e$a;
    .locals 3

    .line 12
    sget-object v0, Landroid/arch/lifecycle/i$a;->b:[I
...
.method static b(Landroid/arch/lifecycle/e$a;)Landroid/arch/lifecycle/e$b;
    ...
    .line 6
    sget-object v0, Landroid/arch/lifecycle/i$a;->a:[I
    ...
    .line 8
    :pswitch_0
    sget-object p0, Landroid/arch/lifecycle/e$b;->DESTROYED:Landroid/arch/lifecycle/e$b;

    return-object p0

    .line 9
    :pswitch_1
    sget-object p0, Landroid/arch/lifecycle/e$b;->RESUMED:Landroid/arch/lifecycle/e$b;

    return-object p0

    .line 10
    :pswitch_2
    sget-object p0, Landroid/arch/lifecycle/e$b;->STARTED:Landroid/arch/lifecycle/e$b;

    return-object p0

    .line 11
    :pswitch_3
    sget-object p0, Landroid/arch/lifecycle/e$b;->CREATED:Landroid/arch/lifecycle/e$b;
...
.method private b(Landroid/arch/lifecycle/h;)V
    ...
    invoke-direct {p0, v3}, Landroid/arch/lifecycle/i;->d(Landroid/arch/lifecycle/e$b;)V
...
.method private b()Z
    ...
    check-cast v0, Landroid/arch/lifecycle/i$b;

    iget-object v0, v0, Landroid/arch/lifecycle/i$b;->a:Landroid/arch/lifecycle/e$b;

    .line 3
    iget-object v2, p0, Landroid/arch/lifecycle/i;->a:La/a/a/b/a;
    ...
    iget-object v2, v2, Landroid/arch/lifecycle/i$b;->a:Landroid/arch/lifecycle/e$b;
...
.method private c(Landroid/arch/lifecycle/g;)Landroid/arch/lifecycle/e$b;
    ...
    check-cast p1, Landroid/arch/lifecycle/i$b;

    iget-object p1, p1, Landroid/arch/lifecycle/i$b;->a:Landroid/arch/lifecycle/e$b;
...
.method private d()V
    ...
    .line 8
    :cond_1
    iget-object v1, p0, Landroid/arch/lifecycle/i;->a:La/a/a/b/a;
    ...
    check-cast v1, Landroid/arch/lifecycle/i$b;

    iget-object v1, v1, Landroid/arch/lifecycle/i$b;->a:Landroid/arch/lifecycle/e$b;
...
.method private d(Landroid/arch/lifecycle/e$b;)V
    .locals 1
...
.method public a(Landroid/arch/lifecycle/e$a;)V
    ...
    .line 3
    invoke-direct {p0, p1}, Landroid/arch/lifecycle/i;->c(Landroid/arch/lifecycle/e$b;)V
...
.method public a(Landroid/arch/lifecycle/g;)V
    ...
    .line 5
    :goto_0
    new-instance v0, Landroid/arch/lifecycle/i$b;

    invoke-direct {v0, p1, v1}, Landroid/arch/lifecycle/i$b;-><init>(Landroid/arch/lifecycle/g;Landroid/arch/lifecycle/e$b;)V
    ...
    .line 7
    :cond_1
    iget-object v1, p0, Landroid/arch/lifecycle/i;->c:Ljava/lang/ref/WeakReference;
    ...
    .line 11
    :goto_3
    iget-object v5, v0, Landroid/arch/lifecycle/i$b;->a:Landroid/arch/lifecycle/e$b;
    ...
    iget-object v4, p0, Landroid/arch/lifecycle/i;->a:La/a/a/b/a;
    ...
    .line 13
    iget-object v4, v0, Landroid/arch/lifecycle/i$b;->a:Landroid/arch/lifecycle/e$b;
    ...
    invoke-virtual {v0, v1, v4}, Landroid/arch/lifecycle/i$b;->a(Landroid/arch/lifecycle/h;Landroid/arch/lifecycle/e$a;)V
