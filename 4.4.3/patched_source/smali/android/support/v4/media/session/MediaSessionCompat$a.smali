...
# instance fields
.field private mCallbackHandler:Landroid/support/v4/media/session/MediaSessionCompat$a$a;
...
.method public constructor <init>()V
    ...
    .line 974
    iput-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$a;->mCallbackHandler:Landroid/support/v4/media/session/MediaSessionCompat$a$a;
...
# virtual methods
.method handleMediaPlayPauseKeySingleTapIfPending(Landroid/support/v4/media/j$a;)V
    .locals 11

    .line 1072
    iget-boolean v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$a;->mMediaPlayPauseKeyPending:Z
    ...
    .line 1075
    iput-boolean v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$a;->mMediaPlayPauseKeyPending:Z
...
.method public onMediaButtonEvent(Landroid/content/Intent;)Z
    ...
    .line 1028
    :cond_0
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$a;->mSessionImpl:Ljava/lang/ref/WeakReference;
    ...
    .line 1029
    iget-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$a;->mCallbackHandler:Landroid/support/v4/media/session/MediaSessionCompat$a$a;
    ...
    .line 1036
    :cond_2
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$b;->g()Landroid/support/v4/media/j$a;
    ...
    .line 1065
    invoke-virtual {p0, v2}, Landroid/support/v4/media/session/MediaSessionCompat$a;->handleMediaPlayPauseKeySingleTapIfPending(Landroid/support/v4/media/j$a;)V
    ...
    .line 1044
    :cond_4
    iget-boolean p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$a;->mMediaPlayPauseKeyPending:Z

    if-eqz p1, :cond_6

    .line 1045
    iget-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$a;->mCallbackHandler:Landroid/support/v4/media/session/MediaSessionCompat$a$a;

    invoke-virtual {p1, v3}, Landroid/support/v4/media/session/MediaSessionCompat$a$a;->removeMessages(I)V

    .line 1047
    iput-boolean v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$a;->mMediaPlayPauseKeyPending:Z
    ...
    .line 1055
    :cond_6
    iput-boolean v3, p0, Landroid/support/v4/media/session/MediaSessionCompat$a;->mMediaPlayPauseKeyPending:Z
...
.method setSessionImpl(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$a;->mCallbackHandler:Landroid/support/v4/media/session/MediaSessionCompat$a$a;
