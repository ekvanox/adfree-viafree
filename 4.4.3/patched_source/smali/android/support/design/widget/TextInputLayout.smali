...
.field final c:Landroid/support/design/widget/c;

.field private final d:Landroid/widget/FrameLayout;

.field private e:Ljava/lang/CharSequence;

.field private final f:Landroid/support/design/widget/k;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Landroid/support/design/widget/k;-><init>(Landroid/support/design/widget/TextInputLayout;)V

    iput-object v0, p0, Landroid/support/design/widget/TextInputLayout;->f:Landroid/support/design/widget/k;
    ...
    invoke-direct {v0, p0}, Landroid/support/design/widget/c;-><init>(Landroid/view/View;)V

    iput-object v0, p0, Landroid/support/design/widget/TextInputLayout;->c:Landroid/support/design/widget/c;
    ...
    .line 261
    iget-object v2, p0, Landroid/support/design/widget/TextInputLayout;->c:Landroid/support/design/widget/c;

    sget-object v3, Landroid/support/design/a/a;->a:Landroid/animation/TimeInterpolator;

    invoke-virtual {v2, v3}, Landroid/support/design/widget/c;->a(Landroid/animation/TimeInterpolator;)V
    ...
    invoke-virtual {v2, v3}, Landroid/support/design/widget/c;->b(Landroid/animation/TimeInterpolator;)V
    ...
    invoke-virtual {v2, v3}, Landroid/support/design/widget/c;->b(I)V
    ...
    .line 266
    invoke-static/range {v4 .. v9}, Landroid/support/design/internal/g;->b(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroid/support/v7/widget/TintTypedArray;
    ...
    .line 371
    invoke-static {p0, p1}, Landroid/support/v4/view/t;->b(Landroid/view/View;I)V
...
.method private a(ZZ)V
    ...
    .line 759
    :goto_1
    iget-object v3, p0, Landroid/support/design/widget/TextInputLayout;->f:Landroid/support/design/widget/k;

    invoke-virtual {v3}, Landroid/support/design/widget/k;->g()Z
    ...
    .line 763
    iget-object v5, p0, Landroid/support/design/widget/TextInputLayout;->c:Landroid/support/design/widget/c;

    invoke-virtual {v5, v4}, Landroid/support/design/widget/c;->a(Landroid/content/res/ColorStateList;)V

    .line 764
    iget-object v4, p0, Landroid/support/design/widget/TextInputLayout;->c:Landroid/support/design/widget/c;

    iget-object v5, p0, Landroid/support/design/widget/TextInputLayout;->R:Landroid/content/res/ColorStateList;

    invoke-virtual {v4, v5}, Landroid/support/design/widget/c;->b(Landroid/content/res/ColorStateList;)V

    :cond_2
    if-nez v0, :cond_3

    .line 769
    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->c:Landroid/support/design/widget/c;
    ...
    invoke-virtual {v0, v4}, Landroid/support/design/widget/c;->a(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/design/widget/c;->b(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v4, p0, Landroid/support/design/widget/TextInputLayout;->f:Landroid/support/design/widget/k;

    invoke-virtual {v4}, Landroid/support/design/widget/k;->k()Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v4, v0}, Landroid/support/design/widget/c;->a(Landroid/content/res/ColorStateList;)V
...
.method private c(Z)V
    ...
    .line 1925
    :cond_1
    iget-object p1, p0, Landroid/support/design/widget/TextInputLayout;->c:Landroid/support/design/widget/c;

    invoke-virtual {p1, v0}, Landroid/support/design/widget/c;->b(F)V
...
.method private d(Z)V
    ...
    invoke-virtual {p1}, Landroid/support/design/widget/d;->a()Z
...
.method private f()V
    ...
    instance-of v0, v0, Landroid/support/design/widget/d;
...
.method private l()V
    ...
    invoke-static {p0, v2, v1}, Landroid/support/design/widget/e;->b(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method private setEditText(Landroid/widget/EditText;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/design/widget/c;->c(Landroid/graphics/Typeface;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/design/widget/c;->a(F)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/c;->b(I)V

    .line 690
    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->c:Landroid/support/design/widget/c;

    invoke-virtual {v0, p1}, Landroid/support/design/widget/c;->a(I)V
    ...
    .line 731
    :cond_5
    iget-object p1, p0, Landroid/support/design/widget/TextInputLayout;->f:Landroid/support/design/widget/k;

    invoke-virtual {p1}, Landroid/support/design/widget/k;->d()V
...
.method private setHintInternal(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/c;->a(Ljava/lang/CharSequence;)V
...
.method private u()V
    ...
    .line 1942
    iget-object v1, p0, Landroid/support/design/widget/TextInputLayout;->c:Landroid/support/design/widget/c;

    invoke-virtual {v1, v0}, Landroid/support/design/widget/c;->a(Landroid/graphics/RectF;)V
...
.method a(F)V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/c;->i()F
    ...
    iget-object v3, p0, Landroid/support/design/widget/TextInputLayout;->c:Landroid/support/design/widget/c;

    invoke-virtual {v3}, Landroid/support/design/widget/c;->i()F
...
.method a(I)V
    ...
    invoke-static {v1, v3}, Landroid/support/v4/view/t;->c(Landroid/view/View;I)V
...
.method public b()Z
    ...
    .line 1024
    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->f:Landroid/support/design/widget/k;

    invoke-virtual {v0}, Landroid/support/design/widget/k;->f()Z
...
.method c()V
    ...
    .line 1388
    :cond_2
    iget-object v1, p0, Landroid/support/design/widget/TextInputLayout;->f:Landroid/support/design/widget/k;

    invoke-virtual {v1}, Landroid/support/design/widget/k;->g()Z
    ...
    .line 1392
    invoke-virtual {v1}, Landroid/support/design/widget/k;->j()I
...
.method d()V
    ...
    .line 2011
    :cond_3
    iget-object v2, p0, Landroid/support/design/widget/TextInputLayout;->f:Landroid/support/design/widget/k;

    invoke-virtual {v2}, Landroid/support/design/widget/k;->g()Z
    ...
    invoke-virtual {v2}, Landroid/support/design/widget/k;->j()I
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/c;->a(Landroid/graphics/Canvas;)V
...
.method protected drawableStateChanged()V
    ...
    .line 1989
    invoke-virtual {v0, v1}, Landroid/support/design/widget/c;->a([I)Z
...
.method public getError()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/k;->e()Z
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/k;->h()Ljava/lang/CharSequence;
...
.method public getErrorCurrentTextColors()I
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/k;->j()I
...
.method public getHelperText()Ljava/lang/CharSequence;
    ...
    .line 1548
    invoke-virtual {v0}, Landroid/support/design/widget/k;->i()Ljava/lang/CharSequence;
...
.method public getHelperTextCurrentTextColor()I
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/k;->l()I
...
.method final getHintCurrentCollapsedTextColor()I
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/c;->j()I
...
.method protected onLayout(ZIIII)V
    ...
    .line 1893
    invoke-static {p0, p1, p2}, Landroid/support/design/widget/e;->b(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    .line 1899
    invoke-virtual {v1, p1, v2, p4, p2}, Landroid/support/design/widget/c;->a(IIII)V

    .line 1907
    iget-object p2, p0, Landroid/support/design/widget/TextInputLayout;->c:Landroid/support/design/widget/c;
    ...
    invoke-virtual {p2, p1, v0, p4, p5}, Landroid/support/design/widget/c;->b(IIII)V

    .line 1908
    iget-object p1, p0, Landroid/support/design/widget/TextInputLayout;->c:Landroid/support/design/widget/c;

    invoke-virtual {p1}, Landroid/support/design/widget/c;->k()V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/k;->g()Z
...
.method public setCounterEnabled(Z)V
    ...
    invoke-virtual {v1, v2, v0}, Landroid/support/design/widget/k;->a(Landroid/widget/TextView;I)V
    ...
    invoke-virtual {v1, v2, v0}, Landroid/support/design/widget/k;->b(Landroid/widget/TextView;I)V
...
.method public setError(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/k;->b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1}, Landroid/support/design/widget/k;->b()V
...
.method public setErrorEnabled(Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/k;->a(Z)V
...
.method public setHelperTextColor(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/k;->b(Landroid/content/res/ColorStateList;)V
...
.method public setHelperTextEnabled(Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/k;->b(Z)V
...
.method public setHelperTextTextAppearance(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/k;->c(I)V
...
.method public setHintTextAppearance(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/c;->c(I)V

    .line 902
    iget-object p1, p0, Landroid/support/design/widget/TextInputLayout;->c:Landroid/support/design/widget/c;

    invoke-virtual {p1}, Landroid/support/design/widget/c;->m()Landroid/content/res/ColorStateList;
...
.method public setTypeface(Landroid/graphics/Typeface;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/c;->c(Landroid/graphics/Typeface;)V

    .line 623
    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->f:Landroid/support/design/widget/k;

    invoke-virtual {v0, p1}, Landroid/support/design/widget/k;->a(Landroid/graphics/Typeface;)V
