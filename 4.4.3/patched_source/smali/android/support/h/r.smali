...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Landroid/support/h/r;->a:Z
    ...
    :goto_1
    sput-boolean v0, Landroid/support/h/r;->b:Z
    ...
    :goto_2
    sput-boolean v1, Landroid/support/h/r;->c:Z
...
.method private static a(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;Landroid/view/ViewGroup;)Landroid/graphics/Bitmap;
    ...
    .line 93
    sget-boolean v0, Landroid/support/h/r;->a:Z
    ...
    .line 102
    :goto_0
    sget-boolean v3, Landroid/support/h/r;->b:Z
    ...
    .line 120
    sget-boolean p2, Landroid/support/h/r;->c:Z
    ...
    :cond_5
    :goto_2
    sget-boolean p1, Landroid/support/h/r;->b:Z
...
.method static a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;)Landroid/view/View;
    ...
    .line 53
    invoke-static {p1, v0}, Landroid/support/h/ad;->a(Landroid/view/View;Landroid/graphics/Matrix;)V

    .line 54
    invoke-static {p0, v0}, Landroid/support/h/ad;->b(Landroid/view/View;Landroid/graphics/Matrix;)V
    ...
    .line 64
    invoke-static {p1, v0, p2, p0}, Landroid/support/h/r;->a(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;Landroid/view/ViewGroup;)Landroid/graphics/Bitmap;
