.class public final Lcom/viafree/android/common/f;
...
.method private final a(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/OrientationHelper;
    .locals 1

    .line 84
    iget-object v0, p0, Lcom/viafree/android/common/f;->a:Landroid/support/v7/widget/OrientationHelper;
    ...
    iput-object p1, p0, Lcom/viafree/android/common/f;->a:Landroid/support/v7/widget/OrientationHelper;

    .line 87
    :cond_0
    iget-object p1, p0, Lcom/viafree/android/common/f;->a:Landroid/support/v7/widget/OrientationHelper;
...
.method private final b(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/OrientationHelper;
    .locals 1

    .line 91
    iget-object v0, p0, Lcom/viafree/android/common/f;->b:Landroid/support/v7/widget/OrientationHelper;
    ...
    iput-object p1, p0, Lcom/viafree/android/common/f;->b:Landroid/support/v7/widget/OrientationHelper;

    .line 94
    :cond_0
    iget-object p1, p0, Lcom/viafree/android/common/f;->b:Landroid/support/v7/widget/OrientationHelper;
...
.method public calculateDistanceToFinalSnap(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/view/View;)[I
    ...
    .line 24
    invoke-direct {p0, p1}, Lcom/viafree/android/common/f;->b(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/OrientationHelper;

    move-result-object v1

    invoke-direct {p0, p2, v1}, Lcom/viafree/android/common/f;->a(Landroid/view/View;Landroid/support/v7/widget/OrientationHelper;)I
    ...
    .line 30
    invoke-direct {p0, p1}, Lcom/viafree/android/common/f;->a(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/OrientationHelper;

    move-result-object p1

    invoke-direct {p0, p2, p1}, Lcom/viafree/android/common/f;->a(Landroid/view/View;Landroid/support/v7/widget/OrientationHelper;)I
...
.method public findSnapView(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/view/View;
    ...
    invoke-direct {p0, p1, v0}, Lcom/viafree/android/common/f;->a(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/support/v7/widget/OrientationHelper;)Landroid/view/View;
