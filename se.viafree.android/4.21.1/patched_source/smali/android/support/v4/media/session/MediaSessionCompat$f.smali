...
.method constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroid/os/Bundle;)V
    ...
    .line 1
    invoke-direct/range {p0 .. p5}, Landroid/support/v4/media/session/MediaSessionCompat$e;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroid/os/Bundle;)V
...
.method public d(Landroid/support/v4/media/session/MediaSessionCompat$c;Landroid/os/Handler;)V
    ...
    .line 1
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$e;->d(Landroid/support/v4/media/session/MediaSessionCompat$c;Landroid/os/Handler;)V
...
.method o(Landroid/os/Bundle;)Landroid/media/RemoteControlClient$MetadataEditor;
    ...
    .line 1
    invoke-super {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$i;->o(Landroid/os/Bundle;)Landroid/media/RemoteControlClient$MetadataEditor;
...
.method r(J)I
    ...
    .line 1
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$e;->r(J)I
