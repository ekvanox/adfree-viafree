...
.method B()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/media/session/MediaSessionCompat$i;->t(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/media/session/MediaSessionCompat$i;->f(Landroid/support/v4/media/MediaMetadataCompat;)V
...
.method public e(I)V
    ...
    .line 8
    invoke-virtual {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$i;->x(Landroid/support/v4/media/session/ParcelableVolumeInfo;)V
...
.method public f(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    .line 5
    invoke-direct {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$i;->u(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    .line 8
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$i;->o(Landroid/os/Bundle;)Landroid/media/RemoteControlClient$MetadataEditor;
...
.method public i(Z)V
    ...
    .line 3
    invoke-virtual {p0}, Landroid/support/v4/media/session/MediaSessionCompat$i;->B()V
...
.method public k(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    .line 4
    invoke-direct {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$i;->w(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    .line 8
    :cond_1
    invoke-virtual {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$i;->y(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    invoke-virtual {p0, v1, v2}, Landroid/support/v4/media/session/MediaSessionCompat$i;->r(J)I
...
.method public l(Landroidx/media/i;)V
    ...
    .line 8
    invoke-virtual {p0, v0}, Landroid/support/v4/media/session/MediaSessionCompat$i;->x(Landroid/support/v4/media/session/ParcelableVolumeInfo;)V
...
.method public release()V
    ...
    .line 4
    invoke-direct {p0}, Landroid/support/v4/media/session/MediaSessionCompat$i;->v()V
...
.method s(IIILjava/lang/Object;Landroid/os/Bundle;)V
    ...
    .line 7
    invoke-virtual {p0, p3}, Landroid/support/v4/media/session/MediaSessionCompat$i;->p(I)Ljava/lang/String;
...
.method x(Landroid/support/v4/media/session/ParcelableVolumeInfo;)V
    ...
    .line 3
    :try_start_0
    invoke-interface {v1, p1}, Landroid/support/v4/media/session/a;->g0(Landroid/support/v4/media/session/ParcelableVolumeInfo;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method y(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$i;->q(I)I
