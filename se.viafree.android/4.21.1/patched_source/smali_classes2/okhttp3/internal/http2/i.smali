...
.method constructor <init>(Li/d;Z)V
    ...
    .line 2
    iput-object p1, p0, Lokhttp3/internal/http2/i;->a:Li/d;
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/i;->g:Li/c;

    .line 5
    new-instance p2, Lokhttp3/internal/http2/c$b;

    invoke-direct {p2, p1}, Lokhttp3/internal/http2/c$b;-><init>(Li/c;)V
...
.method private X(IJ)V
    ...
    .line 3
    iget-object v0, p0, Lokhttp3/internal/http2/i;->a:Li/d;

    iget-object v1, p0, Lokhttp3/internal/http2/i;->g:Li/c;

    invoke-interface {v0, v1, v4, v5}, Li/s;->d(Li/c;J)V
...
.method private static Y(Li/d;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1
    invoke-interface {p0, v0}, Li/d;->l(I)Li/d;
    ...
    .line 3
    invoke-interface {p0, p1}, Li/d;->l(I)Li/d;
...
.method public declared-synchronized K()V
    ...
    sget-object v4, Lokhttp3/internal/http2/d;->a:Li/f;

    invoke-virtual {v4}, Li/f;->j()Ljava/lang/String;

    move-result-object v4

    aput-object v4, v2, v3

    invoke-static {v1, v2}, Lh/g0/c;->r(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    sget-object v1, Lokhttp3/internal/http2/d;->a:Li/f;

    invoke-virtual {v1}, Li/f;->v()[B

    move-result-object v1

    invoke-interface {v0, v1}, Li/d;->A([B)Li/d;
...
.method public declared-synchronized L(ZILi/c;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 2
    :cond_0
    invoke-virtual {p0, p2, v0, p3, p4}, Lokhttp3/internal/http2/i;->M(IBLi/c;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method M(IBLi/c;I)V
    ...
    .line 2
    iget-object p1, p0, Lokhttp3/internal/http2/i;->a:Li/d;

    int-to-long v0, p4

    invoke-interface {p1, p3, v0, v1}, Li/s;->d(Li/c;J)V
...
.method public N(IIBB)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/http2/i;->Y(Li/d;I)V

    .line 4
    iget-object p2, p0, Lokhttp3/internal/http2/i;->a:Li/d;
    ...
    invoke-interface {p2, p1}, Li/d;->g(I)Li/d;
...
.method public declared-synchronized O(ILokhttp3/internal/http2/a;[B)V
    ...
    invoke-interface {v0, p1}, Li/d;->g(I)Li/d;
    ...
    invoke-interface {p1, p2}, Li/d;->g(I)Li/d;
    ...
    invoke-interface {p1, p3}, Li/d;->A([B)Li/d;
...
.method P(ZILjava/util/List;)V
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/i;->g:Li/c;

    invoke-virtual {p3}, Li/c;->d0()J
    ...
    invoke-interface {p1, p3, v2, v3}, Li/s;->d(Li/c;J)V
...
.method public declared-synchronized R(ZII)V
    ...
    invoke-interface {p1, p3}, Li/d;->g(I)Li/d;
...
.method public declared-synchronized S(IILjava/util/List;)V
    ...
    .line 6
    iget-object p3, p0, Lokhttp3/internal/http2/i;->a:Li/d;

    const v2, 0x7fffffff

    and-int/2addr p2, v2

    invoke-interface {p3, p2}, Li/d;->g(I)Li/d;
    ...
    invoke-interface {p2, p3, v4, v5}, Li/s;->d(Li/c;J)V
...
.method public declared-synchronized U(Lokhttp3/internal/http2/l;)V
    ...
    .line 5
    :goto_1
    iget-object v3, p0, Lokhttp3/internal/http2/i;->a:Li/d;

    invoke-interface {v3, v0}, Li/d;->f(I)Li/d;
    ...
    invoke-interface {v0, v3}, Li/d;->g(I)Li/d;
