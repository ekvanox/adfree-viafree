...
.method static constructor <clinit>()V
    ...
    .line 3
    invoke-static {v8, v1}, Lh/g0/c;->G(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
...
.method constructor <init>(Lokhttp3/internal/http2/f$g;)V
    ...
    .line 17
    invoke-static {v6, v2}, Lh/g0/c;->r(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v2

    invoke-static {v2, v12}, Lh/g0/c;->G(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
    ...
    .line 21
    invoke-static {v6, v5}, Lh/g0/c;->r(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v5

    invoke-static {v5, v4}, Lh/g0/c;->G(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
    ...
    iget-object v3, v1, Lokhttp3/internal/http2/f$g;->d:Li/d;

    iget-boolean v4, v0, Lokhttp3/internal/http2/f;->a:Z

    invoke-direct {v2, v3, v4}, Lokhttp3/internal/http2/i;-><init>(Li/d;Z)V
    ...
    iget-object v1, v1, Lokhttp3/internal/http2/f$g;->c:Li/e;

    iget-boolean v4, v0, Lokhttp3/internal/http2/f;->a:Z

    invoke-direct {v3, v1, v4}, Lokhttp3/internal/http2/g;-><init>(Li/e;Z)V
...
.method private S(ILjava/util/List;Z)Lokhttp3/internal/http2/h;
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/http2/h;-><init>(ILokhttp3/internal/http2/f;ZZLh/s;)V
...
.method private declared-synchronized V(Lh/g0/b;)V
    .locals 1
...
.method U(ILi/e;IZ)V
    ...
    .line 3
    invoke-interface {p2, v5, v0, v1}, Li/t;->read(Li/c;J)J

    .line 4
    invoke-virtual {v5}, Li/c;->d0()J
    ...
    invoke-direct/range {v0 .. v7}, Lokhttp3/internal/http2/f$e;-><init>(Lokhttp3/internal/http2/f;Ljava/lang/String;[Ljava/lang/Object;ILi/c;IZ)V

    invoke-direct {p0, p2}, Lokhttp3/internal/http2/f;->V(Lh/g0/b;)V
...
.method W(ILjava/util/List;Z)V
    ...
    invoke-direct {p0, v7}, Lokhttp3/internal/http2/f;->V(Lh/g0/b;)V
    :try_end_0
...
.method X(ILjava/util/List;)V
    ...
    invoke-direct {p0, v0}, Lokhttp3/internal/http2/f;->V(Lh/g0/b;)V
    :try_end_1
...
.method Y(ILokhttp3/internal/http2/a;)V
    ...
    invoke-direct {p0, v6}, Lokhttp3/internal/http2/f;->V(Lh/g0/b;)V
...
.method public f0(IZLi/c;J)V
    ...
    invoke-virtual {p4, p2, p1, p3, v0}, Lokhttp3/internal/http2/i;->L(ZILi/c;I)V
    ...
    :goto_2
    invoke-virtual {v4, v5, p1, p3, v3}, Lokhttp3/internal/http2/i;->L(ZILi/c;I)V
