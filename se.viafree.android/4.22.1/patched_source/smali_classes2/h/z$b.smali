...
.method constructor <init>(Lh/z;Lh/f;)V
    ...
    .line 3
    iput-object p2, p0, Lh/z$b;->b:Lh/f;
...
.method protected k()V
    ...
    invoke-virtual {v1}, Lh/z;->e()Lh/c0;
    ...
    .line 3
    :try_start_1
    iget-object v2, p0, Lh/z$b;->b:Lh/f;

    iget-object v3, p0, Lh/z$b;->g:Lh/z;

    invoke-interface {v2, v3, v0}, Lh/f;->onResponse(Lh/e;Lh/c0;)V
    :try_end_1
    ...
    iget-object v0, v0, Lh/z;->a:Lh/x;

    invoke-virtual {v0}, Lh/x;->j()Lh/n;

    move-result-object v0

    invoke-virtual {v0, p0}, Lh/n;->e(Lh/z$b;)V
    ...
    invoke-virtual {v2, v0}, Lh/z;->h(Ljava/io/IOException;)Ljava/io/IOException;
    ...
    invoke-virtual {v4}, Lh/z;->i()Ljava/lang/String;
    ...
    invoke-static {v1}, Lh/z;->a(Lh/z;)Lh/p;

    move-result-object v1

    iget-object v2, p0, Lh/z$b;->g:Lh/z;

    invoke-virtual {v1, v2, v0}, Lh/p;->b(Lh/e;Ljava/io/IOException;)V

    .line 8
    iget-object v1, p0, Lh/z$b;->b:Lh/f;

    iget-object v2, p0, Lh/z$b;->g:Lh/z;

    invoke-interface {v1, v2, v0}, Lh/f;->onFailure(Lh/e;Ljava/io/IOException;)V
    :try_end_2
    ...
    iget-object v1, v1, Lh/z;->a:Lh/x;

    invoke-virtual {v1}, Lh/x;->j()Lh/n;

    move-result-object v1

    invoke-virtual {v1, p0}, Lh/n;->e(Lh/z$b;)V
...
.method l(Ljava/util/concurrent/ExecutorService;)V
    ...
    .line 5
    iget-object p1, p0, Lh/z$b;->b:Lh/f;

    iget-object v1, p0, Lh/z$b;->g:Lh/z;

    invoke-interface {p1, v1, v0}, Lh/f;->onFailure(Lh/e;Ljava/io/IOException;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    iget-object p1, p1, Lh/z;->a:Lh/x;

    invoke-virtual {p1}, Lh/x;->j()Lh/n;

    move-result-object p1

    invoke-virtual {p1, p0}, Lh/n;->e(Lh/z$b;)V
