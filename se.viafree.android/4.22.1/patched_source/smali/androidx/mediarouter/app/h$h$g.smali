...
.method constructor <init>(Landroidx/mediarouter/app/h$h;Landroid/view/View;)V
    ...
    sget v1, Lc/s/f;->mr_cast_mute_button:I
    ...
    sget v2, Lc/s/f;->mr_cast_volume_slider:I
    ...
    .line 7
    sget v0, Lc/s/f;->mr_cast_route_icon:I
    ...
    .line 8
    sget v0, Lc/s/f;->mr_cast_route_progress_bar:I
    ...
    .line 9
    sget v0, Lc/s/f;->mr_cast_route_name:I
    ...
    .line 10
    sget v0, Lc/s/f;->mr_cast_volume_layout:I
    ...
    .line 11
    sget v0, Lc/s/f;->mr_cast_checkbox:I
    ...
    iget-object p2, p2, Landroidx/mediarouter/app/h;->m:Landroid/content/Context;
    ...
    .line 19
    sget v1, Lc/s/d;->mr_dynamic_dialog_row_height:I
...
.method private g(Lc/s/m/g$f;)Z
    ...
    .line 2
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/mediarouter/app/h$h$g;->h(Lc/s/m/g$f;)Z
    ...
    .line 5
    invoke-virtual {p1}, Lc/s/m/g$f$a;->d()Z
...
.method f(Landroidx/mediarouter/app/h$h$f;)V
    ...
    iget-object v2, v2, Landroidx/mediarouter/app/h;->j:Ljava/util/List;
    ...
    .line 5
    :cond_1
    invoke-virtual {p0, p1}, Landroidx/mediarouter/app/h$f;->b(Lc/s/m/g$f;)V
    ...
    invoke-virtual {v1, p1}, Landroidx/mediarouter/app/h$h;->f(Lc/s/m/g$f;)Landroid/graphics/drawable/Drawable;
    ...
    .line 11
    invoke-direct {p0, p1}, Landroidx/mediarouter/app/h$h$g;->g(Lc/s/m/g$f;)Z
    ...
    iget-object v3, p0, Landroidx/mediarouter/app/h$f;->a:Lc/s/m/g$f;
    ...
    .line 23
    :goto_2
    invoke-static {v1, v3}, Landroidx/mediarouter/app/h;->h(Landroid/view/View;I)V
    ...
    invoke-static {p1, v0}, Landroidx/mediarouter/app/h;->h(Landroid/view/View;I)V
...
.method h(Lc/s/m/g$f;)Z
    ...
    .line 3
    invoke-virtual {p1}, Lc/s/m/g$f$a;->a()I
...
.method i(ZZ)V
    ...
    :goto_0
    invoke-virtual {p2, v0, p1}, Landroidx/mediarouter/app/h$h;->d(Landroid/view/View;I)V
