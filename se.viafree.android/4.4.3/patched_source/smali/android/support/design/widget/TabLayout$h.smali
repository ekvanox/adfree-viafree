...
.method public constructor <init>(Landroid/support/design/widget/TabLayout;Landroid/content/Context;)V
    ...
    invoke-static {p0, p2, v0, v1, v2}, Landroid/support/v4/view/t;->b(Landroid/view/View;IIII)V
    ...
    invoke-static {p1, p2}, Landroid/support/v4/view/r;->a(Landroid/content/Context;I)Landroid/support/v4/view/r;

    move-result-object p1

    .line 1970
    invoke-static {p0, p1}, Landroid/support/v4/view/t;->a(Landroid/view/View;Landroid/support/v4/view/r;)V
...
.method private a(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Landroid/support/design/widget/TabLayout$h;->h:Landroid/graphics/drawable/Drawable;

    .line 1977
    iget-object p1, p0, Landroid/support/design/widget/TabLayout$h;->h:Landroid/graphics/drawable/Drawable;
    ...
    .line 1981
    :cond_0
    iput-object v1, p0, Landroid/support/design/widget/TabLayout$h;->h:Landroid/graphics/drawable/Drawable;
    ...
    .line 1997
    invoke-static {v3}, Landroid/support/design/g/a;->a(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
    ...
    .line 2016
    iget-object p1, p0, Landroid/support/design/widget/TabLayout$h;->a:Landroid/support/design/widget/TabLayout;
...
.method private a(Landroid/widget/TextView;Landroid/widget/ImageView;)V
    ...
    .line 2317
    invoke-static {p1, v2}, Landroid/support/v4/view/g;->b(Landroid/view/ViewGroup$MarginLayoutParams;I)V
    ...
    .line 2326
    invoke-static {p1, v4}, Landroid/support/v4/view/g;->b(Landroid/view/ViewGroup$MarginLayoutParams;I)V
    ...
    :cond_8
    :goto_5
    iget-object p1, p0, Landroid/support/design/widget/TabLayout$h;->b:Landroid/support/design/widget/TabLayout$f;
...
.method final b()V
    ...
    .line 2194
    iget-object v3, p0, Landroid/support/design/widget/TabLayout$h;->c:Landroid/widget/TextView;
    ...
    .line 2197
    :cond_3
    iget-object v3, p0, Landroid/support/design/widget/TabLayout$h;->d:Landroid/widget/ImageView;
    ...
    .line 2203
    iget-object v3, p0, Landroid/support/design/widget/TabLayout$h;->f:Landroid/widget/TextView;

    if-eqz v3, :cond_5

    .line 2204
    invoke-static {v3}, Landroid/support/v4/widget/q;->a(Landroid/widget/TextView;)I

    move-result v3

    iput v3, p0, Landroid/support/design/widget/TabLayout$h;->i:I
    ...
    .line 2209
    :cond_6
    iget-object v2, p0, Landroid/support/design/widget/TabLayout$h;->e:Landroid/view/View;
    ...
    .line 2211
    iput-object v1, p0, Landroid/support/design/widget/TabLayout$h;->e:Landroid/view/View;

    .line 2213
    :cond_7
    iput-object v1, p0, Landroid/support/design/widget/TabLayout$h;->f:Landroid/widget/TextView;

    .line 2214
    iput-object v1, p0, Landroid/support/design/widget/TabLayout$h;->g:Landroid/widget/ImageView;
    ...
    .line 2225
    iput-object v2, p0, Landroid/support/design/widget/TabLayout$h;->d:Landroid/widget/ImageView;
    ...
    .line 2244
    iput-object v1, p0, Landroid/support/design/widget/TabLayout$h;->c:Landroid/widget/TextView;

    .line 2245
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$h;->c:Landroid/widget/TextView;

    invoke-static {v1}, Landroid/support/v4/widget/q;->a(Landroid/widget/TextView;)I

    move-result v1

    iput v1, p0, Landroid/support/design/widget/TabLayout$h;->i:I
    ...
    invoke-static {v1, v2}, Landroid/support/v4/widget/q;->a(Landroid/widget/TextView;I)V

    .line 2248
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$h;->a:Landroid/support/design/widget/TabLayout;
    ...
    .line 2254
    :cond_d
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$h;->f:Landroid/widget/TextView;
...
.method protected drawableStateChanged()V
    ...
    .line 2041
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$h;->h:Landroid/graphics/drawable/Drawable;
...
.method public onMeasure(II)V
    ...
    .line 2129
    iget v1, p0, Landroid/support/design/widget/TabLayout$h;->i:I
    ...
    .line 2134
    :cond_2
    iget-object v2, p0, Landroid/support/design/widget/TabLayout$h;->c:Landroid/widget/TextView;
    ...
    invoke-static {v5}, Landroid/support/v4/widget/q;->a(Landroid/widget/TextView;)I
