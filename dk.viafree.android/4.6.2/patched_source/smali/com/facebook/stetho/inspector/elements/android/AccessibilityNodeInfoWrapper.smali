...
.method public static createNodeInfoFromView(Landroid/view/View;)La/h/q/f0/d;
    .locals 1
    ...
    .line 2
    invoke-static {p0, v0}, La/h/q/w;->a(Landroid/view/View;La/h/q/f0/d;)V
...
.method public static getActions(Landroid/view/View;)Ljava/lang/String;
    ...
    .line 1
    invoke-static {p0}, Lcom/facebook/stetho/inspector/elements/android/AccessibilityNodeInfoWrapper;->createNodeInfoFromView(Landroid/view/View;)La/h/q/f0/d;
    ...
    .line 6
    :cond_0
    invoke-virtual {v2}, La/h/q/f0/d$a;->a()I
    ...
    .line 7
    invoke-virtual {v2}, La/h/q/f0/d$a;->b()Ljava/lang/CharSequence;
    ...
    .line 29
    :goto_1
    invoke-virtual {p0}, La/h/q/f0/d;->w()V
...
.method public static getDescription(Landroid/view/View;)Ljava/lang/CharSequence;
    ...
    .line 14
    invoke-static {v5, v6}, La/h/q/w;->a(Landroid/view/View;La/h/q/f0/d;)V

    .line 15
    invoke-static {v6, v5}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isSpeakingNode(La/h/q/f0/d;Landroid/view/View;)Z
    ...
    .line 16
    invoke-static {v6, v5}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isAccessibilityFocusable(La/h/q/f0/d;Landroid/view/View;)Z
    ...
    .line 22
    :cond_6
    invoke-virtual {v6}, La/h/q/f0/d;->w()V
...
.method public static getFocusableReasons(Landroid/view/View;)Ljava/lang/String;
    ...
    .line 2
    :try_start_0
    invoke-static {v0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->hasText(La/h/q/f0/d;)Z

    move-result v1

    .line 3
    invoke-virtual {v0}, La/h/q/f0/d;->l()Z

    move-result v2

    .line 4
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->hasNonActionableSpeakingDescendants(La/h/q/f0/d;Landroid/view/View;)Z

    move-result v3

    .line 5
    invoke-static {v0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isActionableForAccessibility(La/h/q/f0/d;)Z
    ...
    :cond_3
    :try_start_4
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isTopLevelScrollItem(La/h/q/f0/d;Landroid/view/View;)Z
...
.method public static getIgnored(Landroid/view/View;)Z
    ...
    invoke-static {v3}, La/h/q/w;->k(Landroid/view/View;)I
    ...
    .line 7
    :try_start_0
    invoke-virtual {v0}, La/h/q/f0/d;->v()Z
    ...
    :cond_3
    :try_start_1
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isAccessibilityFocusable(La/h/q/f0/d;Landroid/view/View;)Z
    ...
    :cond_4
    :try_start_2
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isSpeakingNode(La/h/q/f0/d;Landroid/view/View;)Z
    ...
    :cond_6
    :try_start_3
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->hasFocusableAncestor(La/h/q/f0/d;Landroid/view/View;)Z
...
.method public static getIgnoredReasons(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-static {v2}, La/h/q/w;->k(Landroid/view/View;)I
...
.method public static getIsAccessibilityFocused(Landroid/view/View;)Z
    ...
    .line 2
    invoke-virtual {p0}, La/h/q/f0/d;->k()Z
