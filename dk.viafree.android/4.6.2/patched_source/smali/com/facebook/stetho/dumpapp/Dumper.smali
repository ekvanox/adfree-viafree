...
.field private final mParser:Lk/a/a/a/c;
...
.method public constructor <init>(Ljava/lang/Iterable;)V
    ...
    invoke-direct {v0}, Lk/a/a/a/d;-><init>()V

    invoke-direct {p0, p1, v0}, Lcom/facebook/stetho/dumpapp/Dumper;-><init>(Ljava/lang/Iterable;Lk/a/a/a/c;)V

    return-void
.end method

.method public constructor <init>(Ljava/lang/Iterable;Lk/a/a/a/c;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    iput-object p2, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Lk/a/a/a/c;
...
.method private doDump(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;[Ljava/lang/String;)I
    ...
    .line 1
    iget-object v0, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Lk/a/a/a/c;

    iget-object v1, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mGlobalOptions:Lcom/facebook/stetho/dumpapp/GlobalOptions;

    iget-object v1, v1, Lcom/facebook/stetho/dumpapp/GlobalOptions;->options:Lk/a/a/a/k;

    const/4 v2, 0x1

    invoke-interface {v0, v1, p4, v2}, Lk/a/a/a/c;->a(Lk/a/a/a/k;[Ljava/lang/String;Z)Lk/a/a/a/b;
    ...
    iget-object v0, v0, Lcom/facebook/stetho/dumpapp/GlobalOptions;->optionHelp:Lk/a/a/a/h;

    invoke-virtual {v0}, Lk/a/a/a/h;->g()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p4, v0}, Lk/a/a/a/b;->b(Ljava/lang/String;)Z
    ...
    iget-object v0, v0, Lcom/facebook/stetho/dumpapp/GlobalOptions;->optionListPlugins:Lk/a/a/a/h;
    ...
    .line 6
    :cond_1
    invoke-virtual {p4}, Lk/a/a/a/b;->a()Ljava/util/List;
    ...
    .line 7
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/facebook/stetho/dumpapp/Dumper;->dumpPluginOutput(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Lk/a/a/a/b;)V
...
.method private dumpPluginOutput(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Lk/a/a/a/b;)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/facebook/stetho/dumpapp/DumpException;
    ...
    iget-object v4, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Lk/a/a/a/c;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/facebook/stetho/dumpapp/DumperContext;-><init>(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Lk/a/a/a/c;Ljava/util/List;)V
...
.method private dumpUsage(Ljava/io/PrintStream;)V
    ...
    .line 4
    :try_start_0
    invoke-virtual {v0}, Lk/a/a/a/e;->d()I

    move-result v2

    iget-object p1, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mGlobalOptions:Lcom/facebook/stetho/dumpapp/GlobalOptions;

    iget-object v3, p1, Lcom/facebook/stetho/dumpapp/GlobalOptions;->options:Lk/a/a/a/k;

    .line 5
    invoke-virtual {v0}, Lk/a/a/a/e;->b()I

    move-result v4

    .line 6
    invoke-virtual {v0}, Lk/a/a/a/e;->a()I
    ...
    .line 7
    invoke-virtual/range {v0 .. v5}, Lk/a/a/a/e;->a(Ljava/io/PrintWriter;ILk/a/a/a/k;II)V
    :try_end_0
...
.method public dump(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;[Ljava/lang/String;)I
    ...
    move-result p1
    :try_end_0
    .catch Lk/a/a/a/l; {:try_start_0 .. :try_end_0} :catch_3
