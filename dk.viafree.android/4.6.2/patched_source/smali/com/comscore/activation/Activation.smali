...
.method private static b(Ljava/lang/String;Ljava/lang/String;Lcom/comscore/PublisherConfiguration;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v2}, Lcom/comscore/util/jni/JniComScoreHelper;->getApplicationId()Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lcom/comscore/util/jni/JniComScoreHelper;->getApplicationName()Ljava/lang/String;
    ...
    invoke-virtual {v5}, Lcom/comscore/util/jni/JniComScoreHelper;->getApplicationVersion()Ljava/lang/String;
    ...
    :cond_1
    :try_start_0
    const-string v6, "http://segment-data-us-east.zqtk.net/%s?url=%s&c2=%s&c12=%s&ns_ap_bi=%s&ns_ap_sv=%s&ns_ap_an=%s&ns_ap_ver=%s&ns_ap_pn=android"
    ...
    invoke-virtual {p1, p2, v8, p3}, Ljava/io/ByteArrayOutputStream;->write([BII)V
