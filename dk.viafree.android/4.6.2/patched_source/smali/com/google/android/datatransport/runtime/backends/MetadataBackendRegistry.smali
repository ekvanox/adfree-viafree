...
.field private final creationContext:Lcom/google/android/datatransport/runtime/backends/CreationContext;


# direct methods
.method constructor <init>(Landroid/content/Context;Lcom/google/android/datatransport/runtime/backends/CreationContext;)V
    .locals 1
    ...
    .line 3
    iput-object v0, p0, Lcom/google/android/datatransport/runtime/backends/MetadataBackendRegistry;->backendProviders:Ljava/util/Map;

    .line 4
    iput-object p1, p0, Lcom/google/android/datatransport/runtime/backends/MetadataBackendRegistry;->applicationContext:Landroid/content/Context;

    .line 5
    iput-object p2, p0, Lcom/google/android/datatransport/runtime/backends/MetadataBackendRegistry;->creationContext:Lcom/google/android/datatransport/runtime/backends/CreationContext;
...
.method private discover(Landroid/content/Context;)Ljava/util/Map;
    ...
    .line 1
    invoke-static {p1}, Lcom/google/android/datatransport/runtime/backends/MetadataBackendRegistry;->getMetadata(Landroid/content/Context;)Landroid/os/Bundle;
...
.method private getBackendProviders()Ljava/util/Map;
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/datatransport/runtime/backends/MetadataBackendRegistry;->backendProviders:Ljava/util/Map;

    if-nez v0, :cond_0

    .line 2
    iget-object v0, p0, Lcom/google/android/datatransport/runtime/backends/MetadataBackendRegistry;->applicationContext:Landroid/content/Context;

    invoke-direct {p0, v0}, Lcom/google/android/datatransport/runtime/backends/MetadataBackendRegistry;->discover(Landroid/content/Context;)Ljava/util/Map;
...
.method public declared-synchronized get(Ljava/lang/String;)Lcom/google/android/datatransport/runtime/backends/TransportBackend;
    ...
    :cond_0
    :try_start_1
    invoke-direct {p0}, Lcom/google/android/datatransport/runtime/backends/MetadataBackendRegistry;->getBackendProviders()Ljava/util/Map;
    ...
    .line 9
    iget-object v5, p0, Lcom/google/android/datatransport/runtime/backends/MetadataBackendRegistry;->creationContext:Lcom/google/android/datatransport/runtime/backends/CreationContext;

    invoke-interface {v4, v5}, Lcom/google/android/datatransport/runtime/backends/BackendFactory;->create(Lcom/google/android/datatransport/runtime/backends/CreationContext;)Lcom/google/android/datatransport/runtime/backends/TransportBackend;

    move-result-object v4

    .line 10
    iget-object v5, p0, Lcom/google/android/datatransport/runtime/backends/MetadataBackendRegistry;->backends:Ljava/util/Map;
