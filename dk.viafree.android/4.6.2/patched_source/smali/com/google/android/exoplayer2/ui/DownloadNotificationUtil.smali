...
.method public static buildDownloadCompletedNotification(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;Ljava/lang/String;)Landroid/app/Notification;
    ...
    .line 2
    invoke-static/range {v0 .. v5}, Lcom/google/android/exoplayer2/ui/DownloadNotificationUtil;->newNotificationBuilder(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;Ljava/lang/String;I)Landroidx/core/app/j$d;

    move-result-object p0

    .line 3
    invoke-virtual {p0}, Landroidx/core/app/j$d;->a()Landroid/app/Notification;
...
.method public static buildProgressNotification(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;Ljava/lang/String;[Lcom/google/android/exoplayer2/offline/DownloadManager$TaskState;)Landroid/app/Notification;
    ...
    .line 7
    invoke-static/range {v11 .. v16}, Lcom/google/android/exoplayer2/ui/DownloadNotificationUtil;->newNotificationBuilder(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;Ljava/lang/String;I)Landroidx/core/app/j$d;
    ...
    .line 8
    invoke-virtual {v0, v5, v1, v4}, Landroidx/core/app/j$d;->a(IIZ)Landroidx/core/app/j$d;

    .line 9
    invoke-virtual {v0, v2}, Landroidx/core/app/j$d;->d(Z)Landroidx/core/app/j$d;

    .line 10
    invoke-virtual {v0, v3}, Landroidx/core/app/j$d;->e(Z)Landroidx/core/app/j$d;
...
.method private static newNotificationBuilder(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;Ljava/lang/String;I)Landroidx/core/app/j$d;
    .locals 1

    .line 1
    new-instance v0, Landroidx/core/app/j$d;

    invoke-direct {v0, p0, p2}, Landroidx/core/app/j$d;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    .line 2
    invoke-virtual {v0, p1}, Landroidx/core/app/j$d;->f(I)Landroidx/core/app/j$d;
    ...
    invoke-virtual {v0, p0}, Landroidx/core/app/j$d;->b(Ljava/lang/CharSequence;)Landroidx/core/app/j$d;

    :cond_0
    if-eqz p3, :cond_1

    .line 4
    invoke-virtual {v0, p3}, Landroidx/core/app/j$d;->a(Landroid/app/PendingIntent;)Landroidx/core/app/j$d;
    ...
    invoke-virtual {p0, p4}, Landroidx/core/app/j$c;->a(Ljava/lang/CharSequence;)Landroidx/core/app/j$c;

    invoke-virtual {v0, p0}, Landroidx/core/app/j$d;->a(Landroidx/core/app/j$e;)Landroidx/core/app/j$d;
