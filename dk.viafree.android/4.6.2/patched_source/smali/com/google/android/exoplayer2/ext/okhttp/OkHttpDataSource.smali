...
.field private final cacheControl:Li/d;

.field private final callFactory:Li/e$a;
...
.method public constructor <init>(Li/e$a;Ljava/lang/String;Lcom/google/android/exoplayer2/util/Predicate;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/google/android/exoplayer2/ext/okhttp/OkHttpDataSource;-><init>(Li/e$a;Ljava/lang/String;Lcom/google/android/exoplayer2/util/Predicate;Lcom/google/android/exoplayer2/upstream/TransferListener;)V

    return-void
.end method

.method public constructor <init>(Li/e$a;Ljava/lang/String;Lcom/google/android/exoplayer2/util/Predicate;Lcom/google/android/exoplayer2/upstream/TransferListener;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-direct/range {v0 .. v6}, Lcom/google/android/exoplayer2/ext/okhttp/OkHttpDataSource;-><init>(Li/e$a;Ljava/lang/String;Lcom/google/android/exoplayer2/util/Predicate;Lcom/google/android/exoplayer2/upstream/TransferListener;Li/d;Lcom/google/android/exoplayer2/upstream/HttpDataSource$RequestProperties;)V

    return-void
.end method

.method public constructor <init>(Li/e$a;Ljava/lang/String;Lcom/google/android/exoplayer2/util/Predicate;Lcom/google/android/exoplayer2/upstream/TransferListener;Li/d;Lcom/google/android/exoplayer2/upstream/HttpDataSource$RequestProperties;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/ext/okhttp/OkHttpDataSource;->callFactory:Li/e$a;
    ...
    .line 8
    iput-object p5, p0, Lcom/google/android/exoplayer2/ext/okhttp/OkHttpDataSource;->cacheControl:Li/d;
...
.method private closeConnectionQuietly()V
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/exoplayer2/ext/okhttp/OkHttpDataSource;->response:Li/c0;
    ...
    .line 2
    iput-object v0, p0, Lcom/google/android/exoplayer2/ext/okhttp/OkHttpDataSource;->response:Li/c0;
...
.method private makeRequest(Lcom/google/android/exoplayer2/upstream/DataSpec;)Li/a0;
    .locals 11
    ...
    invoke-static {v5}, Li/t;->d(Ljava/lang/String;)Li/t;

    move-result-object v5

    .line 5
    new-instance v6, Li/a0$a;

    invoke-direct {v6}, Li/a0$a;-><init>()V

    invoke-virtual {v6, v5}, Li/a0$a;->a(Li/t;)Li/a0$a;

    .line 6
    iget-object v5, p0, Lcom/google/android/exoplayer2/ext/okhttp/OkHttpDataSource;->cacheControl:Li/d;

    if-eqz v5, :cond_0

    .line 7
    invoke-virtual {v6, v5}, Li/a0$a;->a(Li/d;)Li/a0$a;

    .line 8
    :cond_0
    iget-object v5, p0, Lcom/google/android/exoplayer2/ext/okhttp/OkHttpDataSource;->defaultRequestProperties:Lcom/google/android/exoplayer2/upstream/HttpDataSource$RequestProperties;

    if-eqz v5, :cond_1

    .line 9
    invoke-virtual {v5}, Lcom/google/android/exoplayer2/upstream/HttpDataSource$RequestProperties;->getSnapshot()Ljava/util/Map;
    ...
    invoke-virtual {v6, v8, v7}, Li/a0$a;->b(Ljava/lang/String;Ljava/lang/String;)Li/a0$a;

    goto :goto_0

    .line 11
    :cond_1
    iget-object v5, p0, Lcom/google/android/exoplayer2/ext/okhttp/OkHttpDataSource;->requestProperties:Lcom/google/android/exoplayer2/upstream/HttpDataSource$RequestProperties;
    ...
    .line 15
    invoke-virtual {v6, v0, v5}, Li/a0$a;->a(Ljava/lang/String;Ljava/lang/String;)Li/a0$a;
    ...
    .line 17
    invoke-virtual {v6, v1, v0}, Li/a0$a;->a(Ljava/lang/String;Ljava/lang/String;)Li/a0$a;
    ...
    .line 18
    invoke-virtual {v6, v0, v1}, Li/a0$a;->a(Ljava/lang/String;Ljava/lang/String;)Li/a0$a;
    ...
    .line 20
    invoke-static {v0, p1}, Li/b0;->create(Li/v;[B)Li/b0;

    move-result-object p1

    invoke-virtual {v6, p1}, Li/a0$a;->a(Li/b0;)Li/a0$a;

    .line 21
    :cond_8
    invoke-virtual {v6}, Li/a0$a;->a()Li/a0;
...
.method public getResponseHeaders()Ljava/util/Map;
    ...
    invoke-virtual {v0}, Li/s;->c()Ljava/util/Map;
...
.method public open(Lcom/google/android/exoplayer2/upstream/DataSpec;)J
    ...
    .line 4
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/ext/okhttp/OkHttpDataSource;->makeRequest(Lcom/google/android/exoplayer2/upstream/DataSpec;)Li/a0;
    ...
    .line 5
    :try_start_0
    iget-object v4, p0, Lcom/google/android/exoplayer2/ext/okhttp/OkHttpDataSource;->callFactory:Li/e$a;

    invoke-interface {v4, v2}, Li/e$a;->a(Li/a0;)Li/e;

    move-result-object v2

    invoke-static {v2}, Lcom/google/firebase/perf/network/FirebasePerfOkHttpClient;->execute(Li/e;)Li/c0;

    move-result-object v2

    iput-object v2, p0, Lcom/google/android/exoplayer2/ext/okhttp/OkHttpDataSource;->response:Li/c0;

    .line 6
    iget-object v2, p0, Lcom/google/android/exoplayer2/ext/okhttp/OkHttpDataSource;->response:Li/c0;

    invoke-virtual {v2}, Li/c0;->w()Li/d0;

    move-result-object v2

    invoke-virtual {v2}, Li/d0;->byteStream()Ljava/io/InputStream;
    ...
    invoke-virtual {v2}, Li/c0;->z()I

    move-result v2

    .line 8
    iget-object v4, p0, Lcom/google/android/exoplayer2/ext/okhttp/OkHttpDataSource;->response:Li/c0;

    invoke-virtual {v4}, Li/c0;->C()Z
    ...
    invoke-virtual {v4}, Li/c0;->w()Li/d0;

    move-result-object v4

    invoke-virtual {v4}, Li/d0;->contentType()Li/v;
    ...
    .line 15
    invoke-virtual {v4}, Li/v;->toString()Ljava/lang/String;
