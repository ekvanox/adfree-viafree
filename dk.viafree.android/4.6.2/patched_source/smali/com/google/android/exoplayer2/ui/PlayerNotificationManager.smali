...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;ILcom/google/android/exoplayer2/ui/PlayerNotificationManager$MediaDescriptionAdapter;Lcom/google/android/exoplayer2/ui/PlayerNotificationManager$CustomActionReceiver;)V
    ...
    iget-object p1, p1, Landroidx/core/app/j$a;->i:Landroid/app/PendingIntent;
...
.method private static createPlaybackActions(Landroid/content/Context;)Ljava/util/Map;
    ...
    .line 3
    new-instance v3, Landroidx/core/app/j$a;
    ...
    invoke-direct {v3, v4, v5, v1}, Landroidx/core/app/j$a;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    invoke-direct {v3, v4, v5, p0}, Landroidx/core/app/j$a;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V
...
.method private updateNotification(Landroid/graphics/Bitmap;)Landroid/app/Notification;
    ...
    invoke-virtual {v0, v1, p1}, Landroidx/core/app/m;->a(ILandroid/app/Notification;)V
...
.method protected createNotification(Lcom/google/android/exoplayer2/Player;Landroid/graphics/Bitmap;)Landroid/app/Notification;
    ...
    invoke-direct {v1, v2, v3}, Landroidx/core/app/j$d;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 10
    invoke-virtual {v1, v5}, Landroidx/core/app/j$d;->a(Landroidx/core/app/j$a;)Landroidx/core/app/j$d;
    ...
    .line 11
    :cond_2
    new-instance v2, Landroidx/media/j/a;

    invoke-direct {v2}, Landroidx/media/j/a;-><init>()V

    .line 12
    invoke-virtual {v1, v2}, Landroidx/core/app/j$d;->a(Landroidx/core/app/j$e;)Landroidx/core/app/j$d;
    ...
    .line 14
    invoke-virtual {v2, v4}, Landroidx/media/j/a;->a(Landroid/support/v4/media/session/MediaSessionCompat$Token;)Landroidx/media/j/a;
    ...
    invoke-virtual {v2, v4}, Landroidx/media/j/a;->a([I)Landroidx/media/j/a;
    ...
    .line 17
    :goto_2
    invoke-virtual {v2, v0}, Landroidx/media/j/a;->a(Z)Landroidx/media/j/a;
    ...
    .line 19
    invoke-virtual {v1, v0}, Landroidx/core/app/j$d;->b(Landroid/app/PendingIntent;)Landroidx/core/app/j$d;

    .line 20
    iget-object v0, p0, Lcom/google/android/exoplayer2/ui/PlayerNotificationManager;->stopPendingIntent:Landroid/app/PendingIntent;

    invoke-virtual {v2, v0}, Landroidx/media/j/a;->a(Landroid/app/PendingIntent;)Landroidx/media/j/a;
    ...
    invoke-virtual {v1, v2, v3}, Landroidx/core/app/j$d;->a(J)Landroidx/core/app/j$d;

    .line 35
    invoke-virtual {v1, v5}, Landroidx/core/app/j$d;->e(Z)Landroidx/core/app/j$d;

    .line 36
    invoke-virtual {v1, v5}, Landroidx/core/app/j$d;->f(Z)Landroidx/core/app/j$d;

    goto :goto_3

    .line 37
    :cond_6
    invoke-virtual {v1, v3}, Landroidx/core/app/j$d;->e(Z)Landroidx/core/app/j$d;

    invoke-virtual {v1, v3}, Landroidx/core/app/j$d;->f(Z)Landroidx/core/app/j$d;
    ...
    invoke-virtual {v1, v0}, Landroidx/core/app/j$d;->b(Ljava/lang/CharSequence;)Landroidx/core/app/j$d;
    ...
    invoke-virtual {v1, v0}, Landroidx/core/app/j$d;->a(Ljava/lang/CharSequence;)Landroidx/core/app/j$d;
    ...
    .line 42
    invoke-virtual {v1, p2}, Landroidx/core/app/j$d;->a(Landroid/graphics/Bitmap;)Landroidx/core/app/j$d;
    ...
    .line 44
    invoke-virtual {v1, p1}, Landroidx/core/app/j$d;->a(Landroid/app/PendingIntent;)Landroidx/core/app/j$d;

    .line 45
    :cond_9
    invoke-virtual {v1}, Landroidx/core/app/j$d;->a()Landroid/app/Notification;
