.class Landroidx/leanback/widget/o1;
.super Landroidx/leanback/widget/v;
.source "SingleRow.java"


# instance fields
.field private final j:Landroidx/leanback/widget/v$a;
...
.method constructor <init>()V
    ...
    invoke-direct {v0, v1}, Landroidx/leanback/widget/v$a;-><init>(I)V

    iput-object v0, p0, Landroidx/leanback/widget/o1;->j:Landroidx/leanback/widget/v$a;

    const/4 v0, 0x1

    .line 3
    invoke-virtual {p0, v0}, Landroidx/leanback/widget/v;->h(I)V
...
.method protected final a(ZI[I)I
    ...
    .line 30
    :cond_0
    iget-boolean p1, p0, Landroidx/leanback/widget/v;->c:Z

    if-eqz p1, :cond_1

    iget-object p1, p0, Landroidx/leanback/widget/v;->b:Landroidx/leanback/widget/v$b;

    invoke-interface {p1, p2}, Landroidx/leanback/widget/v$b;->b(I)I
    ...
    iget-object p3, p0, Landroidx/leanback/widget/v;->b:Landroidx/leanback/widget/v$b;

    invoke-interface {p3, p2}, Landroidx/leanback/widget/v$b;->a(I)I
...
.method public a(IILandroidx/recyclerview/widget/RecyclerView$o$c;)V
    ...
    .line 16
    :cond_1
    invoke-virtual {p0}, Landroidx/leanback/widget/o1;->j()I
    ...
    invoke-interface {v0, v1}, Landroidx/leanback/widget/v$b;->b(I)I
    ...
    .line 19
    :cond_4
    invoke-virtual {p0}, Landroidx/leanback/widget/o1;->i()I
    ...
    invoke-interface {v1, v2}, Landroidx/leanback/widget/v$b;->b(I)I
...
.method protected final a(IZ)Z
    ...
    invoke-interface {v4}, Landroidx/leanback/widget/v$b;->getCount()I
    ...
    invoke-interface {v3, v0, v2, v4, v1}, Landroidx/leanback/widget/v$b;->a(IZ[Ljava/lang/Object;Z)I

    move-result v6

    .line 5
    iget v3, p0, Landroidx/leanback/widget/v;->f:I
    ...
    invoke-interface {v3, v4}, Landroidx/leanback/widget/v$b;->b(I)I

    move-result v3

    iget-object v5, p0, Landroidx/leanback/widget/v;->b:Landroidx/leanback/widget/v$b;

    invoke-interface {v5, v4}, Landroidx/leanback/widget/v$b;->a(I)I
    ...
    invoke-interface/range {v3 .. v8}, Landroidx/leanback/widget/v$b;->a(Ljava/lang/Object;IIII)V
...
.method public final a(II)[La/e/d;
    ...
    invoke-virtual {p1, p2}, La/e/d;->a(I)V
...
.method protected final b(IZ)Z
    ...
    invoke-interface {v0}, Landroidx/leanback/widget/v$b;->a()I
    ...
    invoke-interface {v4, v2, v1, v5, v1}, Landroidx/leanback/widget/v$b;->a(IZ[Ljava/lang/Object;Z)I
    ...
    iget v4, p0, Landroidx/leanback/widget/v;->g:I
    ...
    invoke-interface {v4, v5}, Landroidx/leanback/widget/v$b;->b(I)I

    move-result v4

    iget v5, p0, Landroidx/leanback/widget/v;->d:I
    ...
    .line 10
    :goto_1
    iput v2, p0, Landroidx/leanback/widget/v;->f:I
    ...
    iput v2, p0, Landroidx/leanback/widget/v;->g:I
...
.method public final d(I)Landroidx/leanback/widget/v$a;
    .locals 0

    .line 1
    iget-object p1, p0, Landroidx/leanback/widget/o1;->j:Landroidx/leanback/widget/v$a;
