...
.field private j:[Landroidx/leanback/widget/PagingIndicator$d;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 6
    sget-object v1, La/l/m;->PagingIndicator:[I
    ...
    .line 7
    sget p2, La/l/m;->PagingIndicator_lbDotRadius:I

    sget p3, La/l/d;->lb_page_indicator_dot_radius:I

    invoke-direct {p0, p1, p2, p3}, Landroidx/leanback/widget/PagingIndicator;->b(Landroid/content/res/TypedArray;II)I
    ...
    .line 8
    iget p2, p0, Landroidx/leanback/widget/PagingIndicator;->d:I
    ...
    .line 9
    sget p2, La/l/m;->PagingIndicator_arrowRadius:I

    sget v1, La/l/d;->lb_page_indicator_arrow_radius:I

    invoke-direct {p0, p1, p2, v1}, Landroidx/leanback/widget/PagingIndicator;->b(Landroid/content/res/TypedArray;II)I
    ...
    .line 11
    sget p2, La/l/m;->PagingIndicator_dotToDotGap:I

    sget v1, La/l/d;->lb_page_indicator_dot_gap:I
    ...
    .line 12
    sget p2, La/l/m;->PagingIndicator_dotToArrowGap:I

    sget v1, La/l/d;->lb_page_indicator_arrow_gap:I
    ...
    .line 13
    sget p2, La/l/m;->PagingIndicator_dotBgColor:I

    sget v1, La/l/c;->lb_page_indicator_dot:I

    invoke-direct {p0, p1, p2, v1}, Landroidx/leanback/widget/PagingIndicator;->a(Landroid/content/res/TypedArray;II)I
    ...
    iput-object v1, p0, Landroidx/leanback/widget/PagingIndicator;->s:Landroid/graphics/Paint;

    .line 15
    iget-object v1, p0, Landroidx/leanback/widget/PagingIndicator;->s:Landroid/graphics/Paint;

    invoke-virtual {v1, p2}, Landroid/graphics/Paint;->setColor(I)V

    .line 16
    sget p2, La/l/m;->PagingIndicator_arrowBgColor:I

    sget v1, La/l/c;->lb_page_indicator_arrow_background:I

    invoke-direct {p0, p1, p2, v1}, Landroidx/leanback/widget/PagingIndicator;->a(Landroid/content/res/TypedArray;II)I

    move-result p2

    iput p2, p0, Landroidx/leanback/widget/PagingIndicator;->r:I

    .line 17
    iget-object p2, p0, Landroidx/leanback/widget/PagingIndicator;->y:Landroid/graphics/Paint;

    if-nez p2, :cond_0

    sget p2, La/l/m;->PagingIndicator_arrowColor:I
    ...
    .line 21
    sget p1, La/l/c;->lb_page_indicator_arrow_shadow:I
    ...
    .line 22
    sget p2, La/l/d;->lb_page_indicator_arrow_shadow_radius:I
    ...
    iput-object p2, p0, Landroidx/leanback/widget/PagingIndicator;->t:Landroid/graphics/Paint;

    .line 24
    sget p2, La/l/d;->lb_page_indicator_arrow_shadow_offset:I
    ...
    .line 26
    invoke-direct {p0}, Landroidx/leanback/widget/PagingIndicator;->d()Landroid/graphics/Bitmap;
    ...
    iget-object p2, p0, Landroidx/leanback/widget/PagingIndicator;->x:Landroid/graphics/Bitmap;

    invoke-virtual {p2}, Landroid/graphics/Bitmap;->getWidth()I

    move-result p2

    iget-object v0, p0, Landroidx/leanback/widget/PagingIndicator;->x:Landroid/graphics/Bitmap;
    ...
    iget p2, p0, Landroidx/leanback/widget/PagingIndicator;->f:I
    ...
    .line 30
    iget-object p1, p0, Landroidx/leanback/widget/PagingIndicator;->u:Landroid/animation/AnimatorSet;
    ...
    invoke-direct {p0, v4, v1}, Landroidx/leanback/widget/PagingIndicator;->a(FF)Landroid/animation/Animator;

    move-result-object v5

    aput-object v5, v0, v2

    iget v5, p0, Landroidx/leanback/widget/PagingIndicator;->d:I

    mul-int/lit8 v5, v5, 0x2

    int-to-float v5, v5

    iget v6, p0, Landroidx/leanback/widget/PagingIndicator;->g:I
    ...
    .line 31
    invoke-direct {p0, v5, v6}, Landroidx/leanback/widget/PagingIndicator;->b(FF)Landroid/animation/Animator;
    ...
    .line 32
    invoke-direct {p0}, Landroidx/leanback/widget/PagingIndicator;->c()Landroid/animation/Animator;
    ...
    .line 35
    iget-object p1, p0, Landroidx/leanback/widget/PagingIndicator;->v:Landroid/animation/AnimatorSet;

    new-array p2, p2, [Landroid/animation/Animator;

    invoke-direct {p0, v1, v4}, Landroidx/leanback/widget/PagingIndicator;->a(FF)Landroid/animation/Animator;
    ...
    .line 36
    invoke-direct {p0, v0, v1}, Landroidx/leanback/widget/PagingIndicator;->b(FF)Landroid/animation/Animator;
    ...
    .line 39
    iget-object p1, p0, Landroidx/leanback/widget/PagingIndicator;->w:Landroid/animation/AnimatorSet;

    new-array p2, p3, [Landroid/animation/Animator;

    iget-object p3, p0, Landroidx/leanback/widget/PagingIndicator;->u:Landroid/animation/AnimatorSet;
...
.method private a()V
    ...
    invoke-virtual {v0}, Landroidx/leanback/widget/PagingIndicator$d;->g()V
...
.method private b()V
    ...
    .line 14
    iget-boolean v2, p0, Landroidx/leanback/widget/PagingIndicator;->b:Z
    ...
    iget v7, p0, Landroidx/leanback/widget/PagingIndicator;->e:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v1, p1}, Landroidx/leanback/widget/PagingIndicator$d;->a(Landroid/graphics/Canvas;)V
...
.method public onRtlPropertiesChanged(I)V
    ...
    .line 7
    invoke-virtual {v2}, Landroidx/leanback/widget/PagingIndicator$d;->f()V
...
.method public setPageCount(I)V
    ...
    .line 2
    iget p1, p0, Landroidx/leanback/widget/PagingIndicator;->o:I
