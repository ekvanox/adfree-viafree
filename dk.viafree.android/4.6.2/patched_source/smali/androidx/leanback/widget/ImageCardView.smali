...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 2
    sget p1, La/l/l;->Widget_Leanback_ImageCardView:I

    invoke-direct {p0, p2, p3, p1}, Landroidx/leanback/widget/ImageCardView;->a(Landroid/util/AttributeSet;II)V
...
.method private a(Landroid/util/AttributeSet;II)V
    ...
    .line 4
    sget v2, La/l/i;->lb_image_card_view:I
    ...
    sget-object v3, La/l/m;->lbImageCardView:[I
    ...
    .line 6
    sget p2, La/l/m;->lbImageCardView_lbImageCardViewType:I
    ...
    iput-object v8, p0, Landroidx/leanback/widget/ImageCardView;->t:Landroid/widget/ImageView;

    .line 9
    iget-object v8, p0, Landroidx/leanback/widget/ImageCardView;->t:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, Landroidx/leanback/widget/ImageCardView;->z:Landroid/animation/ObjectAnimator;
    ...
    iput-object v0, p0, Landroidx/leanback/widget/ImageCardView;->u:Landroid/view/ViewGroup;

    if-eqz v2, :cond_6

    .line 16
    iget-object p2, p0, Landroidx/leanback/widget/ImageCardView;->u:Landroid/view/ViewGroup;
    ...
    .line 18
    sget v0, La/l/i;->lb_image_card_view_themed_title:I

    iget-object v2, p0, Landroidx/leanback/widget/ImageCardView;->u:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, Landroidx/leanback/widget/ImageCardView;->v:Landroid/widget/TextView;

    .line 19
    iget-object v0, p0, Landroidx/leanback/widget/ImageCardView;->u:Landroid/view/ViewGroup;

    iget-object v2, p0, Landroidx/leanback/widget/ImageCardView;->v:Landroid/widget/TextView;
    ...
    .line 20
    sget v0, La/l/i;->lb_image_card_view_themed_content:I
    ...
    iput-object v0, p0, Landroidx/leanback/widget/ImageCardView;->w:Landroid/widget/TextView;

    .line 21
    iget-object v0, p0, Landroidx/leanback/widget/ImageCardView;->u:Landroid/view/ViewGroup;

    iget-object v2, p0, Landroidx/leanback/widget/ImageCardView;->w:Landroid/widget/TextView;
    ...
    .line 22
    :cond_9
    sget v0, La/l/i;->lb_image_card_view_themed_badge_right:I

    if-eqz p2, :cond_a

    .line 23
    sget v0, La/l/i;->lb_image_card_view_themed_badge_left:I
    ...
    iput-object p3, p0, Landroidx/leanback/widget/ImageCardView;->x:Landroid/widget/ImageView;
    ...
    .line 26
    iget-object v1, p0, Landroidx/leanback/widget/ImageCardView;->x:Landroid/widget/ImageView;

    if-eqz v1, :cond_d

    .line 27
    iget-object v1, p0, Landroidx/leanback/widget/ImageCardView;->v:Landroid/widget/TextView;
    ...
    .line 29
    iget-object v2, p0, Landroidx/leanback/widget/ImageCardView;->x:Landroid/widget/ImageView;
    ...
    .line 32
    iget-object v1, p0, Landroidx/leanback/widget/ImageCardView;->w:Landroid/widget/TextView;
    ...
    .line 41
    iget-object p3, p0, Landroidx/leanback/widget/ImageCardView;->w:Landroid/widget/TextView;
    ...
    .line 42
    iget-object p3, p0, Landroidx/leanback/widget/ImageCardView;->v:Landroid/widget/TextView;
    ...
    :cond_12
    :goto_6
    iget-object p3, p0, Landroidx/leanback/widget/ImageCardView;->x:Landroid/widget/ImageView;

    invoke-virtual {p3, p2}, Landroid/widget/ImageView;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    .line 44
    :cond_13
    sget p2, La/l/m;->lbImageCardView_infoAreaBackground:I
...
.method public a(Landroid/graphics/drawable/Drawable;Z)V
    ...
    .line 55
    invoke-direct {p0}, Landroidx/leanback/widget/ImageCardView;->b()V
...
.method public setMainImage(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 1
    invoke-virtual {p0, p1, v0}, Landroidx/leanback/widget/ImageCardView;->a(Landroid/graphics/drawable/Drawable;Z)V
