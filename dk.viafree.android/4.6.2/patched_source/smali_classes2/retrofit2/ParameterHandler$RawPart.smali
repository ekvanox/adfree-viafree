...
# virtual methods
.method apply(Lretrofit2/RequestBuilder;Li/w$b;)V
    .locals 0

    if-eqz p2, :cond_0

    .line 2
    invoke-virtual {p1, p2}, Lretrofit2/RequestBuilder;->addPart(Li/w$b;)V
...
.method bridge synthetic apply(Lretrofit2/RequestBuilder;Ljava/lang/Object;)V
    ...
    .line 1
    check-cast p2, Li/w$b;

    invoke-virtual {p0, p1, p2}, Lretrofit2/ParameterHandler$RawPart;->apply(Lretrofit2/RequestBuilder;Li/w$b;)V
