...
.field private final headers:Li/s;
...
.method constructor <init>(Lretrofit2/ServiceMethod$Builder;)V
    ...
    invoke-virtual {v0}, Lretrofit2/Retrofit;->callFactory()Li/e$a;

    move-result-object v0

    iput-object v0, p0, Lretrofit2/ServiceMethod;->callFactory:Li/e$a;
    ...
    invoke-virtual {v0}, Lretrofit2/Retrofit;->baseUrl()Li/t;

    move-result-object v0

    iput-object v0, p0, Lretrofit2/ServiceMethod;->baseUrl:Li/t;
    ...
    .line 8
    iget-object v0, p1, Lretrofit2/ServiceMethod$Builder;->headers:Li/s;

    iput-object v0, p0, Lretrofit2/ServiceMethod;->headers:Li/s;

    .line 9
    iget-object v0, p1, Lretrofit2/ServiceMethod$Builder;->contentType:Li/v;

    iput-object v0, p0, Lretrofit2/ServiceMethod;->contentType:Li/v;
...
.method varargs toCall([Ljava/lang/Object;)Li/e;
    .locals 10
    ...
    iget-object v2, p0, Lretrofit2/ServiceMethod;->baseUrl:Li/t;

    iget-object v3, p0, Lretrofit2/ServiceMethod;->relativeUrl:Ljava/lang/String;

    iget-object v4, p0, Lretrofit2/ServiceMethod;->headers:Li/s;

    iget-object v5, p0, Lretrofit2/ServiceMethod;->contentType:Li/v;
    ...
    invoke-direct/range {v0 .. v8}, Lretrofit2/RequestBuilder;-><init>(Ljava/lang/String;Li/t;Ljava/lang/String;Li/s;Li/v;ZZZ)V
    ...
    .line 6
    :cond_1
    iget-object p1, p0, Lretrofit2/ServiceMethod;->callFactory:Li/e$a;

    invoke-virtual {v9}, Lretrofit2/RequestBuilder;->build()Li/a0;

    move-result-object v0

    invoke-interface {p1, v0}, Li/e$a;->a(Li/a0;)Li/e;
...
.method toResponse(Li/d0;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
