...
.method private createRawCall()Li/e;
    .locals 2
    ...
    invoke-virtual {v0, v1}, Lretrofit2/ServiceMethod;->toCall([Ljava/lang/Object;)Li/e;
...
.method public cancel()V
    ...
    .line 3
    :try_start_0
    iget-object v0, p0, Lretrofit2/OkHttpCall;->rawCall:Li/e;
...
.method public enqueue(Lretrofit2/Callback;)V
    ...
    .line 7
    :try_start_1
    invoke-direct {p0}, Lretrofit2/OkHttpCall;->createRawCall()Li/e;

    move-result-object v2

    iput-object v2, p0, Lretrofit2/OkHttpCall;->rawCall:Li/e;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public execute()Lretrofit2/Response;
    ...
    iput-object v0, p0, Lretrofit2/OkHttpCall;->rawCall:Li/e;
    :try_end_1
    ...
    .line 18
    :cond_4
    invoke-static {v0}, Lcom/google/firebase/perf/network/FirebasePerfOkHttpClient;->execute(Li/e;)Li/c0;

    move-result-object v0

    invoke-virtual {p0, v0}, Lretrofit2/OkHttpCall;->parseResponse(Li/c0;)Lretrofit2/Response;
...
.method public isCanceled()Z
    ...
    invoke-interface {v0}, Li/e;->isCanceled()Z
...
.method parseResponse(Li/c0;)Lretrofit2/Response;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v2, v3, v4}, Lretrofit2/OkHttpCall$NoContentResponseBody;-><init>(Li/v;J)V

    invoke-virtual {p1, v1}, Li/c0$a;->a(Li/d0;)Li/c0$a;
    ...
    invoke-direct {v1, v0}, Lretrofit2/OkHttpCall$ExceptionCatchingRequestBody;-><init>(Li/d0;)V

    .line 7
    :try_start_0
    iget-object v0, p0, Lretrofit2/OkHttpCall;->serviceMethod:Lretrofit2/ServiceMethod;

    invoke-virtual {v0, v1}, Lretrofit2/ServiceMethod;->toResponse(Li/d0;)Ljava/lang/Object;

    move-result-object v0

    .line 8
    invoke-static {v0, p1}, Lretrofit2/Response;->success(Ljava/lang/Object;Li/c0;)Lretrofit2/Response;
    ...
    :goto_1
    :try_start_1
    invoke-static {v0}, Lretrofit2/Utils;->buffer(Li/d0;)Li/d0;

    move-result-object v1

    .line 14
    invoke-static {v1, p1}, Lretrofit2/Response;->error(Li/d0;Li/c0;)Lretrofit2/Response;
...
.method public declared-synchronized request()Li/a0;
    .locals 3
    ...
    .line 2
    invoke-interface {v0}, Li/e;->request()Li/a0;
