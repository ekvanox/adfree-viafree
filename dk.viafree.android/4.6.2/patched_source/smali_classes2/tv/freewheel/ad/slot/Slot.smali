...
.method public parse(Lorg/w3c/dom/Element;)V
    ...
    const-string v3, "slotImpression"

    .line 13
    invoke-virtual {p0, v3, v2, v0}, Ltv/freewheel/ad/EventCallbackHolder;->createEventHandler(Ljava/lang/String;Ljava/lang/String;Z)Ltv/freewheel/ad/handler/EventCallbackHandler;

    move-result-object v3

    check-cast v3, Ltv/freewheel/ad/handler/SlotImpressionCallbackHandler;

    iput-object v3, p0, Ltv/freewheel/ad/slot/Slot;->slotStartCallbackHandler:Ltv/freewheel/ad/handler/SlotImpressionCallbackHandler;

    .line 14
    iget-object v3, p0, Ltv/freewheel/ad/slot/Slot;->slotStartCallbackHandler:Ltv/freewheel/ad/handler/SlotImpressionCallbackHandler;

    if-eqz v3, :cond_1

    .line 15
    invoke-virtual {v3, p0}, Ltv/freewheel/ad/handler/SlotImpressionCallbackHandler;->setSlot(Ltv/freewheel/ad/slot/Slot;)V

    :cond_1
    const-string v3, "slotEnd"
...
.method public parseEventCallbacksWithMetadataLines(Ljava/util/List;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 9
    invoke-virtual {p0, p3, p2, p1}, Ltv/freewheel/ad/EventCallbackHolder;->createEventHandler(Ljava/lang/String;Ljava/lang/String;Z)Ltv/freewheel/ad/handler/EventCallbackHandler;

    move-result-object p3

    check-cast p3, Ltv/freewheel/ad/handler/SlotImpressionCallbackHandler;

    iput-object p3, p0, Ltv/freewheel/ad/slot/Slot;->slotStartCallbackHandler:Ltv/freewheel/ad/handler/SlotImpressionCallbackHandler;

    .line 10
    iget-object p3, p0, Ltv/freewheel/ad/slot/Slot;->slotStartCallbackHandler:Ltv/freewheel/ad/handler/SlotImpressionCallbackHandler;

    if-eqz p3, :cond_3

    .line 11
    invoke-virtual {p3, p0}, Ltv/freewheel/ad/handler/SlotImpressionCallbackHandler;->setSlot(Ltv/freewheel/ad/slot/Slot;)V
