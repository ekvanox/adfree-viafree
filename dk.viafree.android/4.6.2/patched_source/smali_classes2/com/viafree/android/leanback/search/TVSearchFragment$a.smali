...
.method public final a(Lcom/viafree/android/r/b/f/f;)V
    ...
    invoke-static {v1}, Lcom/viafree/android/leanback/search/TVSearchFragment;->b(Lcom/viafree/android/leanback/search/TVSearchFragment;)Lcom/viafree/android/search/c;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/viafree/android/leanback/u/n;-><init>(Landroid/content/Context;Ljava/lang/Boolean;Ljava/lang/Boolean;ILh/v/d/g;)V
    ...
    invoke-direct {p1, v1}, Landroidx/leanback/widget/e0;-><init>(Ljava/lang/String;)V

    goto :goto_1

    :cond_1
    sget-object p1, Lh/v/d/r;->a:Lh/v/d/r;
    ...
    invoke-static {v4}, Lcom/viafree/android/leanback/search/TVSearchFragment;->b(Lcom/viafree/android/leanback/search/TVSearchFragment;)Lcom/viafree/android/search/c;

    move-result-object v4

    invoke-virtual {v4}, Lcom/viafree/android/search/c;->f()Ljava/lang/String;
    ...
    invoke-direct {v1, p1}, Landroidx/leanback/widget/e0;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v1}, Lcom/viafree/android/leanback/search/TVSearchFragment;->a(Lcom/viafree/android/leanback/search/TVSearchFragment;)Landroidx/leanback/widget/c;

    move-result-object v7

    new-instance v8, Landroidx/leanback/widget/n0;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/viafree/android/leanback/q;-><init>(Ljava/util/List;Landroidx/leanback/widget/a1;Ljava/lang/String;ILh/v/d/g;)V

    invoke-direct {v8, p1, v9}, Landroidx/leanback/widget/n0;-><init>(Landroidx/leanback/widget/e0;Landroidx/leanback/widget/p0;)V

    invoke-virtual {v7, v8}, Landroidx/leanback/widget/c;->a(Ljava/lang/Object;)V
