...
.field protected p:Lcom/viafree/android/s/o/d/e;

.field private final q:Lcom/viafree/android/login/authentication/b;

.field private r:Landroidx/leanback/widget/x;

.field private s:Landroidx/leanback/widget/x;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lcom/viafree/android/leanback/l$a;-><init>(Lh/v/d/g;)V
...
.method private final U()V
    ...
    const-string v3, "resources.getStringArray\u2026acebook_login_permission)"
    ...
    .line 7
    invoke-static {v1}, Lh/r/b;->c([Ljava/lang/Object;)Ljava/util/List;

    move-result-object v1

    invoke-virtual {v0, p0, v1}, Lcom/facebook/login/LoginManager;->logInWithReadPermissions(Landroidx/fragment/app/Fragment;Ljava/util/Collection;)V
...
.method public static final synthetic a(Lcom/viafree/android/leanback/l;Ljava/lang/String;)V
    ...
    .line 3
    invoke-direct {p0, p1}, Lcom/viafree/android/leanback/l;->e(Ljava/lang/String;)V
...
.method private final a(Lcom/viafree/android/login/model/UserLoginResponse;)V
    ...
    invoke-static {v0, v1}, Lcom/viafree/android/s/p/k;->a(Landroidx/fragment/app/c;Lh/v/c/a;)V
...
.method private final j(Landroidx/leanback/widget/x;)V
    .locals 5
    ...
    new-instance v1, Lh/a0/d;

    const-string v2, " "

    invoke-direct {v1, v2}, Lh/a0/d;-><init>(Ljava/lang/String;)V

    const-string v2, ""

    invoke-virtual {v1, v0, v2}, Lh/a0/d;->a(Ljava/lang/CharSequence;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroidx/leanback/widget/x;->c(Ljava/lang/CharSequence;)V
...
.method protected final R()Lcom/viafree/android/s/o/d/e;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/viafree/android/leanback/l;->p:Lcom/viafree/android/s/o/d/e;
...
.method protected final S()Lcom/viafree/android/s/m/a/a/b;
    .locals 1
...
.method public a(Landroid/os/Bundle;)Landroidx/leanback/widget/w$a;
    ...
    .line 8
    :goto_0
    new-instance v4, Landroidx/leanback/widget/w$a;

    if-eqz v2, :cond_1

    invoke-static {v2}, Lcom/viafree/android/s/p/k;->c(Lcom/viafree/viafreeandroidutility/dto/ProgramObject;)Ljava/lang/String;

    move-result-object v3

    :cond_1
    invoke-direct {v4, p1, v0, v3, v1}, Landroidx/leanback/widget/w$a;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/graphics/drawable/Drawable;)V
...
.method public a(Ljava/util/List;Landroid/os/Bundle;)V
    ...
    .line 9
    new-instance p2, Landroidx/leanback/widget/x$a;

    invoke-virtual {p0}, Landroidx/fragment/app/Fragment;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-direct {p2, v0}, Landroidx/leanback/widget/x$a;-><init>(Landroid/content/Context;)V

    const-wide v0, 0x2e3d54bf8L

    .line 10
    invoke-virtual {p2, v0, v1}, Landroidx/leanback/widget/x$b;->a(J)Landroidx/leanback/widget/x$b;

    check-cast p2, Landroidx/leanback/widget/x$a;
    ...
    invoke-virtual {p2, v0}, Landroidx/leanback/widget/x$b;->a(Ljava/lang/CharSequence;)Landroidx/leanback/widget/x$b;

    check-cast p2, Landroidx/leanback/widget/x$a;

    .line 12
    invoke-virtual {p2}, Landroidx/leanback/widget/x$a;->b()Landroidx/leanback/widget/x;
    ...
    invoke-direct {v0, v1}, Landroidx/leanback/widget/x$a;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/leanback/widget/x$b;->a(Ljava/lang/CharSequence;)Landroidx/leanback/widget/x$b;
    ...
    .line 17
    iget-object v1, p0, Lcom/viafree/android/leanback/l;->r:Landroidx/leanback/widget/x;
    ...
    .line 18
    iget-object v1, p0, Lcom/viafree/android/leanback/l;->s:Landroidx/leanback/widget/x;
    ...
    .line 20
    invoke-static {v0, p2}, Lh/v/d/i;->a(Ljava/lang/Object;Ljava/lang/String;)V
...
.method public d(Landroidx/leanback/widget/x;)V
    ...
    .line 2
    iget-object p1, p0, Lcom/viafree/android/leanback/l;->r:Landroidx/leanback/widget/x;
    ...
    .line 3
    :goto_0
    iget-object v2, p0, Lcom/viafree/android/leanback/l;->s:Landroidx/leanback/widget/x;

    if-eqz v2, :cond_3

    invoke-virtual {v2}, Landroidx/leanback/widget/x;->g()Ljava/lang/CharSequence;
    ...
    invoke-direct {p0}, Lcom/viafree/android/leanback/l;->U()V
...
.method public e(Landroidx/leanback/widget/x;)V
    ...
    .line 2
    invoke-direct {p0, p1}, Lcom/viafree/android/leanback/l;->j(Landroidx/leanback/widget/x;)V

    .line 3
    invoke-super {p0, p1}, Landroidx/leanback/app/j;->e(Landroidx/leanback/widget/x;)V
...
.method public g(Landroidx/leanback/widget/x;)J
    ...
    .line 2
    invoke-super {p0, p1}, Landroidx/leanback/app/j;->g(Landroidx/leanback/widget/x;)J
...
.method public onAttach(Landroid/content/Context;)V
    ...
    .line 4
    invoke-virtual {v0, v1}, Landroidx/leanback/widget/x$b;->b(Z)Landroidx/leanback/widget/x$b;

    check-cast v0, Landroidx/leanback/widget/x$a;

    .line 5
    invoke-virtual {v0, v1}, Landroidx/leanback/widget/x$b;->a(Z)Landroidx/leanback/widget/x$b;
    ...
    .line 6
    invoke-virtual {v0, v2}, Landroidx/leanback/widget/x$b;->a(I)Landroidx/leanback/widget/x$b;

    check-cast v0, Landroidx/leanback/widget/x$a;

    .line 7
    invoke-virtual {v0, v2}, Landroidx/leanback/widget/x$b;->b(I)Landroidx/leanback/widget/x$b;
    ...
    iput-object v0, p0, Lcom/viafree/android/leanback/l;->s:Landroidx/leanback/widget/x;
    ...
    invoke-virtual {v0, v3}, Landroidx/leanback/widget/x$b;->a(Ljava/lang/CharSequence;)Landroidx/leanback/widget/x$b;
    ...
    .line 14
    invoke-virtual {v0, v3}, Landroidx/leanback/widget/x$b;->a(I)Landroidx/leanback/widget/x$b;

    check-cast v0, Landroidx/leanback/widget/x$a;

    .line 15
    invoke-virtual {v0, v3}, Landroidx/leanback/widget/x$b;->b(I)Landroidx/leanback/widget/x$b;
    ...
    .line 16
    invoke-virtual {v0, v3, v4}, Landroidx/leanback/widget/x$b;->a(J)Landroidx/leanback/widget/x$b;
    ...
    iput-object v0, p0, Lcom/viafree/android/leanback/l;->r:Landroidx/leanback/widget/x;
...
.method public synthetic onDestroyView()V
    ...
    invoke-virtual {p0}, Lcom/viafree/android/leanback/l;->Q()V
