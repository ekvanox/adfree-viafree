...
.method public getFont(Landroid/content/Context;)Landroid/graphics/Typeface;
    ...
    invoke-static {p1, v0}, La/h/h/c/f;->a(Landroid/content/Context;I)Landroid/graphics/Typeface;
...
.method public getFontAsync(Landroid/content/Context;Landroid/text/TextPaint;La/h/h/c/f$a;)V
    .locals 2
    ...
    invoke-direct {v1, p0, p2, p3}, Lcom/google/android/material/resources/TextAppearance$1;-><init>(Lcom/google/android/material/resources/TextAppearance;Landroid/text/TextPaint;La/h/h/c/f$a;)V

    const/4 p2, 0x0

    invoke-static {p1, v0, v1, p2}, La/h/h/c/f;->a(Landroid/content/Context;ILa/h/h/c/f$a;Landroid/os/Handler;)V
    :try_end_0
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public updateDrawState(Landroid/content/Context;Landroid/text/TextPaint;La/h/h/c/f$a;)V
    .locals 4

    .line 1
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/resources/TextAppearance;->updateMeasureState(Landroid/content/Context;Landroid/text/TextPaint;La/h/h/c/f$a;)V
...
.method public updateMeasureState(Landroid/content/Context;Landroid/text/TextPaint;La/h/h/c/f$a;)V
    .locals 1
    ...
    .line 3
    :cond_0
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/resources/TextAppearance;->getFontAsync(Landroid/content/Context;Landroid/text/TextPaint;La/h/h/c/f$a;)V
